...
`)+`
`+d);const T=E+m+a,M=E+d+o,b=uc(i,i.VERTEX_SHADER,T),w=uc(i,i.FRAGMENT_SHADER,M);i.attachShader(_,b),i.attachShader(_,w),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function R(D){if(r.debug.checkShaderErrors){const N=i.getProgramInfoLog(_)||"",O=i.getShaderInfoLog(b)||"",q=i.getShaderInfoLog(w)||"",V=N.trim(),G=O.trim(),K=q.trim();let z=!0,se=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(z=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,b,w);else{const le=fc(i,b,"vertex"),_e=fc(i,w,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`;function yg(r,e,t){let n=new Ko;const i=new qe,s=new qe,a=new ft,o=new Hf({depthPacking:Jh}),c=new Vf,l={},u=t.maxTextureSize,h={[ti]:Ot,[Ot]:ti,[fn]:fn},f=new ni({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new qe},radius:{value:4}},vertexShader:Mg,fragmentShader:Sg}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const g=new si;g.setAttribute("position",new En(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new mn(g,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Oc;let d=this.type;this.render=function(w,R,C){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||w.length===0)return;const x=r.getRenderTarget(),y=r.getActiveCubeFace(),D=r.getActiveMipmapLevel(),N=r.state;N.setBlending(jn),N.buffers.depth.getReversed()===!0?N.buffers.color.setClear(0,0,0,0):N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);const O=d!==Un&&this.type===Un,q=d===Un&&this.type!==Un;for(let V=0,G=w.length;V<G;V++){const K=w[V],z=K.shadow;if(z===void 0){console.warn("THREE.WebGLShadowMap:",K,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;i.copy(z.mapSize);const se=z.getFrameExtents();if(i.multiply(se),s.copy(z.mapSize),(i.x>u||i.y>u)&&(i.x>u&&(s.x=Math.floor(u/se.x),i.x=s.x*se.x,z.mapSize.x=s.x),i.y>u&&(s.y=Math.floor(u/se.y),i.y=s.y*se.y,z.mapSize.y=s.y)),z.map===null||O===!0||q===!0){const _e=this.type!==Un?{minFilter:It,magFilter:It}:{};z.map!==null&&z.map.dispose(),z.map=new Pi(i.x,i.y,_e),z.map.texture.name=K.name+".shadowMap",z.camera.updateProjectionMatrix()}r.setRenderTarget(z.map),r.clear();const le=z.getViewportCount();for(let _e=0;_e<le;_e++){const be=z.getViewport(_e);a.set(s.x*be.x,s.y*be.y,s.x*be.z,s.y*be.w),N.viewport(a),z.updateMatrices(K,_e),n=z.getFrustum(),M(R,C,z.camera,K,this.type)}z.isPointLightShadow!==!0&&this.type===Un&&E(z,C),z.needsUpdate=!1}d=this.type,m.needsUpdate=!1,r.setRenderTarget(x,y,D)};function E(w,R){const C=e.update(_);f.defines.VSM_SAMPLES!==w.blurSamples&&(f.defines.VSM_SAMPLES=w.blurSamples,p.defines.VSM_SAMPLES=w.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),w.mapPass===null&&(w.mapPass=new Pi(i.x,i.y)),f.uniforms.shadow_pass.value=w.map.texture,f.uniforms.resolution.value=w.mapSize,f.uniforms.radius.value=w.radius,r.setRenderTarget(w.mapPass),r.clear(),r.renderBufferDirect(R,null,C,f,_,null),p.uniforms.shadow_pass.value=w.mapPass.texture,p.uniforms.resolution.value=w.mapSize,p.uniforms.radius.value=w.radius,r.setRenderTarget(w.map),r.clear(),r.renderBufferDirect(R,null,C,p,_,null)}function T(w,R,C,x){let y=null;const D=C.isPointLight===!0?w.customDistanceMaterial:w.customDepthMaterial;if(D!==void 0)y=D;else if(y=C.isPointLight===!0?c:o,r.localClippingEnabled&&R.clipShadows===!0&&Array.isArray(R.clippingPlanes)&&R.clippingPlanes.length!==0||R.displacementMap&&R.displacementScale!==0||R.alphaMap&&R.alphaTest>0||R.map&&R.alphaTest>0||R.alphaToCoverage===!0){const N=y.uuid,O=R.uuid;let q=l[N];q===void 0&&(q={},l[N]=q);let V=q[O];V===void 0&&(V=y.clone(),q[O]=V,R.addEventListener("dispose",b)),y=V}if(y.visible=R.visible,y.wireframe=R.wireframe,x===Un?y.side=R.shadowSide!==null?R.shadowSide:R.side:y.side=R.shadowSide!==null?R.shadowSide:h[R.side],y.alphaMap=R.alphaMap,y.alphaTest=R.alphaToCoverage===!0?.5:R.alphaTest,y.map=R.map,y.clipShadows=R.clipShadows,y.clippingPlanes=R.clippingPlanes,y.clipIntersection=R.clipIntersection,y.displacementMap=R.displacementMap,y.displacementScale=R.displacementScale,y.displacementBias=R.displacementBias,y.wireframeLinewidth=R.wireframeLinewidth,y.linewidth=R.linewidth,C.isPointLight===!0&&y.isMeshDistanceMaterial===!0){const N=r.properties.get(y);N.light=C}return y}function M(w,R,C,x,y){if(w.visible===!1)return;if(w.layers.test(R.layers)&&(w.isMesh||w.isLine||w.isPoints)&&(w.castShadow||w.receiveShadow&&y===Un)&&(!w.frustumCulled||n.intersectsObject(w))){w.modelViewMatrix.multiplyMatrices(C.matrixWorldInverse,w.matrixWorld);const O=e.update(w),q=w.material;if(Array.isArray(q)){const V=O.groups;for(let G=0,K=V.length;G<K;G++){const z=V[G],se=q[z.materialIndex];if(se&&se.visible){const le=T(w,se,x,y);w.onBeforeShadow(r,w,R,C,O,le,z),r.renderBufferDirect(C,null,O,le,w,z),w.onAfterShadow(r,w,R,C,O,le,z)}}}else if(q.visible){const V=T(w,q,x,y);w.onBeforeShadow(r,w,R,C,O,V,null),r.renderBufferDirect(C,null,O,V,w,null),w.onAfterShadow(r,w,R,C,O,V,null)}}const N=w.children;for(let O=0,q=N.length;O<q;O++)M(N[O],R,C,x,y)}function b(w){w.target.removeEventListener("dispose",b);for(const C in l){const x=l[C],y=w.target.uuid;y in x&&(x[y].dispose(),delete x[y])}}}const Eg={[Fa]:Oa,[Ba]:Ha,[za]:Va,[sr]:ka,[Oa]:Fa,[Ha]:Ba,[Va]:za,[ka]:sr};function Tg(r,e){function t(){let L=!1;const re=new ft;let oe=null;const ge=new ft(0,0,0,0);return{setMask:function(te){oe!==te&&!L&&(r.colorMask(te,te,te,te),oe=te)},setLocked:function(te){L=te},setClear:function(te,j,Me,Ue,rt){rt===!0&&(te*=Ue,j*=Ue,Me*=Ue),re.set(te,j,Me,Ue),ge.equals(re)===!1&&(r.clearColor(te,j,Me,Ue),ge.copy(re))},reset:function(){L=!1,oe=null,ge.set(-1,0,0,0)}}}function n(){let L=!1,re=!1,oe=null,ge=null,te=null;return{setReversed:function(j){if(re!==j){const Me=e.get("EXT_clip_control");j?Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.ZERO_TO_ONE_EXT):Me.clipControlEXT(Me.LOWER_LEFT_EXT,Me.NEGATIVE_ONE_TO_ONE_EXT),re=j;const Ue=te;te=null,this.setClear(Ue)}},getReversed:function(){return re},setTest:function(j){j?J(r.DEPTH_TEST):me(r.DEPTH_TEST)},setMask:function(j){oe!==j&&!L&&(r.depthMask(j),oe=j)},setFunc:function(j){if(re&&(j=Eg[j]),ge!==j){switch(j){case Fa:r.depthFunc(r.NEVER);break;case Oa:r.depthFunc(r.ALWAYS);break;case Ba:r.depthFunc(r.LESS);break;case sr:r.depthFunc(r.LEQUAL);break;case za:r.depthFunc(r.EQUAL);break;case ka:r.depthFunc(r.GEQUAL);break;case Ha:r.depthFunc(r.GREATER);break;case Va:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}ge=j}},setLocked:function(j){L=j},setClear:function(j){te!==j&&(re&&(j=1-j),r.clearDepth(j),te=j)},reset:function(){L=!1,oe=null,ge=null,te=null,re=!1}}}function i(){let L=!1,re=null,oe=null,ge=null,te=null,j=null,Me=null,Ue=null,rt=null;return{setTest:function(Je){L||(Je?J(r.STENCIL_TEST):me(r.STENCIL_TEST))},setMask:function(Je){re!==Je&&!L&&(r.stencilMask(Je),re=Je)},setFunc:function(Je,Rn,_n){(oe!==Je||ge!==Rn||te!==_n)&&(r.stencilFunc(Je,Rn,_n),oe=Je,ge=Rn,te=_n)},setOp:function(Je,Rn,_n){(j!==Je||Me!==Rn||Ue!==_n)&&(r.stencilOp(Je,Rn,_n),j=Je,Me=Rn,Ue=_n)},setLocked:function(Je){L=Je},setClear:function(Je){rt!==Je&&(r.clearStencil(Je),rt=Je)},reset:function(){L=!1,re=null,oe=null,ge=null,te=null,j=null,Me=null,Ue=null,rt=null}}}const s=new t,a=new n,o=new i,c=new WeakMap,l=new WeakMap;let u={},h={},f=new WeakMap,p=[],g=null,_=!1,m=null,d=null,E=null,T=null,M=null,b=null,w=null,R=new Xe(0,0,0),C=0,x=!1,y=null,D=null,N=null,O=null,q=null;const V=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let G=!1,K=0;const z=r.getParameter(r.VERSION);z.indexOf("WebGL")!==-1?(K=parseFloat(/^WebGL (\d)/.exec(z)[1]),G=K>=1):z.indexOf("OpenGL ES")!==-1&&(K=parseFloat(/^OpenGL ES (\d)/.exec(z)[1]),G=K>=2);let se=null,le={};const _e=r.getParameter(r.SCISSOR_BOX),be=r.getParameter(r.VIEWPORT),Oe=new ft().fromArray(_e),He=new ft().fromArray(be);function Be(L,re,oe,ge){const te=new Uint8Array(4),j=r.createTexture();r.bindTexture(L,j),r.texParameteri(L,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(L,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let Me=0;Me<oe;Me++)L===r.TEXTURE_3D||L===r.TEXTURE_2D_ARRAY?r.texImage3D(re,0,r.RGBA,1,1,ge,0,r.RGBA,r.UNSIGNED_BYTE,te):r.texImage2D(re+Me,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,te);return j}const Z={};Z[r.TEXTURE_2D]=Be(r.TEXTURE_2D,r.TEXTURE_2D,1),Z[r.TEXTURE_CUBE_MAP]=Be(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),Z[r.TEXTURE_2D_ARRAY]=Be(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),Z[r.TEXTURE_3D]=Be(r.TEXTURE_3D,r.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),J(r.DEPTH_TEST),a.setFunc(sr),$(!1),W(yl),J(r.CULL_FACE),Ze(jn);function J(L){u[L]!==!0&&(r.enable(L),u[L]=!0)}function me(L){u[L]!==!1&&(r.disable(L),u[L]=!1)}function Pe(L,re){return h[L]!==re?(r.bindFramebuffer(L,re),h[L]=re,L===r.DRAW_FRAMEBUFFER&&(h[r.FRAMEBUFFER]=re),L===r.FRAMEBUFFER&&(h[r.DRAW_FRAMEBUFFER]=re),!0):!1}function ye(L,re){let oe=p,ge=!1;if(L){oe=f.get(re),oe===void 0&&(oe=[],f.set(re,oe));const te=L.textures;if(oe.length!==te.length||oe[0]!==r.COLOR_ATTACHMENT0){for(let j=0,Me=te.length;j<Me;j++)oe[j]=r.COLOR_ATTACHMENT0+j;oe.length=te.length,ge=!0}}else oe[0]!==r.BACK&&(oe[0]=r.BACK,ge=!0);ge&&r.drawBuffers(oe)}function ke(L){return g!==L?(r.useProgram(L),g=L,!0):!1}const _t={[Mi]:r.FUNC_ADD,[Th]:r.FUNC_SUBTRACT,[bh]:r.FUNC_REVERSE_SUBTRACT};_t[Ah]=r.MIN,_t[wh]=r.MAX;const P={[Rh]:r.ZERO,[Ch]:r.ONE,[Ph]:r.SRC_COLOR,[Ua]:r.SRC_ALPHA,[Fh]:r.SRC_ALPHA_SATURATE,[Uh]:r.DST_COLOR,[Lh]:r.DST_ALPHA,[Dh]:r.ONE_MINUS_SRC_COLOR,[Na]:r.ONE_MINUS_SRC_ALPHA,[Nh]:r.ONE_MINUS_DST_COLOR,[Ih]:r.ONE_MINUS_DST_ALPHA,[Oh]:r.CONSTANT_COLOR,[Bh]:r.ONE_MINUS_CONSTANT_COLOR,[zh]:r.CONSTANT_ALPHA,[kh]:r.ONE_MINUS_CONSTANT_ALPHA};function Ze(L,re,oe,ge,te,j,Me,Ue,rt,Je){if(L===jn){_===!0&&(me(r.BLEND),_=!1);return}if(_===!1&&(J(r.BLEND),_=!0),L!==Eh){if(L!==m||Je!==x){if((d!==Mi||M!==Mi)&&(r.blendEquation(r.FUNC_ADD),d=Mi,M=Mi),Je)switch(L){case er:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case El:r.blendFunc(r.ONE,r.ONE);break;case Tl:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case bl:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case er:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case El:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case Tl:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case bl:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}E=null,T=null,b=null,w=null,R.set(0,0,0),C=0,m=L,x=Je}return}te=te||re,j=j||oe,Me=Me||ge,(re!==d||te!==M)&&(r.blendEquationSeparate(_t[re],_t[te]),d=re,M=te),(oe!==E||ge!==T||j!==b||Me!==w)&&(r.blendFuncSeparate(P[oe],P[ge],P[j],P[Me]),E=oe,T=ge,b=j,w=Me),(Ue.equals(R)===!1||rt!==C)&&(r.blendColor(Ue.r,Ue.g,Ue.b,rt),R.copy(Ue),C=rt),m=L,x=!1}function Ie(L,re){L.side===fn?me(r.CULL_FACE):J(r.CULL_FACE);let oe=L.side===Ot;re&&(oe=!oe),$(oe),L.blending===er&&L.transparent===!1?Ze(jn):Ze(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),a.setFunc(L.depthFunc),a.setTest(L.depthTest),a.setMask(L.depthWrite),s.setMask(L.colorWrite);const ge=L.stencilWrite;o.setTest(ge),ge&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),ee(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?J(r.SAMPLE_ALPHA_TO_COVERAGE):me(r.SAMPLE_ALPHA_TO_COVERAGE)}function $(L){y!==L&&(L?r.frontFace(r.CW):r.frontFace(r.CCW),y=L)}function W(L){L!==Mh?(J(r.CULL_FACE),L!==D&&(L===yl?r.cullFace(r.BACK):L===Sh?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):me(r.CULL_FACE),D=L}function xe(L){L!==N&&(G&&r.lineWidth(L),N=L)}function ee(L,re,oe){L?(J(r.POLYGON_OFFSET_FILL),(O!==re||q!==oe)&&(r.polygonOffset(re,oe),O=re,q=oe)):me(r.POLYGON_OFFSET_FILL)}function de(L){L?J(r.SCISSOR_TEST):me(r.SCISSOR_TEST)}function Ye(L){L===void 0&&(L=r.TEXTURE0+V-1),se!==L&&(r.activeTexture(L),se=L)}function je(L,re,oe){oe===void 0&&(se===null?oe=r.TEXTURE0+V-1:oe=se);let ge=le[oe];ge===void 0&&(ge={type:void 0,texture:void 0},le[oe]=ge),(ge.type!==L||ge.texture!==re)&&(se!==oe&&(r.activeTexture(oe),se=oe),r.bindTexture(L,re||Z[L]),ge.type=L,ge.texture=re)}function A(){const L=le[se];L!==void 0&&L.type!==void 0&&(r.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function v(){try{r.compressedTexImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function F(){try{r.compressedTexImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Y(){try{r.texSubImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Q(){try{r.texSubImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function X(){try{r.compressedTexSubImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ae(){try{r.compressedTexSubImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ae(){try{r.texStorage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Se(){try{r.texStorage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ee(){try{r.texImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ie(){try{r.texImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function fe(L){Oe.equals(L)===!1&&(r.scissor(L.x,L.y,L.z,L.w),Oe.copy(L))}function De(L){He.equals(L)===!1&&(r.viewport(L.x,L.y,L.z,L.w),He.copy(L))}function Te(L,re){let oe=l.get(re);oe===void 0&&(oe=new WeakMap,l.set(re,oe));let ge=oe.get(L);ge===void 0&&(ge=r.getUniformBlockIndex(re,L.name),oe.set(L,ge))}function ue(L,re){const ge=l.get(re).get(L);c.get(re)!==ge&&(r.uniformBlockBinding(re,ge,L.__bindingPointIndex),c.set(re,ge))}function Ne(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),a.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),u={},se=null,le={},h={},f=new WeakMap,p=[],g=null,_=!1,m=null,d=null,E=null,T=null,M=null,b=null,w=null,R=new Xe(0,0,0),C=0,x=!1,y=null,D=null,N=null,O=null,q=null,Oe.set(0,0,r.canvas.width,r.canvas.height),He.set(0,0,r.canvas.width,r.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:J,disable:me,bindFramebuffer:Pe,drawBuffers:ye,useProgram:ke,setBlending:Ze,setMaterial:Ie,setFlipSided:$,setCullFace:W,setLineWidth:xe,setPolygonOffset:ee,setScissorTest:de,activeTexture:Ye,bindTexture:je,unbindTexture:A,compressedTexImage2D:v,compressedTexImage3D:F,texImage2D:Ee,texImage3D:ie,updateUBOMapping:Te,uniformBlockBinding:ue,texStorage2D:ae,texStorage3D:Se,texSubImage2D:Y,texSubImage3D:Q,compressedTexSubImage2D:X,compressedTexSubImage3D:Ae,scissor:fe,viewport:De,reset:Ne}}function bg(r,e,t,n,i,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new qe,u=new WeakMap;let h;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(A,v){return p?new OffscreenCanvas(A,v):Fr("canvas")}function _(A,v,F){let Y=1;const Q=je(A);if((Q.width>F||Q.height>F)&&(Y=F/Math.max(Q.width,Q.height)),Y<1)if(typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&A instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&A instanceof ImageBitmap||typeof VideoFrame<"u"&&A instanceof VideoFrame){const X=Math.floor(Y*Q.width),Ae=Math.floor(Y*Q.height);h===void 0&&(h=g(X,Ae));const ae=v?g(X,Ae):h;return ae.width=X,ae.height=Ae,ae.getContext("2d").drawImage(A,0,0,X,Ae),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+Q.width+"x"+Q.height+") to ("+X+"x"+Ae+")."),ae}else return"data"in A&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+Q.width+"x"+Q.height+")."),A;return A}function m(A){return A.generateMipmaps}function d(A){r.generateMipmap(A)}function E(A){return A.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:A.isWebGL3DRenderTarget?r.TEXTURE_3D:A.isWebGLArrayRenderTarget||A.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function T(A,v,F,Y,Q=!1){if(A!==null){if(r[A]!==void 0)return r[A];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+A+"'")}let X=v;if(v===r.RED&&(F===r.FLOAT&&(X=r.R32F),F===r.HALF_FLOAT&&(X=r.R16F),F===r.UNSIGNED_BYTE&&(X=r.R8)),v===r.RED_INTEGER&&(F===r.UNSIGNED_BYTE&&(X=r.R8UI),F===r.UNSIGNED_SHORT&&(X=r.R16UI),F===r.UNSIGNED_INT&&(X=r.R32UI),F===r.BYTE&&(X=r.R8I),F===r.SHORT&&(X=r.R16I),F===r.INT&&(X=r.R32I)),v===r.RG&&(F===r.FLOAT&&(X=r.RG32F),F===r.HALF_FLOAT&&(X=r.RG16F),F===r.UNSIGNED_BYTE&&(X=r.RG8)),v===r.RG_INTEGER&&(F===r.UNSIGNED_BYTE&&(X=r.RG8UI),F===r.UNSIGNED_SHORT&&(X=r.RG16UI),F===r.UNSIGNED_INT&&(X=r.RG32UI),F===r.BYTE&&(X=r.RG8I),F===r.SHORT&&(X=r.RG16I),F===r.INT&&(X=r.RG32I)),v===r.RGB_INTEGER&&(F===r.UNSIGNED_BYTE&&(X=r.RGB8UI),F===r.UNSIGNED_SHORT&&(X=r.RGB16UI),F===r.UNSIGNED_INT&&(X=r.RGB32UI),F===r.BYTE&&(X=r.RGB8I),F===r.SHORT&&(X=r.RGB16I),F===r.INT&&(X=r.RGB32I)),v===r.RGBA_INTEGER&&(F===r.UNSIGNED_BYTE&&(X=r.RGBA8UI),F===r.UNSIGNED_SHORT&&(X=r.RGBA16UI),F===r.UNSIGNED_INT&&(X=r.RGBA32UI),F===r.BYTE&&(X=r.RGBA8I),F===r.SHORT&&(X=r.RGBA16I),F===r.INT&&(X=r.RGBA32I)),v===r.RGB&&(F===r.UNSIGNED_INT_5_9_9_9_REV&&(X=r.RGB9_E5),F===r.UNSIGNED_INT_10F_11F_11F_REV&&(X=r.R11F_G11F_B10F)),v===r.RGBA){const Ae=Q?Ps:$e.getTransfer(Y);F===r.FLOAT&&(X=r.RGBA32F),F===r.HALF_FLOAT&&(X=r.RGBA16F),F===r.UNSIGNED_BYTE&&(X=Ae===et?r.SRGB8_ALPHA8:r.RGBA8),F===r.UNSIGNED_SHORT_4_4_4_4&&(X=r.RGBA4),F===r.UNSIGNED_SHORT_5_5_5_1&&(X=r.RGB5_A1)}return(X===r.R16F||X===r.R32F||X===r.RG16F||X===r.RG32F||X===r.RGBA16F||X===r.RGBA32F)&&e.get("EXT_color_buffer_float"),X}function M(A,v){let F;return A?v===null||v===Ci||v===Ir?F=r.DEPTH24_STENCIL8:v===On?F=r.DEPTH32F_STENCIL8:v===Lr&&(F=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Ci||v===Ir?F=r.DEPTH_COMPONENT24:v===On?F=r.DEPTH_COMPONENT32F:v===Lr&&(F=r.DEPTH_COMPONENT16),F}function b(A,v){return m(A)===!0||A.isFramebufferTexture&&A.minFilter!==It&&A.minFilter!==Mn?Math.log2(Math.max(v.width,v.height))+1:A.mipmaps!==void 0&&A.mipmaps.length>0?A.mipmaps.length:A.isCompressedTexture&&Array.isArray(A.image)?v.mipmaps.length:1}function w(A){const v=A.target;v.removeEventListener("dispose",w),C(v),v.isVideoTexture&&u.delete(v)}function R(A){const v=A.target;v.removeEventListener("dispose",R),y(v)}function C(A){const v=n.get(A);if(v.__webglInit===void 0)return;const F=A.source,Y=f.get(F);if(Y){const Q=Y[v.__cacheKey];Q.usedTimes--,Q.usedTimes===0&&x(A),Object.keys(Y).length===0&&f.delete(F)}n.remove(A)}function x(A){const v=n.get(A);r.deleteTexture(v.__webglTexture);const F=A.source,Y=f.get(F);delete Y[v.__cacheKey],a.memory.textures--}function y(A){const v=n.get(A);if(A.depthTexture&&(A.depthTexture.dispose(),n.remove(A.depthTexture)),A.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(v.__webglFramebuffer[Y]))for(let Q=0;Q<v.__webglFramebuffer[Y].length;Q++)r.deleteFramebuffer(v.__webglFramebuffer[Y][Q]);else r.deleteFramebuffer(v.__webglFramebuffer[Y]);v.__webglDepthbuffer&&r.deleteRenderbuffer(v.__webglDepthbuffer[Y])}else{if(Array.isArray(v.__webglFramebuffer))for(let Y=0;Y<v.__webglFramebuffer.length;Y++)r.deleteFramebuffer(v.__webglFramebuffer[Y]);else r.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&r.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&r.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let Y=0;Y<v.__webglColorRenderbuffer.length;Y++)v.__webglColorRenderbuffer[Y]&&r.deleteRenderbuffer(v.__webglColorRenderbuffer[Y]);v.__webglDepthRenderbuffer&&r.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const F=A.textures;for(let Y=0,Q=F.length;Y<Q;Y++){const X=n.get(F[Y]);X.__webglTexture&&(r.deleteTexture(X.__webglTexture),a.memory.textures--),n.remove(F[Y])}n.remove(A)}let D=0;function N(){D=0}function O(){const A=D;return A>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+A+" texture units while this GPU supports only "+i.maxTextures),D+=1,A}function q(A){const v=[];return v.push(A.wrapS),v.push(A.wrapT),v.push(A.wrapR||0),v.push(A.magFilter),v.push(A.minFilter),v.push(A.anisotropy),v.push(A.internalFormat),v.push(A.format),v.push(A.type),v.push(A.generateMipmaps),v.push(A.premultiplyAlpha),v.push(A.flipY),v.push(A.unpackAlignment),v.push(A.colorSpace),v.join()}function V(A,v){const F=n.get(A);if(A.isVideoTexture&&de(A),A.isRenderTargetTexture===!1&&A.isExternalTexture!==!0&&A.version>0&&F.__version!==A.version){const Y=A.image;if(Y===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{Z(F,A,v);return}}else A.isExternalTexture&&(F.__webglTexture=A.sourceTexture?A.sourceTexture:null);t.bindTexture(r.TEXTURE_2D,F.__webglTexture,r.TEXTURE0+v)}function G(A,v){const F=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&F.__version!==A.version){Z(F,A,v);return}t.bindTexture(r.TEXTURE_2D_ARRAY,F.__webglTexture,r.TEXTURE0+v)}function K(A,v){const F=n.get(A);if(A.isRenderTargetTexture===!1&&A.version>0&&F.__version!==A.version){Z(F,A,v);return}t.bindTexture(r.TEXTURE_3D,F.__webglTexture,r.TEXTURE0+v)}function z(A,v){const F=n.get(A);if(A.version>0&&F.__version!==A.version){J(F,A,v);return}t.bindTexture(r.TEXTURE_CUBE_MAP,F.__webglTexture,r.TEXTURE0+v)}const se={[Xa]:r.REPEAT,[yi]:r.CLAMP_TO_EDGE,[qa]:r.MIRRORED_REPEAT},le={[It]:r.NEAREST,[Zh]:r.NEAREST_MIPMAP_NEAREST,[es]:r.NEAREST_MIPMAP_LINEAR,[Mn]:r.LINEAR,[Ys]:r.LINEAR_MIPMAP_NEAREST,[Ei]:r.LINEAR_MIPMAP_LINEAR},_e={[ef]:r.NEVER,[of]:r.ALWAYS,[tf]:r.LESS,[$c]:r.LEQUAL,[nf]:r.EQUAL,[af]:r.GEQUAL,[rf]:r.GREATER,[sf]:r.NOTEQUAL};function be(A,v){if(v.type===On&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===Mn||v.magFilter===Ys||v.magFilter===es||v.magFilter===Ei||v.minFilter===Mn||v.minFilter===Ys||v.minFilter===es||v.minFilter===Ei)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(A,r.TEXTURE_WRAP_S,se[v.wrapS]),r.texParameteri(A,r.TEXTURE_WRAP_T,se[v.wrapT]),(A===r.TEXTURE_3D||A===r.TEXTURE_2D_ARRAY)&&r.texParameteri(A,r.TEXTURE_WRAP_R,se[v.wrapR]),r.texParameteri(A,r.TEXTURE_MAG_FILTER,le[v.magFilter]),r.texParameteri(A,r.TEXTURE_MIN_FILTER,le[v.minFilter]),v.compareFunction&&(r.texParameteri(A,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(A,r.TEXTURE_COMPARE_FUNC,_e[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===It||v.minFilter!==es&&v.minFilter!==Ei||v.type===On&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");r.texParameterf(A,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,i.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function Oe(A,v){let F=!1;A.__webglInit===void 0&&(A.__webglInit=!0,v.addEventListener("dispose",w));const Y=v.source;let Q=f.get(Y);Q===void 0&&(Q={},f.set(Y,Q));const X=q(v);if(X!==A.__cacheKey){Q[X]===void 0&&(Q[X]={texture:r.createTexture(),usedTimes:0},a.memory.textures++,F=!0),Q[X].usedTimes++;const Ae=Q[A.__cacheKey];Ae!==void 0&&(Q[A.__cacheKey].usedTimes--,Ae.usedTimes===0&&x(v)),A.__cacheKey=X,A.__webglTexture=Q[X].texture}return F}function He(A,v,F){return Math.floor(Math.floor(A/F)/v)}function Be(A,v,F,Y){const X=A.updateRanges;if(X.length===0)t.texSubImage2D(r.TEXTURE_2D,0,0,0,v.width,v.height,F,Y,v.data);else{X.sort((ie,fe)=>ie.start-fe.start);let Ae=0;for(let ie=1;ie<X.length;ie++){const fe=X[Ae],De=X[ie],Te=fe.start+fe.count,ue=He(De.start,v.width,4),Ne=He(fe.start,v.width,4);De.start<=Te+1&&ue===Ne&&He(De.start+De.count-1,v.width,4)===ue?fe.count=Math.max(fe.count,De.start+De.count-fe.start):(++Ae,X[Ae]=De)}X.length=Ae+1;const ae=r.getParameter(r.UNPACK_ROW_LENGTH),Se=r.getParameter(r.UNPACK_SKIP_PIXELS),Ee=r.getParameter(r.UNPACK_SKIP_ROWS);r.pixelStorei(r.UNPACK_ROW_LENGTH,v.width);for(let ie=0,fe=X.length;ie<fe;ie++){const De=X[ie],Te=Math.floor(De.start/4),ue=Math.ceil(De.count/4),Ne=Te%v.width,L=Math.floor(Te/v.width),re=ue,oe=1;r.pixelStorei(r.UNPACK_SKIP_PIXELS,Ne),r.pixelStorei(r.UNPACK_SKIP_ROWS,L),t.texSubImage2D(r.TEXTURE_2D,0,Ne,L,re,oe,F,Y,v.data)}A.clearUpdateRanges(),r.pixelStorei(r.UNPACK_ROW_LENGTH,ae),r.pixelStorei(r.UNPACK_SKIP_PIXELS,Se),r.pixelStorei(r.UNPACK_SKIP_ROWS,Ee)}}function Z(A,v,F){let Y=r.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(Y=r.TEXTURE_2D_ARRAY),v.isData3DTexture&&(Y=r.TEXTURE_3D);const Q=Oe(A,v),X=v.source;t.bindTexture(Y,A.__webglTexture,r.TEXTURE0+F);const Ae=n.get(X);if(X.version!==Ae.__version||Q===!0){t.activeTexture(r.TEXTURE0+F);const ae=$e.getPrimaries($e.workingColorSpace),Se=v.colorSpace===Yn?null:$e.getPrimaries(v.colorSpace),Ee=v.colorSpace===Yn||ae===Se?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,v.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,v.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);let ie=_(v.image,!1,i.maxTextureSize);ie=Ye(v,ie);const fe=s.convert(v.format,v.colorSpace),De=s.convert(v.type);let Te=T(v.internalFormat,fe,De,v.colorSpace,v.isVideoTexture);be(Y,v);let ue;const Ne=v.mipmaps,L=v.isVideoTexture!==!0,re=Ae.__version===void 0||Q===!0,oe=X.dataReady,ge=b(v,ie);if(v.isDepthTexture)Te=M(v.format===Nr,v.type),re&&(L?t.texStorage2D(r.TEXTURE_2D,1,Te,ie.width,ie.height):t.texImage2D(r.TEXTURE_2D,0,Te,ie.width,ie.height,0,fe,De,null));else if(v.isDataTexture)if(Ne.length>0){L&&re&&t.texStorage2D(r.TEXTURE_2D,ge,Te,Ne[0].width,Ne[0].height);for(let te=0,j=Ne.length;te<j;te++)ue=Ne[te],L?oe&&t.texSubImage2D(r.TEXTURE_2D,te,0,0,ue.width,ue.height,fe,De,ue.data):t.texImage2D(r.TEXTURE_2D,te,Te,ue.width,ue.height,0,fe,De,ue.data);v.generateMipmaps=!1}else L?(re&&t.texStorage2D(r.TEXTURE_2D,ge,Te,ie.width,ie.height),oe&&Be(v,ie,fe,De)):t.texImage2D(r.TEXTURE_2D,0,Te,ie.width,ie.height,0,fe,De,ie.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){L&&re&&t.texStorage3D(r.TEXTURE_2D_ARRAY,ge,Te,Ne[0].width,Ne[0].height,ie.depth);for(let te=0,j=Ne.length;te<j;te++)if(ue=Ne[te],v.format!==pn)if(fe!==null)if(L){if(oe)if(v.layerUpdates.size>0){const Me=$l(ue.width,ue.height,v.format,v.type);for(const Ue of v.layerUpdates){const rt=ue.data.subarray(Ue*Me/ue.data.BYTES_PER_ELEMENT,(Ue+1)*Me/ue.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,te,0,0,Ue,ue.width,ue.height,1,fe,rt)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,te,0,0,0,ue.width,ue.height,ie.depth,fe,ue.data)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,te,Te,ue.width,ue.height,ie.depth,0,ue.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else L?oe&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,te,0,0,0,ue.width,ue.height,ie.depth,fe,De,ue.data):t.texImage3D(r.TEXTURE_2D_ARRAY,te,Te,ue.width,ue.height,ie.depth,0,fe,De,ue.data)}else{L&&re&&t.texStorage2D(r.TEXTURE_2D,ge,Te,Ne[0].width,Ne[0].height);for(let te=0,j=Ne.length;te<j;te++)ue=Ne[te],v.format!==pn?fe!==null?L?oe&&t.compressedTexSubImage2D(r.TEXTURE_2D,te,0,0,ue.width,ue.height,fe,ue.data):t.compressedTexImage2D(r.TEXTURE_2D,te,Te,ue.width,ue.height,0,ue.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):L?oe&&t.texSubImage2D(r.TEXTURE_2D,te,0,0,ue.width,ue.height,fe,De,ue.data):t.texImage2D(r.TEXTURE_2D,te,Te,ue.width,ue.height,0,fe,De,ue.data)}else if(v.isDataArrayTexture)if(L){if(re&&t.texStorage3D(r.TEXTURE_2D_ARRAY,ge,Te,ie.width,ie.height,ie.depth),oe)if(v.layerUpdates.size>0){const te=$l(ie.width,ie.height,v.format,v.type);for(const j of v.layerUpdates){const Me=ie.data.subarray(j*te/ie.data.BYTES_PER_ELEMENT,(j+1)*te/ie.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,j,ie.width,ie.height,1,fe,De,Me)}v.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,ie.width,ie.height,ie.depth,fe,De,ie.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,Te,ie.width,ie.height,ie.depth,0,fe,De,ie.data);else if(v.isData3DTexture)L?(re&&t.texStorage3D(r.TEXTURE_3D,ge,Te,ie.width,ie.height,ie.depth),oe&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,ie.width,ie.height,ie.depth,fe,De,ie.data)):t.texImage3D(r.TEXTURE_3D,0,Te,ie.width,ie.height,ie.depth,0,fe,De,ie.data);else if(v.isFramebufferTexture){if(re)if(L)t.texStorage2D(r.TEXTURE_2D,ge,Te,ie.width,ie.height);else{let te=ie.width,j=ie.height;for(let Me=0;Me<ge;Me++)t.texImage2D(r.TEXTURE_2D,Me,Te,te,j,0,fe,De,null),te>>=1,j>>=1}}else if(Ne.length>0){if(L&&re){const te=je(Ne[0]);t.texStorage2D(r.TEXTURE_2D,ge,Te,te.width,te.height)}for(let te=0,j=Ne.length;te<j;te++)ue=Ne[te],L?oe&&t.texSubImage2D(r.TEXTURE_2D,te,0,0,fe,De,ue):t.texImage2D(r.TEXTURE_2D,te,Te,fe,De,ue);v.generateMipmaps=!1}else if(L){if(re){const te=je(ie);t.texStorage2D(r.TEXTURE_2D,ge,Te,te.width,te.height)}oe&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,fe,De,ie)}else t.texImage2D(r.TEXTURE_2D,0,Te,fe,De,ie);m(v)&&d(Y),Ae.__version=X.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function J(A,v,F){if(v.image.length!==6)return;const Y=Oe(A,v),Q=v.source;t.bindTexture(r.TEXTURE_CUBE_MAP,A.__webglTexture,r.TEXTURE0+F);const X=n.get(Q);if(Q.version!==X.__version||Y===!0){t.activeTexture(r.TEXTURE0+F);const Ae=$e.getPrimaries($e.workingColorSpace),ae=v.colorSpace===Yn?null:$e.getPrimaries(v.colorSpace),Se=v.colorSpace===Yn||Ae===ae?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,v.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,v.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Se);const Ee=v.isCompressedTexture||v.image[0].isCompressedTexture,ie=v.image[0]&&v.image[0].isDataTexture,fe=[];for(let j=0;j<6;j++)!Ee&&!ie?fe[j]=_(v.image[j],!0,i.maxCubemapSize):fe[j]=ie?v.image[j].image:v.image[j],fe[j]=Ye(v,fe[j]);const De=fe[0],Te=s.convert(v.format,v.colorSpace),ue=s.convert(v.type),Ne=T(v.internalFormat,Te,ue,v.colorSpace),L=v.isVideoTexture!==!0,re=X.__version===void 0||Y===!0,oe=Q.dataReady;let ge=b(v,De);be(r.TEXTURE_CUBE_MAP,v);let te;if(Ee){L&&re&&t.texStorage2D(r.TEXTURE_CUBE_MAP,ge,Ne,De.width,De.height);for(let j=0;j<6;j++){te=fe[j].mipmaps;for(let Me=0;Me<te.length;Me++){const Ue=te[Me];v.format!==pn?Te!==null?L?oe&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,0,0,Ue.width,Ue.height,Te,Ue.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,Ne,Ue.width,Ue.height,0,Ue.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?oe&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,0,0,Ue.width,Ue.height,Te,ue,Ue.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me,Ne,Ue.width,Ue.height,0,Te,ue,Ue.data)}}}else{if(te=v.mipmaps,L&&re){te.length>0&&ge++;const j=je(fe[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,ge,Ne,j.width,j.height)}for(let j=0;j<6;j++)if(ie){L?oe&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,fe[j].width,fe[j].height,Te,ue,fe[j].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Ne,fe[j].width,fe[j].height,0,Te,ue,fe[j].data);for(let Me=0;Me<te.length;Me++){const rt=te[Me].image[j].image;L?oe&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,0,0,rt.width,rt.height,Te,ue,rt.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,Ne,rt.width,rt.height,0,Te,ue,rt.data)}}else{L?oe&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,0,0,Te,ue,fe[j]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,0,Ne,Te,ue,fe[j]);for(let Me=0;Me<te.length;Me++){const Ue=te[Me];L?oe&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,0,0,Te,ue,Ue.image[j]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+j,Me+1,Ne,Te,ue,Ue.image[j])}}}m(v)&&d(r.TEXTURE_CUBE_MAP),X.__version=Q.version,v.onUpdate&&v.onUpdate(v)}A.__version=v.version}function me(A,v,F,Y,Q,X){const Ae=s.convert(F.format,F.colorSpace),ae=s.convert(F.type),Se=T(F.internalFormat,Ae,ae,F.colorSpace),Ee=n.get(v),ie=n.get(F);if(ie.__renderTarget=v,!Ee.__hasExternalTextures){const fe=Math.max(1,v.width>>X),De=Math.max(1,v.height>>X);Q===r.TEXTURE_3D||Q===r.TEXTURE_2D_ARRAY?t.texImage3D(Q,X,Se,fe,De,v.depth,0,Ae,ae,null):t.texImage2D(Q,X,Se,fe,De,0,Ae,ae,null)}t.bindFramebuffer(r.FRAMEBUFFER,A),ee(v)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Y,Q,ie.__webglTexture,0,xe(v)):(Q===r.TEXTURE_2D||Q>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&Q<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,Y,Q,ie.__webglTexture,X),t.bindFramebuffer(r.FRAMEBUFFER,null)}function Pe(A,v,F){if(r.bindRenderbuffer(r.RENDERBUFFER,A),v.depthBuffer){const Y=v.depthTexture,Q=Y&&Y.isDepthTexture?Y.type:null,X=M(v.stencilBuffer,Q),Ae=v.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,ae=xe(v);ee(v)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,ae,X,v.width,v.height):F?r.renderbufferStorageMultisample(r.RENDERBUFFER,ae,X,v.width,v.height):r.renderbufferStorage(r.RENDERBUFFER,X,v.width,v.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,Ae,r.RENDERBUFFER,A)}else{const Y=v.textures;for(let Q=0;Q<Y.length;Q++){const X=Y[Q],Ae=s.convert(X.format,X.colorSpace),ae=s.convert(X.type),Se=T(X.internalFormat,Ae,ae,X.colorSpace),Ee=xe(v);F&&ee(v)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,Ee,Se,v.width,v.height):ee(v)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,Ee,Se,v.width,v.height):r.renderbufferStorage(r.RENDERBUFFER,Se,v.width,v.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function ye(A,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(r.FRAMEBUFFER,A),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Y=n.get(v.depthTexture);Y.__renderTarget=v,(!Y.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),V(v.depthTexture,0);const Q=Y.__webglTexture,X=xe(v);if(v.depthTexture.format===Ur)ee(v)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,Q,0,X):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,Q,0);else if(v.depthTexture.format===Nr)ee(v)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,Q,0,X):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,Q,0);else throw new Error("Unknown depthTexture format")}function ke(A){const v=n.get(A),F=A.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==A.depthTexture){const Y=A.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),Y){const Q=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,Y.removeEventListener("dispose",Q)};Y.addEventListener("dispose",Q),v.__depthDisposeCallback=Q}v.__boundDepthTexture=Y}if(A.depthTexture&&!v.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");const Y=A.texture.mipmaps;Y&&Y.length>0?ye(v.__webglFramebuffer[0],A):ye(v.__webglFramebuffer,A)}else if(F){v.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(t.bindFramebuffer(r.FRAMEBUFFER,v.__webglFramebuffer[Y]),v.__webglDepthbuffer[Y]===void 0)v.__webglDepthbuffer[Y]=r.createRenderbuffer(),Pe(v.__webglDepthbuffer[Y],A,!1);else{const Q=A.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,X=v.__webglDepthbuffer[Y];r.bindRenderbuffer(r.RENDERBUFFER,X),r.framebufferRenderbuffer(r.FRAMEBUFFER,Q,r.RENDERBUFFER,X)}}else{const Y=A.texture.mipmaps;if(Y&&Y.length>0?t.bindFramebuffer(r.FRAMEBUFFER,v.__webglFramebuffer[0]):t.bindFramebuffer(r.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=r.createRenderbuffer(),Pe(v.__webglDepthbuffer,A,!1);else{const Q=A.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,X=v.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,X),r.framebufferRenderbuffer(r.FRAMEBUFFER,Q,r.RENDERBUFFER,X)}}t.bindFramebuffer(r.FRAMEBUFFER,null)}function _t(A,v,F){const Y=n.get(A);v!==void 0&&me(Y.__webglFramebuffer,A,A.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),F!==void 0&&ke(A)}function P(A){const v=A.texture,F=n.get(A),Y=n.get(v);A.addEventListener("dispose",R);const Q=A.textures,X=A.isWebGLCubeRenderTarget===!0,Ae=Q.length>1;if(Ae||(Y.__webglTexture===void 0&&(Y.__webglTexture=r.createTexture()),Y.__version=v.version,a.memory.textures++),X){F.__webglFramebuffer=[];for(let ae=0;ae<6;ae++)if(v.mipmaps&&v.mipmaps.length>0){F.__webglFramebuffer[ae]=[];for(let Se=0;Se<v.mipmaps.length;Se++)F.__webglFramebuffer[ae][Se]=r.createFramebuffer()}else F.__webglFramebuffer[ae]=r.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){F.__webglFramebuffer=[];for(let ae=0;ae<v.mipmaps.length;ae++)F.__webglFramebuffer[ae]=r.createFramebuffer()}else F.__webglFramebuffer=r.createFramebuffer();if(Ae)for(let ae=0,Se=Q.length;ae<Se;ae++){const Ee=n.get(Q[ae]);Ee.__webglTexture===void 0&&(Ee.__webglTexture=r.createTexture(),a.memory.textures++)}if(A.samples>0&&ee(A)===!1){F.__webglMultisampledFramebuffer=r.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let ae=0;ae<Q.length;ae++){const Se=Q[ae];F.__webglColorRenderbuffer[ae]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,F.__webglColorRenderbuffer[ae]);const Ee=s.convert(Se.format,Se.colorSpace),ie=s.convert(Se.type),fe=T(Se.internalFormat,Ee,ie,Se.colorSpace,A.isXRRenderTarget===!0),De=xe(A);r.renderbufferStorageMultisample(r.RENDERBUFFER,De,fe,A.width,A.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+ae,r.RENDERBUFFER,F.__webglColorRenderbuffer[ae])}r.bindRenderbuffer(r.RENDERBUFFER,null),A.depthBuffer&&(F.__webglDepthRenderbuffer=r.createRenderbuffer(),Pe(F.__webglDepthRenderbuffer,A,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if(X){t.bindTexture(r.TEXTURE_CUBE_MAP,Y.__webglTexture),be(r.TEXTURE_CUBE_MAP,v);for(let ae=0;ae<6;ae++)if(v.mipmaps&&v.mipmaps.length>0)for(let Se=0;Se<v.mipmaps.length;Se++)me(F.__webglFramebuffer[ae][Se],A,v,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ae,Se);else me(F.__webglFramebuffer[ae],A,v,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+ae,0);m(v)&&d(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(Ae){for(let ae=0,Se=Q.length;ae<Se;ae++){const Ee=Q[ae],ie=n.get(Ee);let fe=r.TEXTURE_2D;(A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(fe=A.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(fe,ie.__webglTexture),be(fe,Ee),me(F.__webglFramebuffer,A,Ee,r.COLOR_ATTACHMENT0+ae,fe,0),m(Ee)&&d(fe)}t.unbindTexture()}else{let ae=r.TEXTURE_2D;if((A.isWebGL3DRenderTarget||A.isWebGLArrayRenderTarget)&&(ae=A.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(ae,Y.__webglTexture),be(ae,v),v.mipmaps&&v.mipmaps.length>0)for(let Se=0;Se<v.mipmaps.length;Se++)me(F.__webglFramebuffer[Se],A,v,r.COLOR_ATTACHMENT0,ae,Se);else me(F.__webglFramebuffer,A,v,r.COLOR_ATTACHMENT0,ae,0);m(v)&&d(ae),t.unbindTexture()}A.depthBuffer&&ke(A)}function Ze(A){const v=A.textures;for(let F=0,Y=v.length;F<Y;F++){const Q=v[F];if(m(Q)){const X=E(A),Ae=n.get(Q).__webglTexture;t.bindTexture(X,Ae),d(X),t.unbindTexture()}}}const Ie=[],$=[];function W(A){if(A.samples>0){if(ee(A)===!1){const v=A.textures,F=A.width,Y=A.height;let Q=r.COLOR_BUFFER_BIT;const X=A.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,Ae=n.get(A),ae=v.length>1;if(ae)for(let Ee=0;Ee<v.length;Ee++)t.bindFramebuffer(r.FRAMEBUFFER,Ae.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ee,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,Ae.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ee,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,Ae.__webglMultisampledFramebuffer);const Se=A.texture.mipmaps;Se&&Se.length>0?t.bindFramebuffer(r.DRAW_FRAMEBUFFER,Ae.__webglFramebuffer[0]):t.bindFramebuffer(r.DRAW_FRAMEBUFFER,Ae.__webglFramebuffer);for(let Ee=0;Ee<v.length;Ee++){if(A.resolveDepthBuffer&&(A.depthBuffer&&(Q|=r.DEPTH_BUFFER_BIT),A.stencilBuffer&&A.resolveStencilBuffer&&(Q|=r.STENCIL_BUFFER_BIT)),ae){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,Ae.__webglColorRenderbuffer[Ee]);const ie=n.get(v[Ee]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,ie,0)}r.blitFramebuffer(0,0,F,Y,0,0,F,Y,Q,r.NEAREST),c===!0&&(Ie.length=0,$.length=0,Ie.push(r.COLOR_ATTACHMENT0+Ee),A.depthBuffer&&A.resolveDepthBuffer===!1&&(Ie.push(X),$.push(X),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,$)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,Ie))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),ae)for(let Ee=0;Ee<v.length;Ee++){t.bindFramebuffer(r.FRAMEBUFFER,Ae.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ee,r.RENDERBUFFER,Ae.__webglColorRenderbuffer[Ee]);const ie=n.get(v[Ee]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,Ae.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+Ee,r.TEXTURE_2D,ie,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,Ae.__webglMultisampledFramebuffer)}else if(A.depthBuffer&&A.resolveDepthBuffer===!1&&c){const v=A.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[v])}}}function xe(A){return Math.min(i.maxSamples,A.samples)}function ee(A){const v=n.get(A);return A.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function de(A){const v=a.render.frame;u.get(A)!==v&&(u.set(A,v),A.update())}function Ye(A,v){const F=A.colorSpace,Y=A.format,Q=A.type;return A.isCompressedTexture===!0||A.isVideoTexture===!0||F!==lr&&F!==Yn&&($e.getTransfer(F)===et?(Y!==pn||Q!==bn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),v}function je(A){return typeof HTMLImageElement<"u"&&A instanceof HTMLImageElement?(l.width=A.naturalWidth||A.width,l.height=A.naturalHeight||A.height):typeof VideoFrame<"u"&&A instanceof VideoFrame?(l.width=A.displayWidth,l.height=A.displayHeight):(l.width=A.width,l.height=A.height),l}this.allocateTextureUnit=O,this.resetTextureUnits=N,this.setTexture2D=V,this.setTexture2DArray=G,this.setTexture3D=K,this.setTextureCube=z,this.rebindTextures=_t,this.setupRenderTarget=P,this.updateRenderTargetMipmap=Ze,this.updateMultisampleRenderTarget=W,this.setupDepthRenderbuffer=ke,this.setupFrameBufferTexture=me,this.useMultisampledRTT=ee}function Ag(r,e){function t(n,i=Yn){let s;const a=$e.getTransfer(i);if(n===bn)return r.UNSIGNED_BYTE;if(n===Ho)return r.UNSIGNED_SHORT_4_4_4_4;if(n===Vo)return r.UNSIGNED_SHORT_5_5_5_1;if(n===Vc)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===Gc)return r.UNSIGNED_INT_10F_11F_11F_REV;if(n===kc)return r.BYTE;if(n===Hc)return r.SHORT;if(n===Lr)return r.UNSIGNED_SHORT;if(n===ko)return r.INT;if(n===Ci)return r.UNSIGNED_INT;if(n===On)return r.FLOAT;if(n===Xr)return r.HALF_FLOAT;if(n===Wc)return r.ALPHA;if(n===Xc)return r.RGB;if(n===pn)return r.RGBA;if(n===Ur)return r.DEPTH_COMPONENT;if(n===Nr)return r.DEPTH_STENCIL;if(n===qc)return r.RED;if(n===Go)return r.RED_INTEGER;if(n===Yc)return r.RG;if(n===Wo)return r.RG_INTEGER;if(n===Xo)return r.RGBA_INTEGER;if(n===ys||n===Es||n===Ts||n===bs)if(a===et)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===ys)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===Es)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Ts)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===bs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===ys)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===Es)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Ts)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===bs)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ya||n===Ka||n===$a||n===Za)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Ya)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ka)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===$a)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Za)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ja||n===Ja||n===Qa)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===ja||n===Ja)return a===et?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Qa)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===eo||n===to||n===no||n===io||n===ro||n===so||n===ao||n===oo||n===lo||n===co||n===uo||n===ho||n===fo||n===po)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===eo)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===to)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===no)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===io)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ro)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===so)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===ao)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===oo)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===lo)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===co)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===uo)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ho)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===fo)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===po)return a===et?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===mo||n===_o||n===go)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===mo)return a===et?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===_o)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===go)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===vo||n===xo||n===Mo||n===So)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===vo)return s.COMPRESSED_RED_RGTC1_EXT;if(n===xo)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Mo)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===So)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ir?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:t}}const wg=`
void main() {
...
}`;class Cg{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new ou(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new ni({vertexShader:wg,fragmentShader:Rg,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new mn(new ks(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Pg extends _r{constructor(e,t){super();const n=this;let i=null,s=1,a=null,o="local-floor",c=1,l=null,u=null,h=null,f=null,p=null,g=null;const _=typeof XRWebGLBinding<"u",m=new Cg,d={},E=t.getContextAttributes();let T=null,M=null;const b=[],w=[],R=new qe;let C=null;const x=new sn;x.viewport=new ft;const y=new sn;y.viewport=new ft;const D=[x,y],N=new jf;let O=null,q=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(Z){let J=b[Z];return J===void 0&&(J=new _a,b[Z]=J),J.getTargetRaySpace()},this.getControllerGrip=function(Z){let J=b[Z];return J===void 0&&(J=new _a,b[Z]=J),J.getGripSpace()},this.getHand=function(Z){let J=b[Z];return J===void 0&&(J=new _a,b[Z]=J),J.getHandSpace()};function V(Z){const J=w.indexOf(Z.inputSource);if(J===-1)return;const me=b[J];me!==void 0&&(me.update(Z.inputSource,Z.frame,l||a),me.dispatchEvent({type:Z.type,data:Z.inputSource}))}function G(){i.removeEventListener("select",V),i.removeEventListener("selectstart",V),i.removeEventListener("selectend",V),i.removeEventListener("squeeze",V),i.removeEventListener("squeezestart",V),i.removeEventListener("squeezeend",V),i.removeEventListener("end",G),i.removeEventListener("inputsourceschange",K);for(let Z=0;Z<b.length;Z++){const J=w[Z];J!==null&&(w[Z]=null,b[Z].disconnect(J))}O=null,q=null,m.reset();for(const Z in d)delete d[Z];e.setRenderTarget(T),p=null,f=null,h=null,i=null,M=null,Be.stop(),n.isPresenting=!1,e.setPixelRatio(C),e.setSize(R.width,R.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(Z){s=Z,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(Z){o=Z,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(Z){l=Z},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return h===null&&_&&(h=new XRWebGLBinding(i,t)),h},this.getFrame=function(){return g},this.getSession=function(){return i},this.setSession=async function(Z){if(i=Z,i!==null){if(T=e.getRenderTarget(),i.addEventListener("select",V),i.addEventListener("selectstart",V),i.addEventListener("selectend",V),i.addEventListener("squeeze",V),i.addEventListener("squeezestart",V),i.addEventListener("squeezeend",V),i.addEventListener("end",G),i.addEventListener("inputsourceschange",K),E.xrCompatible!==!0&&await t.makeXRCompatible(),C=e.getPixelRatio(),e.getSize(R),_&&"createProjectionLayer"in XRWebGLBinding.prototype){let me=null,Pe=null,ye=null;E.depth&&(ye=E.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,me=E.stencil?Nr:Ur,Pe=E.stencil?Ir:Ci);const ke={colorFormat:t.RGBA8,depthFormat:ye,scaleFactor:s};h=this.getBinding(),f=h.createProjectionLayer(ke),i.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),M=new Pi(f.textureWidth,f.textureHeight,{format:pn,type:bn,depthTexture:new au(f.textureWidth,f.textureHeight,Pe,void 0,void 0,void 0,void 0,void 0,void 0,me),stencilBuffer:E.stencil,colorSpace:e.outputColorSpace,samples:E.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const me={antialias:E.antialias,alpha:!0,depth:E.depth,stencil:E.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(i,t,me),i.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),M=new Pi(p.framebufferWidth,p.framebufferHeight,{format:pn,type:bn,colorSpace:e.outputColorSpace,stencilBuffer:E.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await i.requestReferenceSpace(o),Be.setContext(i),Be.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(i!==null)return i.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function K(Z){for(let J=0;J<Z.removed.length;J++){const me=Z.removed[J],Pe=w.indexOf(me);Pe>=0&&(w[Pe]=null,b[Pe].disconnect(me))}for(let J=0;J<Z.added.length;J++){const me=Z.added[J];let Pe=w.indexOf(me);if(Pe===-1){for(let ke=0;ke<b.length;ke++)if(ke>=w.length){w.push(me),Pe=ke;break}else if(w[ke]===null){w[ke]=me,Pe=ke;break}if(Pe===-1)break}const ye=b[Pe];ye&&ye.connect(me)}}const z=new B,se=new B;function le(Z,J,me){z.setFromMatrixPosition(J.matrixWorld),se.setFromMatrixPosition(me.matrixWorld);const Pe=z.distanceTo(se),ye=J.projectionMatrix.elements,ke=me.projectionMatrix.elements,_t=ye[14]/(ye[10]-1),P=ye[14]/(ye[10]+1),Ze=(ye[9]+1)/ye[5],Ie=(ye[9]-1)/ye[5],$=(ye[8]-1)/ye[0],W=(ke[8]+1)/ke[0],xe=_t*$,ee=_t*W,de=Pe/(-$+W),Ye=de*-$;if(J.matrixWorld.decompose(Z.position,Z.quaternion,Z.scale),Z.translateX(Ye),Z.translateZ(de),Z.matrixWorld.compose(Z.position,Z.quaternion,Z.scale),Z.matrixWorldInverse.copy(Z.matrixWorld).invert(),ye[10]===-1)Z.projectionMatrix.copy(J.projectionMatrix),Z.projectionMatrixInverse.copy(J.projectionMatrixInverse);else{const je=_t+de,A=P+de,v=xe-Ye,F=ee+(Pe-Ye),Y=Ze*P/A*je,Q=Ie*P/A*je;Z.projectionMatrix.makePerspective(v,F,Y,Q,je,A),Z.projectionMatrixInverse.copy(Z.projectionMatrix).invert()}}function _e(Z,J){J===null?Z.matrixWorld.copy(Z.matrix):Z.matrixWorld.multiplyMatrices(J.matrixWorld,Z.matrix),Z.matrixWorldInverse.copy(Z.matrixWorld).invert()}this.updateCamera=function(Z){if(i===null)return;let J=Z.near,me=Z.far;m.texture!==null&&(m.depthNear>0&&(J=m.depthNear),m.depthFar>0&&(me=m.depthFar)),N.near=y.near=x.near=J,N.far=y.far=x.far=me,(O!==N.near||q!==N.far)&&(i.updateRenderState({depthNear:N.near,depthFar:N.far}),O=N.near,q=N.far),N.layers.mask=Z.layers.mask|6,x.layers.mask=N.layers.mask&3,y.layers.mask=N.layers.mask&5;const Pe=Z.parent,ye=N.cameras;_e(N,Pe);for(let ke=0;ke<ye.length;ke++)_e(ye[ke],Pe);ye.length===2?le(N,x,y):N.projectionMatrix.copy(x.projectionMatrix),be(Z,N,Pe)};function be(Z,J,me){me===null?Z.matrix.copy(J.matrixWorld):(Z.matrix.copy(me.matrixWorld),Z.matrix.invert(),Z.matrix.multiply(J.matrixWorld)),Z.matrix.decompose(Z.position,Z.quaternion,Z.scale),Z.updateMatrixWorld(!0),Z.projectionMatrix.copy(J.projectionMatrix),Z.projectionMatrixInverse.copy(J.projectionMatrixInverse),Z.isPerspectiveCamera&&(Z.fov=yo*2*Math.atan(1/Z.projectionMatrix.elements[5]),Z.zoom=1)}this.getCamera=function(){return N},this.getFoveation=function(){if(!(f===null&&p===null))return c},this.setFoveation=function(Z){c=Z,f!==null&&(f.fixedFoveation=Z),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=Z)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(N)},this.getCameraTexture=function(Z){return d[Z]};let Oe=null;function He(Z,J){if(u=J.getViewerPose(l||a),g=J,u!==null){const me=u.views;p!==null&&(e.setRenderTargetFramebuffer(M,p.framebuffer),e.setRenderTarget(M));let Pe=!1;me.length!==N.cameras.length&&(N.cameras.length=0,Pe=!0);for(let P=0;P<me.length;P++){const Ze=me[P];let Ie=null;if(p!==null)Ie=p.getViewport(Ze);else{const W=h.getViewSubImage(f,Ze);Ie=W.viewport,P===0&&(e.setRenderTargetTextures(M,W.colorTexture,W.depthStencilTexture),e.setRenderTarget(M))}let $=D[P];$===void 0&&($=new sn,$.layers.enable(P),$.viewport=new ft,D[P]=$),$.matrix.fromArray(Ze.transform.matrix),$.matrix.decompose($.position,$.quaternion,$.scale),$.projectionMatrix.fromArray(Ze.projectionMatrix),$.projectionMatrixInverse.copy($.projectionMatrix).invert(),$.viewport.set(Ie.x,Ie.y,Ie.width,Ie.height),P===0&&(N.matrix.copy($.matrix),N.matrix.decompose(N.position,N.quaternion,N.scale)),Pe===!0&&N.cameras.push($)}const ye=i.enabledFeatures;if(ye&&ye.includes("depth-sensing")&&i.depthUsage=="gpu-optimized"&&_){h=n.getBinding();const P=h.getDepthInformation(me[0]);P&&P.isValid&&P.texture&&m.init(P,i.renderState)}if(ye&&ye.includes("camera-access")&&_){e.state.unbindTexture(),h=n.getBinding();for(let P=0;P<me.length;P++){const Ze=me[P].camera;if(Ze){let Ie=d[Ze];Ie||(Ie=new ou,d[Ze]=Ie);const $=h.getCameraImage(Ze);Ie.sourceTexture=$}}}}for(let me=0;me<b.length;me++){const Pe=w[me],ye=b[me];Pe!==null&&ye!==void 0&&ye.update(Pe,J,l||a)}Oe&&Oe(Z,J),J.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:J}),g=null}const Be=new uu;Be.setAnimationLoop(He),this.setAnimationLoop=function(Z){Oe=Z},this.dispose=function(){}}}const pi=new An,Dg=new mt;function Lg(r,e){function t(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function n(m,d){d.color.getRGB(m.fogColor.value,iu(r)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function i(m,d,E,T,M){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(m,d):d.isMeshToonMaterial?(s(m,d),h(m,d)):d.isMeshPhongMaterial?(s(m,d),u(m,d)):d.isMeshStandardMaterial?(s(m,d),f(m,d),d.isMeshPhysicalMaterial&&p(m,d,M)):d.isMeshMatcapMaterial?(s(m,d),g(m,d)):d.isMeshDepthMaterial?s(m,d):d.isMeshDistanceMaterial?(s(m,d),_(m,d)):d.isMeshNormalMaterial?s(m,d):d.isLineBasicMaterial?(a(m,d),d.isLineDashedMaterial&&o(m,d)):d.isPointsMaterial?c(m,d,E,T):d.isSpriteMaterial?l(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,t(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===Ot&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,t(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===Ot&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,t(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,t(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);const E=e.get(d),T=E.envMap,M=E.envMapRotation;T&&(m.envMap.value=T,pi.copy(M),pi.x*=-1,pi.y*=-1,pi.z*=-1,T.isCubeTexture&&T.isRenderTargetTexture===!1&&(pi.y*=-1,pi.z*=-1),m.envMapRotation.value.setFromMatrix4(Dg.makeRotationFromEuler(pi)),m.flipEnvMap.value=T.isCubeTexture&&T.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap&&(m.lightMap.value=d.lightMap,m.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,m.lightMapTransform)),d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,m.aoMapTransform))}function a(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform))}function o(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function c(m,d,E,T){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*E,m.scale.value=T*.5,d.map&&(m.map.value=d.map,t(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function l(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function u(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function h(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function f(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,m.roughnessMapTransform)),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function p(m,d,E){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Ot&&m.clearcoatNormalScale.value.negate())),d.dispersion>0&&(m.dispersion.value=d.dispersion),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=E.texture,m.transmissionSamplerSize.value.set(E.width,E.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,d){d.matcap&&(m.matcap.value=d.matcap)}function _(m,d){const E=e.get(d).light;m.referencePosition.value.setFromMatrixPosition(E.matrixWorld),m.nearDistance.value=E.shadow.camera.near,m.farDistance.value=E.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:i}}function Ig(r,e,t,n){let i={},s={},a=[];const o=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function c(E,T){const M=T.program;n.uniformBlockBinding(E,M)}function l(E,T){let M=i[E.id];M===void 0&&(g(E),M=u(E),i[E.id]=M,E.addEventListener("dispose",m));const b=T.program;n.updateUBOMapping(E,b);const w=e.render.frame;s[E.id]!==w&&(f(E),s[E.id]=w)}function u(E){const T=h();E.__bindingPointIndex=T;const M=r.createBuffer(),b=E.__size,w=E.usage;return r.bindBuffer(r.UNIFORM_BUFFER,M),r.bufferData(r.UNIFORM_BUFFER,b,w),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,T,M),M}function h(){for(let E=0;E<o;E++)if(a.indexOf(E)===-1)return a.push(E),E;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(E){const T=i[E.id],M=E.uniforms,b=E.__cache;r.bindBuffer(r.UNIFORM_BUFFER,T);for(let w=0,R=M.length;w<R;w++){const C=Array.isArray(M[w])?M[w]:[M[w]];for(let x=0,y=C.length;x<y;x++){const D=C[x];if(p(D,w,x,b)===!0){const N=D.__offset,O=Array.isArray(D.value)?D.value:[D.value];let q=0;for(let V=0;V<O.length;V++){const G=O[V],K=_(G);typeof G=="number"||typeof G=="boolean"?(D.__data[0]=G,r.bufferSubData(r.UNIFORM_BUFFER,N+q,D.__data)):G.isMatrix3?(D.__data[0]=G.elements[0],D.__data[1]=G.elements[1],D.__data[2]=G.elements[2],D.__data[3]=0,D.__data[4]=G.elements[3],D.__data[5]=G.elements[4],D.__data[6]=G.elements[5],D.__data[7]=0,D.__data[8]=G.elements[6],D.__data[9]=G.elements[7],D.__data[10]=G.elements[8],D.__data[11]=0):(G.toArray(D.__data,q),q+=K.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,N,D.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function p(E,T,M,b){const w=E.value,R=T+"_"+M;if(b[R]===void 0)return typeof w=="number"||typeof w=="boolean"?b[R]=w:b[R]=w.clone(),!0;{const C=b[R];if(typeof w=="number"||typeof w=="boolean"){if(C!==w)return b[R]=w,!0}else if(C.equals(w)===!1)return C.copy(w),!0}return!1}function g(E){const T=E.uniforms;let M=0;const b=16;for(let R=0,C=T.length;R<C;R++){const x=Array.isArray(T[R])?T[R]:[T[R]];for(let y=0,D=x.length;y<D;y++){const N=x[y],O=Array.isArray(N.value)?N.value:[N.value];for(let q=0,V=O.length;q<V;q++){const G=O[q],K=_(G),z=M%b,se=z%K.boundary,le=z+se;M+=se,le!==0&&b-le<K.storage&&(M+=b-le),N.__data=new Float32Array(K.storage/Float32Array.BYTES_PER_ELEMENT),N.__offset=M,M+=K.storage}}}const w=M%b;return w>0&&(M+=b-w),E.__size=M,E.__cache={},this}function _(E){const T={boundary:0,storage:0};return typeof E=="number"||typeof E=="boolean"?(T.boundary=4,T.storage=4):E.isVector2?(T.boundary=8,T.storage=8):E.isVector3||E.isColor?(T.boundary=16,T.storage=12):E.isVector4?(T.boundary=16,T.storage=16):E.isMatrix3?(T.boundary=48,T.storage=48):E.isMatrix4?(T.boundary=64,T.storage=64):E.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",E),T}function m(E){const T=E.target;T.removeEventListener("dispose",m);const M=a.indexOf(T.__bindingPointIndex);a.splice(M,1),r.deleteBuffer(i[T.id]),delete i[T.id],delete s[T.id]}function d(){for(const E in i)r.deleteBuffer(i[E]);a=[],i={},s={}}return{bind:c,update:l,dispose:d}}class Ug{constructor(e={}){const{canvas:t=cf(),context:n=null,depth:i=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:f=!1}=e;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=n.getContextAttributes().alpha}else p=a;const g=new Uint32Array(4),_=new Int32Array(4);let m=null,d=null;const E=[],T=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Jn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const M=this;let b=!1;this._outputColorSpace=rn;let w=0,R=0,C=null,x=-1,y=null;const D=new ft,N=new ft;let O=null;const q=new Xe(0);let V=0,G=t.width,K=t.height,z=1,se=null,le=null;const _e=new ft(0,0,G,K),be=new ft(0,0,G,K);let Oe=!1;const He=new Ko;let Be=!1,Z=!1;const J=new mt,me=new B,Pe=new ft,ye={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let ke=!1;function _t(){return C===null?z:1}let P=n;function Ze(S,I){return t.getContext(S,I)}try{const S={alpha:!0,depth:i,stencil:s,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${zo}`),t.addEventListener("webglcontextlost",oe,!1),t.addEventListener("webglcontextrestored",ge,!1),t.addEventListener("webglcontextcreationerror",te,!1),P===null){const I="webgl2";if(P=Ze(I,S),P===null)throw Ze(I)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(S){throw console.error("THREE.WebGLRenderer: "+S.message),S}let Ie,$,W,xe,ee,de,Ye,je,A,v,F,Y,Q,X,Ae,ae,Se,Ee,ie,fe,De,Te,ue,Ne;function L(){Ie=new Wm(P),Ie.init(),Te=new Ag(P,Ie),$=new Om(P,Ie,e,Te),W=new Tg(P,Ie),$.reversedDepthBuffer&&f&&W.buffers.depth.setReversed(!0),xe=new Ym(P),ee=new hg,de=new bg(P,Ie,W,ee,$,Te,xe),Ye=new zm(M),je=new Gm(M),A=new Qf(P),ue=new Nm(P,A),v=new Xm(P,A,xe,ue),F=new $m(P,v,A,xe),ie=new Km(P,$,de),ae=new Bm(ee),Y=new ug(M,Ye,je,Ie,$,ue,ae),Q=new Lg(M,ee),X=new dg,Ae=new xg(Ie),Ee=new Um(M,Ye,je,W,F,p,c),Se=new yg(M,F,$),Ne=new Ig(P,xe,$,W),fe=new Fm(P,Ie,xe),De=new qm(P,Ie,xe),xe.programs=Y.programs,M.capabilities=$,M.extensions=Ie,M.properties=ee,M.renderLists=X,M.shadowMap=Se,M.state=W,M.info=xe}L();const re=new Pg(M,P);this.xr=re,this.getContext=function(){return P},this.getContextAttributes=function(){return P.getContextAttributes()},this.forceContextLoss=function(){const S=Ie.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=Ie.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return z},this.setPixelRatio=function(S){S!==void 0&&(z=S,this.setSize(G,K,!1))},this.getSize=function(S){return S.set(G,K)},this.setSize=function(S,I,k=!0){if(re.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}G=S,K=I,t.width=Math.floor(S*z),t.height=Math.floor(I*z),k===!0&&(t.style.width=S+"px",t.style.height=I+"px"),this.setViewport(0,0,S,I)},this.getDrawingBufferSize=function(S){return S.set(G*z,K*z).floor()},this.setDrawingBufferSize=function(S,I,k){G=S,K=I,z=k,t.width=Math.floor(S*k),t.height=Math.floor(I*k),this.setViewport(0,0,S,I)},this.getCurrentViewport=function(S){return S.copy(D)},this.getViewport=function(S){return S.copy(_e)},this.setViewport=function(S,I,k,H){S.isVector4?_e.set(S.x,S.y,S.z,S.w):_e.set(S,I,k,H),W.viewport(D.copy(_e).multiplyScalar(z).round())},this.getScissor=function(S){return S.copy(be)},this.setScissor=function(S,I,k,H){S.isVector4?be.set(S.x,S.y,S.z,S.w):be.set(S,I,k,H),W.scissor(N.copy(be).multiplyScalar(z).round())},this.getScissorTest=function(){return Oe},this.setScissorTest=function(S){W.setScissorTest(Oe=S)},this.setOpaqueSort=function(S){se=S},this.setTransparentSort=function(S){le=S},this.getClearColor=function(S){return S.copy(Ee.getClearColor())},this.setClearColor=function(){Ee.setClearColor(...arguments)},this.getClearAlpha=function(){return Ee.getClearAlpha()},this.setClearAlpha=function(){Ee.setClearAlpha(...arguments)},this.clear=function(S=!0,I=!0,k=!0){let H=0;if(S){let U=!1;if(C!==null){const ne=C.texture.format;U=ne===Xo||ne===Wo||ne===Go}if(U){const ne=C.texture.type,he=ne===bn||ne===Ci||ne===Lr||ne===Ir||ne===Ho||ne===Vo,ve=Ee.getClearColor(),pe=Ee.getClearAlpha(),Ce=ve.r,Le=ve.g,we=ve.b;he?(g[0]=Ce,g[1]=Le,g[2]=we,g[3]=pe,P.clearBufferuiv(P.COLOR,0,g)):(_[0]=Ce,_[1]=Le,_[2]=we,_[3]=pe,P.clearBufferiv(P.COLOR,0,_))}else H|=P.COLOR_BUFFER_BIT}I&&(H|=P.DEPTH_BUFFER_BIT),k&&(H|=P.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),P.clear(H)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",oe,!1),t.removeEventListener("webglcontextrestored",ge,!1),t.removeEventListener("webglcontextcreationerror",te,!1),Ee.dispose(),X.dispose(),Ae.dispose(),ee.dispose(),Ye.dispose(),je.dispose(),F.dispose(),ue.dispose(),Ne.dispose(),Y.dispose(),re.dispose(),re.removeEventListener("sessionstart",_n),re.removeEventListener("sessionend",_l),oi.stop()};function oe(S){S.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),b=!0}function ge(){console.log("THREE.WebGLRenderer: Context Restored."),b=!1;const S=xe.autoReset,I=Se.enabled,k=Se.autoUpdate,H=Se.needsUpdate,U=Se.type;L(),xe.autoReset=S,Se.enabled=I,Se.autoUpdate=k,Se.needsUpdate=H,Se.type=U}function te(S){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function j(S){const I=S.target;I.removeEventListener("dispose",j),Me(I)}function Me(S){Ue(S),ee.remove(S)}function Ue(S){const I=ee.get(S).programs;I!==void 0&&(I.forEach(function(k){Y.releaseProgram(k)}),S.isShaderMaterial&&Y.releaseShaderCache(S))}this.renderBufferDirect=function(S,I,k,H,U,ne){I===null&&(I=ye);const he=U.isMesh&&U.matrixWorld.determinant()<0,ve=ph(S,I,k,H,U);W.setMaterial(H,he);let pe=k.index,Ce=1;if(H.wireframe===!0){if(pe=v.getWireframeAttribute(k),pe===void 0)return;Ce=2}const Le=k.drawRange,we=k.attributes.position;let Ve=Le.start*Ce,Qe=(Le.start+Le.count)*Ce;ne!==null&&(Ve=Math.max(Ve,ne.start*Ce),Qe=Math.min(Qe,(ne.start+ne.count)*Ce)),pe!==null?(Ve=Math.max(Ve,0),Qe=Math.min(Qe,pe.count)):we!=null&&(Ve=Math.max(Ve,0),Qe=Math.min(Qe,we.count));const ht=Qe-Ve;if(ht<0||ht===1/0)return;ue.setup(U,H,ve,k,pe);let st,tt=fe;if(pe!==null&&(st=A.get(pe),tt=De,tt.setIndex(st)),U.isMesh)H.wireframe===!0?(W.setLineWidth(H.wireframeLinewidth*_t()),tt.setMode(P.LINES)):tt.setMode(P.TRIANGLES);else if(U.isLine){let Re=H.linewidth;Re===void 0&&(Re=1),W.setLineWidth(Re*_t()),U.isLineSegments?tt.setMode(P.LINES):U.isLineLoop?tt.setMode(P.LINE_LOOP):tt.setMode(P.LINE_STRIP)}else U.isPoints?tt.setMode(P.POINTS):U.isSprite&&tt.setMode(P.TRIANGLES);if(U.isBatchedMesh)if(U._multiDrawInstances!==null)Or("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),tt.renderMultiDrawInstances(U._multiDrawStarts,U._multiDrawCounts,U._multiDrawCount,U._multiDrawInstances);else if(Ie.get("WEBGL_multi_draw"))tt.renderMultiDraw(U._multiDrawStarts,U._multiDrawCounts,U._multiDrawCount);else{const Re=U._multiDrawStarts,ot=U._multiDrawCounts,Ke=U._multiDrawCount,Gt=pe?A.get(pe).bytesPerElement:1,Ii=ee.get(H).currentProgram.getUniforms();for(let Wt=0;Wt<Ke;Wt++)Ii.setValue(P,"_gl_DrawID",Wt),tt.render(Re[Wt]/Gt,ot[Wt])}else if(U.isInstancedMesh)tt.renderInstances(Ve,ht,U.count);else if(k.isInstancedBufferGeometry){const Re=k._maxInstanceCount!==void 0?k._maxInstanceCount:1/0,ot=Math.min(k.instanceCount,Re);tt.renderInstances(Ve,ht,ot)}else tt.render(Ve,ht)};function rt(S,I,k){S.transparent===!0&&S.side===fn&&S.forceSinglePass===!1?(S.side=Ot,S.needsUpdate=!0,Qr(S,I,k),S.side=ti,S.needsUpdate=!0,Qr(S,I,k),S.side=fn):Qr(S,I,k)}this.compile=function(S,I,k=null){k===null&&(k=S),d=Ae.get(k),d.init(I),T.push(d),k.traverseVisible(function(U){U.isLight&&U.layers.test(I.layers)&&(d.pushLight(U),U.castShadow&&d.pushShadow(U))}),S!==k&&S.traverseVisible(function(U){U.isLight&&U.layers.test(I.layers)&&(d.pushLight(U),U.castShadow&&d.pushShadow(U))}),d.setupLights();const H=new Set;return S.traverse(function(U){if(!(U.isMesh||U.isPoints||U.isLine||U.isSprite))return;const ne=U.material;if(ne)if(Array.isArray(ne))for(let he=0;he<ne.length;he++){const ve=ne[he];rt(ve,k,U),H.add(ve)}else rt(ne,k,U),H.add(ne)}),d=T.pop(),H},this.compileAsync=function(S,I,k=null){const H=this.compile(S,I,k);return new Promise(U=>{function ne(){if(H.forEach(function(he){ee.get(he).currentProgram.isReady()&&H.delete(he)}),H.size===0){U(S);return}setTimeout(ne,10)}Ie.get("KHR_parallel_shader_compile")!==null?ne():setTimeout(ne,10)})};let Je=null;function Rn(S){Je&&Je(S)}function _n(){oi.stop()}function _l(){oi.start()}const oi=new uu;oi.setAnimationLoop(Rn),typeof self<"u"&&oi.setContext(self),this.setAnimationLoop=function(S){Je=S,re.setAnimationLoop(S),S===null?oi.stop():oi.start()},re.addEventListener("sessionstart",_n),re.addEventListener("sessionend",_l),this.render=function(S,I){if(I!==void 0&&I.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(b===!0)return;if(S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),I.parent===null&&I.matrixWorldAutoUpdate===!0&&I.updateMatrixWorld(),re.enabled===!0&&re.isPresenting===!0&&(re.cameraAutoUpdate===!0&&re.updateCamera(I),I=re.getCamera()),S.isScene===!0&&S.onBeforeRender(M,S,I,C),d=Ae.get(S,T.length),d.init(I),T.push(d),J.multiplyMatrices(I.projectionMatrix,I.matrixWorldInverse),He.setFromProjectionMatrix(J,Sn,I.reversedDepth),Z=this.localClippingEnabled,Be=ae.init(this.clippingPlanes,Z),m=X.get(S,E.length),m.init(),E.push(m),re.enabled===!0&&re.isPresenting===!0){const ne=M.xr.getDepthSensingMesh();ne!==null&&Xs(ne,I,-1/0,M.sortObjects)}Xs(S,I,0,M.sortObjects),m.finish(),M.sortObjects===!0&&m.sort(se,le),ke=re.enabled===!1||re.isPresenting===!1||re.hasDepthSensing()===!1,ke&&Ee.addToRenderList(m,S),this.info.render.frame++,Be===!0&&ae.beginShadows();const k=d.state.shadowsArray;Se.render(k,S,I),Be===!0&&ae.endShadows(),this.info.autoReset===!0&&this.info.reset();const H=m.opaque,U=m.transmissive;if(d.setupLights(),I.isArrayCamera){const ne=I.cameras;if(U.length>0)for(let he=0,ve=ne.length;he<ve;he++){const pe=ne[he];vl(H,U,S,pe)}ke&&Ee.render(S);for(let he=0,ve=ne.length;he<ve;he++){const pe=ne[he];gl(m,S,pe,pe.viewport)}}else U.length>0&&vl(H,U,S,I),ke&&Ee.render(S),gl(m,S,I);C!==null&&R===0&&(de.updateMultisampleRenderTarget(C),de.updateRenderTargetMipmap(C)),S.isScene===!0&&S.onAfterRender(M,S,I),ue.resetDefaultState(),x=-1,y=null,T.pop(),T.length>0?(d=T[T.length-1],Be===!0&&ae.setGlobalState(M.clippingPlanes,d.state.camera)):d=null,E.pop(),E.length>0?m=E[E.length-1]:m=null};function Xs(S,I,k,H){if(S.visible===!1)return;if(S.layers.test(I.layers)){if(S.isGroup)k=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(I);else if(S.isLight)d.pushLight(S),S.castShadow&&d.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||He.intersectsSprite(S)){H&&Pe.setFromMatrixPosition(S.matrixWorld).applyMatrix4(J);const he=F.update(S),ve=S.material;ve.visible&&m.push(S,he,ve,k,Pe.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||He.intersectsObject(S))){const he=F.update(S),ve=S.material;if(H&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),Pe.copy(S.boundingSphere.center)):(he.boundingSphere===null&&he.computeBoundingSphere(),Pe.copy(he.boundingSphere.center)),Pe.applyMatrix4(S.matrixWorld).applyMatrix4(J)),Array.isArray(ve)){const pe=he.groups;for(let Ce=0,Le=pe.length;Ce<Le;Ce++){const we=pe[Ce],Ve=ve[we.materialIndex];Ve&&Ve.visible&&m.push(S,he,Ve,k,Pe.z,we)}}else ve.visible&&m.push(S,he,ve,k,Pe.z,null)}}const ne=S.children;for(let he=0,ve=ne.length;he<ve;he++)Xs(ne[he],I,k,H)}function gl(S,I,k,H){const U=S.opaque,ne=S.transmissive,he=S.transparent;d.setupLightsView(k),Be===!0&&ae.setGlobalState(M.clippingPlanes,k),H&&W.viewport(D.copy(H)),U.length>0&&Jr(U,I,k),ne.length>0&&Jr(ne,I,k),he.length>0&&Jr(he,I,k),W.buffers.depth.setTest(!0),W.buffers.depth.setMask(!0),W.buffers.color.setMask(!0),W.setPolygonOffset(!1)}function vl(S,I,k,H){if((k.isScene===!0?k.overrideMaterial:null)!==null)return;d.state.transmissionRenderTarget[H.id]===void 0&&(d.state.transmissionRenderTarget[H.id]=new Pi(1,1,{generateMipmaps:!0,type:Ie.has("EXT_color_buffer_half_float")||Ie.has("EXT_color_buffer_float")?Xr:bn,minFilter:Ei,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:$e.workingColorSpace}));const ne=d.state.transmissionRenderTarget[H.id],he=H.viewport||D;ne.setSize(he.z*M.transmissionResolutionScale,he.w*M.transmissionResolutionScale);const ve=M.getRenderTarget(),pe=M.getActiveCubeFace(),Ce=M.getActiveMipmapLevel();M.setRenderTarget(ne),M.getClearColor(q),V=M.getClearAlpha(),V<1&&M.setClearColor(16777215,.5),M.clear(),ke&&Ee.render(k);const Le=M.toneMapping;M.toneMapping=Jn;const we=H.viewport;if(H.viewport!==void 0&&(H.viewport=void 0),d.setupLightsView(H),Be===!0&&ae.setGlobalState(M.clippingPlanes,H),Jr(S,k,H),de.updateMultisampleRenderTarget(ne),de.updateRenderTargetMipmap(ne),Ie.has("WEBGL_multisampled_render_to_texture")===!1){let Ve=!1;for(let Qe=0,ht=I.length;Qe<ht;Qe++){const st=I[Qe],tt=st.object,Re=st.geometry,ot=st.material,Ke=st.group;if(ot.side===fn&&tt.layers.test(H.layers)){const Gt=ot.side;ot.side=Ot,ot.needsUpdate=!0,xl(tt,k,H,Re,ot,Ke),ot.side=Gt,ot.needsUpdate=!0,Ve=!0}}Ve===!0&&(de.updateMultisampleRenderTarget(ne),de.updateRenderTargetMipmap(ne))}M.setRenderTarget(ve,pe,Ce),M.setClearColor(q,V),we!==void 0&&(H.viewport=we),M.toneMapping=Le}function Jr(S,I,k){const H=I.isScene===!0?I.overrideMaterial:null;for(let U=0,ne=S.length;U<ne;U++){const he=S[U],ve=he.object,pe=he.geometry,Ce=he.group;let Le=he.material;Le.allowOverride===!0&&H!==null&&(Le=H),ve.layers.test(k.layers)&&xl(ve,I,k,pe,Le,Ce)}}function xl(S,I,k,H,U,ne){S.onBeforeRender(M,I,k,H,U,ne),S.modelViewMatrix.multiplyMatrices(k.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),U.onBeforeRender(M,I,k,H,S,ne),U.transparent===!0&&U.side===fn&&U.forceSinglePass===!1?(U.side=Ot,U.needsUpdate=!0,M.renderBufferDirect(k,I,H,U,S,ne),U.side=ti,U.needsUpdate=!0,M.renderBufferDirect(k,I,H,U,S,ne),U.side=fn):M.renderBufferDirect(k,I,H,U,S,ne),S.onAfterRender(M,I,k,H,U,ne)}function Qr(S,I,k){I.isScene!==!0&&(I=ye);const H=ee.get(S),U=d.state.lights,ne=d.state.shadowsArray,he=U.state.version,ve=Y.getParameters(S,U.state,ne,I,k),pe=Y.getProgramCacheKey(ve);let Ce=H.programs;H.environment=S.isMeshStandardMaterial?I.environment:null,H.fog=I.fog,H.envMap=(S.isMeshStandardMaterial?je:Ye).get(S.envMap||H.environment),H.envMapRotation=H.environment!==null&&S.envMap===null?I.environmentRotation:S.envMapRotation,Ce===void 0&&(S.addEventListener("dispose",j),Ce=new Map,H.programs=Ce);let Le=Ce.get(pe);if(Le!==void 0){if(H.currentProgram===Le&&H.lightsStateVersion===he)return Sl(S,ve),Le}else ve.uniforms=Y.getUniforms(S),S.onBeforeCompile(ve,M),Le=Y.acquireProgram(ve,pe),Ce.set(pe,Le),H.uniforms=ve.uniforms;const we=H.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(we.clippingPlanes=ae.uniform),Sl(S,ve),H.needsLights=_h(S),H.lightsStateVersion=he,H.needsLights&&(we.ambientLightColor.value=U.state.ambient,we.lightProbe.value=U.state.probe,we.directionalLights.value=U.state.directional,we.directionalLightShadows.value=U.state.directionalShadow,we.spotLights.value=U.state.spot,we.spotLightShadows.value=U.state.spotShadow,we.rectAreaLights.value=U.state.rectArea,we.ltc_1.value=U.state.rectAreaLTC1,we.ltc_2.value=U.state.rectAreaLTC2,we.pointLights.value=U.state.point,we.pointLightShadows.value=U.state.pointShadow,we.hemisphereLights.value=U.state.hemi,we.directionalShadowMap.value=U.state.directionalShadowMap,we.directionalShadowMatrix.value=U.state.directionalShadowMatrix,we.spotShadowMap.value=U.state.spotShadowMap,we.spotLightMatrix.value=U.state.spotLightMatrix,we.spotLightMap.value=U.state.spotLightMap,we.pointShadowMap.value=U.state.pointShadowMap,we.pointShadowMatrix.value=U.state.pointShadowMatrix),H.currentProgram=Le,H.uniformsList=null,Le}function Ml(S){if(S.uniformsList===null){const I=S.currentProgram.getUniforms();S.uniformsList=As.seqWithValue(I.seq,S.uniforms)}return S.uniformsList}function Sl(S,I){const k=ee.get(S);k.outputColorSpace=I.outputColorSpace,k.batching=I.batching,k.batchingColor=I.batchingColor,k.instancing=I.instancing,k.instancingColor=I.instancingColor,k.instancingMorph=I.instancingMorph,k.skinning=I.skinning,k.morphTargets=I.morphTargets,k.morphNormals=I.morphNormals,k.morphColors=I.morphColors,k.morphTargetsCount=I.morphTargetsCount,k.numClippingPlanes=I.numClippingPlanes,k.numIntersection=I.numClipIntersection,k.vertexAlphas=I.vertexAlphas,k.vertexTangents=I.vertexTangents,k.toneMapping=I.toneMapping}function ph(S,I,k,H,U){I.isScene!==!0&&(I=ye),de.resetTextureUnits();const ne=I.fog,he=H.isMeshStandardMaterial?I.environment:null,ve=C===null?M.outputColorSpace:C.isXRRenderTarget===!0?C.texture.colorSpace:lr,pe=(H.isMeshStandardMaterial?je:Ye).get(H.envMap||he),Ce=H.vertexColors===!0&&!!k.attributes.color&&k.attributes.color.itemSize===4,Le=!!k.attributes.tangent&&(!!H.normalMap||H.anisotropy>0),we=!!k.morphAttributes.position,Ve=!!k.morphAttributes.normal,Qe=!!k.morphAttributes.color;let ht=Jn;H.toneMapped&&(C===null||C.isXRRenderTarget===!0)&&(ht=M.toneMapping);const st=k.morphAttributes.position||k.morphAttributes.normal||k.morphAttributes.color,tt=st!==void 0?st.length:0,Re=ee.get(H),ot=d.state.lights;if(Be===!0&&(Z===!0||S!==y)){const Pt=S===y&&H.id===x;ae.setState(H,S,Pt)}let Ke=!1;H.version===Re.__version?(Re.needsLights&&Re.lightsStateVersion!==ot.state.version||Re.outputColorSpace!==ve||U.isBatchedMesh&&Re.batching===!1||!U.isBatchedMesh&&Re.batching===!0||U.isBatchedMesh&&Re.batchingColor===!0&&U.colorTexture===null||U.isBatchedMesh&&Re.batchingColor===!1&&U.colorTexture!==null||U.isInstancedMesh&&Re.instancing===!1||!U.isInstancedMesh&&Re.instancing===!0||U.isSkinnedMesh&&Re.skinning===!1||!U.isSkinnedMesh&&Re.skinning===!0||U.isInstancedMesh&&Re.instancingColor===!0&&U.instanceColor===null||U.isInstancedMesh&&Re.instancingColor===!1&&U.instanceColor!==null||U.isInstancedMesh&&Re.instancingMorph===!0&&U.morphTexture===null||U.isInstancedMesh&&Re.instancingMorph===!1&&U.morphTexture!==null||Re.envMap!==pe||H.fog===!0&&Re.fog!==ne||Re.numClippingPlanes!==void 0&&(Re.numClippingPlanes!==ae.numPlanes||Re.numIntersection!==ae.numIntersection)||Re.vertexAlphas!==Ce||Re.vertexTangents!==Le||Re.morphTargets!==we||Re.morphNormals!==Ve||Re.morphColors!==Qe||Re.toneMapping!==ht||Re.morphTargetsCount!==tt)&&(Ke=!0):(Ke=!0,Re.__version=H.version);let Gt=Re.currentProgram;Ke===!0&&(Gt=Qr(H,I,U));let Ii=!1,Wt=!1,vr=!1;const lt=Gt.getUniforms(),Qt=Re.uniforms;if(W.useProgram(Gt.program)&&(Ii=!0,Wt=!0,vr=!0),H.id!==x&&(x=H.id,Wt=!0),Ii||y!==S){W.buffers.depth.getReversed()&&S.reversedDepth!==!0&&(S._reversedDepth=!0,S.updateProjectionMatrix()),lt.setValue(P,"projectionMatrix",S.projectionMatrix),lt.setValue(P,"viewMatrix",S.matrixWorldInverse);const Nt=lt.map.cameraPosition;Nt!==void 0&&Nt.setValue(P,me.setFromMatrixPosition(S.matrixWorld)),$.logarithmicDepthBuffer&&lt.setValue(P,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(H.isMeshPhongMaterial||H.isMeshToonMaterial||H.isMeshLambertMaterial||H.isMeshBasicMaterial||H.isMeshStandardMaterial||H.isShaderMaterial)&&lt.setValue(P,"isOrthographic",S.isOrthographicCamera===!0),y!==S&&(y=S,Wt=!0,vr=!0)}if(U.isSkinnedMesh){lt.setOptional(P,U,"bindMatrix"),lt.setOptional(P,U,"bindMatrixInverse");const Pt=U.skeleton;Pt&&(Pt.boneTexture===null&&Pt.computeBoneTexture(),lt.setValue(P,"boneTexture",Pt.boneTexture,de))}U.isBatchedMesh&&(lt.setOptional(P,U,"batchingTexture"),lt.setValue(P,"batchingTexture",U._matricesTexture,de),lt.setOptional(P,U,"batchingIdTexture"),lt.setValue(P,"batchingIdTexture",U._indirectTexture,de),lt.setOptional(P,U,"batchingColorTexture"),U._colorsTexture!==null&&lt.setValue(P,"batchingColorTexture",U._colorsTexture,de));const en=k.morphAttributes;if((en.position!==void 0||en.normal!==void 0||en.color!==void 0)&&ie.update(U,k,Gt),(Wt||Re.receiveShadow!==U.receiveShadow)&&(Re.receiveShadow=U.receiveShadow,lt.setValue(P,"receiveShadow",U.receiveShadow)),H.isMeshGouraudMaterial&&H.envMap!==null&&(Qt.envMap.value=pe,Qt.flipEnvMap.value=pe.isCubeTexture&&pe.isRenderTargetTexture===!1?-1:1),H.isMeshStandardMaterial&&H.envMap===null&&I.environment!==null&&(Qt.envMapIntensity.value=I.environmentIntensity),Wt&&(lt.setValue(P,"toneMappingExposure",M.toneMappingExposure),Re.needsLights&&mh(Qt,vr),ne&&H.fog===!0&&Q.refreshFogUniforms(Qt,ne),Q.refreshMaterialUniforms(Qt,H,z,K,d.state.transmissionRenderTarget[S.id]),As.upload(P,Ml(Re),Qt,de)),H.isShaderMaterial&&H.uniformsNeedUpdate===!0&&(As.upload(P,Ml(Re),Qt,de),H.uniformsNeedUpdate=!1),H.isSpriteMaterial&&lt.setValue(P,"center",U.center),lt.setValue(P,"modelViewMatrix",U.modelViewMatrix),lt.setValue(P,"normalMatrix",U.normalMatrix),lt.setValue(P,"modelMatrix",U.matrixWorld),H.isShaderMaterial||H.isRawShaderMaterial){const Pt=H.uniformsGroups;for(let Nt=0,qs=Pt.length;Nt<qs;Nt++){const li=Pt[Nt];Ne.update(li,Gt),Ne.bind(li,Gt)}}return Gt}function mh(S,I){S.ambientLightColor.needsUpdate=I,S.lightProbe.needsUpdate=I,S.directionalLights.needsUpdate=I,S.directionalLightShadows.needsUpdate=I,S.pointLights.needsUpdate=I,S.pointLightShadows.needsUpdate=I,S.spotLights.needsUpdate=I,S.spotLightShadows.needsUpdate=I,S.rectAreaLights.needsUpdate=I,S.hemisphereLights.needsUpdate=I}function _h(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return w},this.getActiveMipmapLevel=function(){return R},this.getRenderTarget=function(){return C},this.setRenderTargetTextures=function(S,I,k){const H=ee.get(S);H.__autoAllocateDepthBuffer=S.resolveDepthBuffer===!1,H.__autoAllocateDepthBuffer===!1&&(H.__useRenderToTexture=!1),ee.get(S.texture).__webglTexture=I,ee.get(S.depthTexture).__webglTexture=H.__autoAllocateDepthBuffer?void 0:k,H.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(S,I){const k=ee.get(S);k.__webglFramebuffer=I,k.__useDefaultFramebuffer=I===void 0};const gh=P.createFramebuffer();this.setRenderTarget=function(S,I=0,k=0){C=S,w=I,R=k;let H=!0,U=null,ne=!1,he=!1;if(S){const pe=ee.get(S);if(pe.__useDefaultFramebuffer!==void 0)W.bindFramebuffer(P.FRAMEBUFFER,null),H=!1;else if(pe.__webglFramebuffer===void 0)de.setupRenderTarget(S);else if(pe.__hasExternalTextures)de.rebindTextures(S,ee.get(S.texture).__webglTexture,ee.get(S.depthTexture).__webglTexture);else if(S.depthBuffer){const we=S.depthTexture;if(pe.__boundDepthTexture!==we){if(we!==null&&ee.has(we)&&(S.width!==we.image.width||S.height!==we.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");de.setupDepthRenderbuffer(S)}}const Ce=S.texture;(Ce.isData3DTexture||Ce.isDataArrayTexture||Ce.isCompressedArrayTexture)&&(he=!0);const Le=ee.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(Le[I])?U=Le[I][k]:U=Le[I],ne=!0):S.samples>0&&de.useMultisampledRTT(S)===!1?U=ee.get(S).__webglMultisampledFramebuffer:Array.isArray(Le)?U=Le[k]:U=Le,D.copy(S.viewport),N.copy(S.scissor),O=S.scissorTest}else D.copy(_e).multiplyScalar(z).floor(),N.copy(be).multiplyScalar(z).floor(),O=Oe;if(k!==0&&(U=gh),W.bindFramebuffer(P.FRAMEBUFFER,U)&&H&&W.drawBuffers(S,U),W.viewport(D),W.scissor(N),W.setScissorTest(O),ne){const pe=ee.get(S.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_CUBE_MAP_POSITIVE_X+I,pe.__webglTexture,k)}else if(he){const pe=I;for(let Ce=0;Ce<S.textures.length;Ce++){const Le=ee.get(S.textures[Ce]);P.framebufferTextureLayer(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0+Ce,Le.__webglTexture,k,pe)}}else if(S!==null&&k!==0){const pe=ee.get(S.texture);P.framebufferTexture2D(P.FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,pe.__webglTexture,k)}x=-1},this.readRenderTargetPixels=function(S,I,k,H,U,ne,he,ve=0){if(!(S&&S.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let pe=ee.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&he!==void 0&&(pe=pe[he]),pe){W.bindFramebuffer(P.FRAMEBUFFER,pe);try{const Ce=S.textures[ve],Le=Ce.format,we=Ce.type;if(!$.textureFormatReadable(Le)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!$.textureTypeReadable(we)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}I>=0&&I<=S.width-H&&k>=0&&k<=S.height-U&&(S.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+ve),P.readPixels(I,k,H,U,Te.convert(Le),Te.convert(we),ne))}finally{const Ce=C!==null?ee.get(C).__webglFramebuffer:null;W.bindFramebuffer(P.FRAMEBUFFER,Ce)}}},this.readRenderTargetPixelsAsync=async function(S,I,k,H,U,ne,he,ve=0){if(!(S&&S.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let pe=ee.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&he!==void 0&&(pe=pe[he]),pe)if(I>=0&&I<=S.width-H&&k>=0&&k<=S.height-U){W.bindFramebuffer(P.FRAMEBUFFER,pe);const Ce=S.textures[ve],Le=Ce.format,we=Ce.type;if(!$.textureFormatReadable(Le))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!$.textureTypeReadable(we))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const Ve=P.createBuffer();P.bindBuffer(P.PIXEL_PACK_BUFFER,Ve),P.bufferData(P.PIXEL_PACK_BUFFER,ne.byteLength,P.STREAM_READ),S.textures.length>1&&P.readBuffer(P.COLOR_ATTACHMENT0+ve),P.readPixels(I,k,H,U,Te.convert(Le),Te.convert(we),0);const Qe=C!==null?ee.get(C).__webglFramebuffer:null;W.bindFramebuffer(P.FRAMEBUFFER,Qe);const ht=P.fenceSync(P.SYNC_GPU_COMMANDS_COMPLETE,0);return P.flush(),await uf(P,ht,4),P.bindBuffer(P.PIXEL_PACK_BUFFER,Ve),P.getBufferSubData(P.PIXEL_PACK_BUFFER,0,ne),P.deleteBuffer(Ve),P.deleteSync(ht),ne}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(S,I=null,k=0){const H=Math.pow(2,-k),U=Math.floor(S.image.width*H),ne=Math.floor(S.image.height*H),he=I!==null?I.x:0,ve=I!==null?I.y:0;de.setTexture2D(S,0),P.copyTexSubImage2D(P.TEXTURE_2D,k,0,0,he,ve,U,ne),W.unbindTexture()};const vh=P.createFramebuffer(),xh=P.createFramebuffer();this.copyTextureToTexture=function(S,I,k=null,H=null,U=0,ne=null){ne===null&&(U!==0?(Or("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),ne=U,U=0):ne=0);let he,ve,pe,Ce,Le,we,Ve,Qe,ht;const st=S.isCompressedTexture?S.mipmaps[ne]:S.image;if(k!==null)he=k.max.x-k.min.x,ve=k.max.y-k.min.y,pe=k.isBox3?k.max.z-k.min.z:1,Ce=k.min.x,Le=k.min.y,we=k.isBox3?k.min.z:0;else{const en=Math.pow(2,-U);he=Math.floor(st.width*en),ve=Math.floor(st.height*en),S.isDataArrayTexture?pe=st.depth:S.isData3DTexture?pe=Math.floor(st.depth*en):pe=1,Ce=0,Le=0,we=0}H!==null?(Ve=H.x,Qe=H.y,ht=H.z):(Ve=0,Qe=0,ht=0);const tt=Te.convert(I.format),Re=Te.convert(I.type);let ot;I.isData3DTexture?(de.setTexture3D(I,0),ot=P.TEXTURE_3D):I.isDataArrayTexture||I.isCompressedArrayTexture?(de.setTexture2DArray(I,0),ot=P.TEXTURE_2D_ARRAY):(de.setTexture2D(I,0),ot=P.TEXTURE_2D),P.pixelStorei(P.UNPACK_FLIP_Y_WEBGL,I.flipY),P.pixelStorei(P.UNPACK_PREMULTIPLY_ALPHA_WEBGL,I.premultiplyAlpha),P.pixelStorei(P.UNPACK_ALIGNMENT,I.unpackAlignment);const Ke=P.getParameter(P.UNPACK_ROW_LENGTH),Gt=P.getParameter(P.UNPACK_IMAGE_HEIGHT),Ii=P.getParameter(P.UNPACK_SKIP_PIXELS),Wt=P.getParameter(P.UNPACK_SKIP_ROWS),vr=P.getParameter(P.UNPACK_SKIP_IMAGES);P.pixelStorei(P.UNPACK_ROW_LENGTH,st.width),P.pixelStorei(P.UNPACK_IMAGE_HEIGHT,st.height),P.pixelStorei(P.UNPACK_SKIP_PIXELS,Ce),P.pixelStorei(P.UNPACK_SKIP_ROWS,Le),P.pixelStorei(P.UNPACK_SKIP_IMAGES,we);const lt=S.isDataArrayTexture||S.isData3DTexture,Qt=I.isDataArrayTexture||I.isData3DTexture;if(S.isDepthTexture){const en=ee.get(S),Pt=ee.get(I),Nt=ee.get(en.__renderTarget),qs=ee.get(Pt.__renderTarget);W.bindFramebuffer(P.READ_FRAMEBUFFER,Nt.__webglFramebuffer),W.bindFramebuffer(P.DRAW_FRAMEBUFFER,qs.__webglFramebuffer);for(let li=0;li<pe;li++)lt&&(P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,ee.get(S).__webglTexture,U,we+li),P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,ee.get(I).__webglTexture,ne,ht+li)),P.blitFramebuffer(Ce,Le,he,ve,Ve,Qe,he,ve,P.DEPTH_BUFFER_BIT,P.NEAREST);W.bindFramebuffer(P.READ_FRAMEBUFFER,null),W.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else if(U!==0||S.isRenderTargetTexture||ee.has(S)){const en=ee.get(S),Pt=ee.get(I);W.bindFramebuffer(P.READ_FRAMEBUFFER,vh),W.bindFramebuffer(P.DRAW_FRAMEBUFFER,xh);for(let Nt=0;Nt<pe;Nt++)lt?P.framebufferTextureLayer(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,en.__webglTexture,U,we+Nt):P.framebufferTexture2D(P.READ_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,en.__webglTexture,U),Qt?P.framebufferTextureLayer(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,Pt.__webglTexture,ne,ht+Nt):P.framebufferTexture2D(P.DRAW_FRAMEBUFFER,P.COLOR_ATTACHMENT0,P.TEXTURE_2D,Pt.__webglTexture,ne),U!==0?P.blitFramebuffer(Ce,Le,he,ve,Ve,Qe,he,ve,P.COLOR_BUFFER_BIT,P.NEAREST):Qt?P.copyTexSubImage3D(ot,ne,Ve,Qe,ht+Nt,Ce,Le,he,ve):P.copyTexSubImage2D(ot,ne,Ve,Qe,Ce,Le,he,ve);W.bindFramebuffer(P.READ_FRAMEBUFFER,null),W.bindFramebuffer(P.DRAW_FRAMEBUFFER,null)}else Qt?S.isDataTexture||S.isData3DTexture?P.texSubImage3D(ot,ne,Ve,Qe,ht,he,ve,pe,tt,Re,st.data):I.isCompressedArrayTexture?P.compressedTexSubImage3D(ot,ne,Ve,Qe,ht,he,ve,pe,tt,st.data):P.texSubImage3D(ot,ne,Ve,Qe,ht,he,ve,pe,tt,Re,st):S.isDataTexture?P.texSubImage2D(P.TEXTURE_2D,ne,Ve,Qe,he,ve,tt,Re,st.data):S.isCompressedTexture?P.compressedTexSubImage2D(P.TEXTURE_2D,ne,Ve,Qe,st.width,st.height,tt,st.data):P.texSubImage2D(P.TEXTURE_2D,ne,Ve,Qe,he,ve,tt,Re,st);P.pixelStorei(P.UNPACK_ROW_LENGTH,Ke),P.pixelStorei(P.UNPACK_IMAGE_HEIGHT,Gt),P.pixelStorei(P.UNPACK_SKIP_PIXELS,Ii),P.pixelStorei(P.UNPACK_SKIP_ROWS,Wt),P.pixelStorei(P.UNPACK_SKIP_IMAGES,vr),ne===0&&I.generateMipmaps&&P.generateMipmap(ot),W.unbindTexture()},this.initRenderTarget=function(S){ee.get(S).__webglFramebuffer===void 0&&de.setupRenderTarget(S)},this.initTexture=function(S){S.isCubeTexture?de.setTextureCube(S,0):S.isData3DTexture?de.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?de.setTexture2DArray(S,0):de.setTexture2D(S,0),W.unbindTexture()},this.resetState=function(){w=0,R=0,C=null,W.reset(),ue.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Sn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=$e._getDrawingBufferColorSpace(e),t.unpackColorSpace=$e._getUnpackColorSpace()}}function Nn(r){if(r===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return r}function mu(r,e){r.prototype=Object.create(e.prototype),r.prototype.constructor=r,r.__proto__=e}/*!
 * GSAP 3.13.0
 * https://gsap.com
 *
...
*/var wc,$n,ir,fl,Ti,Rc,dl,w0=function(){return typeof window<"u"},kn={},xi=180/Math.PI,rr=Math.PI/180,$i=Math.atan2,Cc=1e8,pl=/([A-Z])/g,R0=/(left|right|width|margin|padding|x)/i,C0=/[\s,\(]\S/,yn={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},No=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},P0=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},D0=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},L0=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},ih=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},rh=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},I0=function(e,t,n){return e.style[t]=n},U0=function(e,t,n){return e.style.setProperty(t,n)},N0=function(e,t,n){return e._gsap[t]=n},F0=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},O0=function(e,t,n,i,s){var a=e._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},B0=function(e,t,n,i,s){var a=e._gsap;a[t]=n,a.renderTransform(s,a)},ut="transform",Ht=ut+"Origin",z0=function r(e,t){var n=this,i=this.target,s=i.style,a=i._gsap;if(e in kn&&s){if(this.tfm=this.tfm||{},e!=="transform")e=yn[e]||e,~e.indexOf(",")?e.split(",").forEach(function(o){return n.tfm[o]=Fn(i,o)}):this.tfm[e]=a.x?a[e]:Fn(i,e),e===Ht&&(this.tfm.zOrigin=a.zOrigin);else return yn.transform.split(",").forEach(function(o){return r.call(n,o,t)});if(this.props.indexOf(ut)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(Ht,t,"")),e=ut}(s||t)&&this.props.push(e,t,s[e])},sh=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},k0=function(){var e=this.props,t=this.target,n=t.style,i=t._gsap,s,a;for(s=0;s<e.length;s+=3)e[s+1]?e[s+1]===2?t[e[s]](e[s+2]):t[e[s]]=e[s+2]:e[s+2]?n[e[s]]=e[s+2]:n.removeProperty(e[s].substr(0,2)==="--"?e[s]:e[s].replace(pl,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),s=dl(),(!s||!s.isStart)&&!n[ut]&&(sh(n),i.zOrigin&&n[Ht]&&(n[Ht]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},ah=function(e,t){var n={target:e,props:[],revert:k0,save:z0};return e._gsap||Vt.core.getCache(e),t&&e.style&&e.nodeType&&t.split(",").forEach(function(i){return n.save(i)}),n},oh,Fo=function(e,t){var n=$n.createElementNS?$n.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):$n.createElement(e);return n&&n.style?n:$n.createElement(e)},ln=function r(e,t,n){var i=getComputedStyle(e);return i[t]||i.getPropertyValue(t.replace(pl,"-$1").toLowerCase())||i.getPropertyValue(t)||!n&&r(e,mr(t)||t,1)||""},Pc="O,Moz,ms,Ms,Webkit".split(","),mr=function(e,t,n){var i=t||Ti,s=i.style,a=5;if(e in s&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);a--&&!(Pc[a]+e in s););return a<0?null:(a===3?"ms":a>=0?Pc[a]:"")+e},Oo=function(){w0()&&window.document&&(wc=window,$n=wc.document,ir=$n.documentElement,Ti=Fo("div")||{style:{}},Fo("div"),ut=mr(ut),Ht=ut+"Origin",Ti.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",oh=!!mr("perspective"),dl=Vt.core.reverting,fl=1)},Dc=function(e){var t=e.ownerSVGElement,n=Fo("svg",t&&t.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),i=e.cloneNode(!0),s;i.style.display="block",n.appendChild(i),ir.appendChild(n);try{s=i.getBBox()}catch{}return n.removeChild(i),ir.removeChild(n),s},Lc=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},lh=function(e){var t,n;try{t=e.getBBox()}catch{t=Dc(e),n=1}return t&&(t.width||t.height)||n||(t=Dc(e)),t&&!t.width&&!t.x&&!t.y?{x:+Lc(e,["x","cx","x1"])||0,y:+Lc(e,["y","cy","y1"])||0,width:0,height:0}:t},ch=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&lh(e))},Di=function(e,t){if(t){var n=e.style,i;t in kn&&t!==Ht&&(t=ut),n.removeProperty?(i=t.substr(0,2),(i==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(i==="--"?t:t.replace(pl,"-$1").toLowerCase())):n.removeAttribute(t)}},Zn=function(e,t,n,i,s,a){var o=new kt(e._pt,t,n,0,1,a?rh:ih);return e._pt=o,o.b=i,o.e=s,e._props.push(n),o},Ic={deg:1,rad:1,turn:1},H0={grid:1,flex:1},ri=function r(e,t,n,i){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",o=Ti.style,c=R0.test(t),l=e.tagName.toLowerCase()==="svg",u=(l?"client":"offset")+(c?"Width":"Height"),h=100,f=i==="px",p=i==="%",g,_,m,d;if(i===a||!s||Ic[i]||Ic[a])return s;if(a!=="px"&&!f&&(s=r(e,t,n,"px")),d=e.getCTM&&ch(e),(p||a==="%")&&(kn[t]||~t.indexOf("adius")))return g=d?e.getBBox()[c?"width":"height"]:e[u],pt(p?s/g*h:s/100*g);if(o[c?"width":"height"]=h+(f?a:i),_=i!=="rem"&&~t.indexOf("adius")||i==="em"&&e.appendChild&&!l?e:e.parentNode,d&&(_=(e.ownerSVGElement||{}).parentNode),(!_||_===$n||!_.appendChild)&&(_=$n.body),m=_._gsap,m&&p&&m.width&&c&&m.time===Kt.time&&!m.uncache)return pt(s/m.width*h);if(p&&(t==="height"||t==="width")){var E=e.style[t];e.style[t]=h+i,g=e[u],E?e.style[t]=E:Di(e,t)}else(p||a==="%")&&!H0[ln(_,"display")]&&(o.position=ln(e,"position")),_===e&&(o.position="static"),_.appendChild(Ti),g=Ti[u],_.removeChild(Ti),o.position="absolute";return c&&p&&(m=bi(_),m.time=Kt.time,m.width=_[u]),pt(f?g*s/h:g&&s?h/g*s:0)},Fn=function(e,t,n,i){var s;return fl||Oo(),t in yn&&t!=="transform"&&(t=yn[t],~t.indexOf(",")&&(t=t.split(",")[0])),kn[t]&&t!=="transform"?(s=Wr(e,i),s=t!=="transformOrigin"?s[t]:s.svg?s.origin:Bs(ln(e,Ht))+" "+s.zOrigin+"px"):(s=e.style[t],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=Os[t]&&Os[t](e,t,n)||ln(e,t)||bu(e,t)||(t==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?ri(e,t,s,n)+n:s},V0=function(e,t,n,i){if(!n||n==="none"){var s=mr(t,e,1),a=s&&ln(e,s,1);a&&a!==n?(t=s,n=a):t==="borderColor"&&(n=ln(e,"borderTopColor"))}var o=new kt(this._pt,e.style,t,0,1,eh),c=0,l=0,u,h,f,p,g,_,m,d,E,T,M,b;if(o.b=n,o.e=i,n+="",i+="",i.substring(0,6)==="var(--"&&(i=ln(e,i.substring(4,i.indexOf(")")))),i==="auto"&&(_=e.style[t],e.style[t]=i,i=ln(e,t)||i,_?e.style[t]=_:Di(e,t)),u=[n,i],Wu(u),n=u[0],i=u[1],f=n.match(Ji)||[],b=i.match(Ji)||[],b.length){for(;h=Ji.exec(i);)m=h[0],E=i.substring(c,h.index),g?g=(g+1)%5:(E.substr(-5)==="rgba("||E.substr(-5)==="hsla(")&&(g=1),m!==(_=f[l++]||"")&&(p=parseFloat(_)||0,M=_.substr((p+"").length),m.charAt(1)==="="&&(m=nr(p,m)+M),d=parseFloat(m),T=m.substr((d+"").length),c=Ji.lastIndex-T.length,T||(T=T||Zt.units[t]||M,c===i.length&&(i+=T,o.e+=T)),M!==T&&(p=ri(e,t,_,T)||0),o._pt={_next:o._pt,p:E||l===1?E:",",s:p,c:d-p,m:g&&g<4||t==="zIndex"?Math.round:0});o.c=c<i.length?i.substring(c,i.length):""}else o.r=t==="display"&&i==="none"?rh:ih;return xu.test(i)&&(o.e=0),this._pt=o,o},Uc={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},G0=function(e){var t=e.split(" "),n=t[0],i=t[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(e=n,n=i,i=e),t[0]=Uc[n]||n,t[1]=Uc[i]||i,t.join(" ")},W0=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,i=n.style,s=t.u,a=n._gsap,o,c,l;if(s==="all"||s===!0)i.cssText="",c=1;else for(s=s.split(","),l=s.length;--l>-1;)o=s[l],kn[o]&&(c=1,o=o==="transformOrigin"?Ht:ut),Di(n,o);c&&(Di(n,ut),a&&(a.svg&&n.removeAttribute("transform"),i.scale=i.rotate=i.translate="none",Wr(n,1),a.uncache=1,sh(i)))}},Os={clearProps:function(e,t,n,i,s){if(s.data!=="isFromStart"){var a=e._pt=new kt(e._pt,t,n,0,0,W0);return a.u=i,a.pr=-10,a.tween=s,e._props.push(n),1}}},Gr=[1,0,0,1,0,0],uh={},hh=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},Nc=function(e){var t=ln(e,ut);return hh(t)?Gr:t.substr(7).match(vu).map(pt)},ml=function(e,t){var n=e._gsap||bi(e),i=e.style,s=Nc(e),a,o,c,l;return n.svg&&e.getAttribute("transform")?(c=e.transform.baseVal.consolidate().matrix,s=[c.a,c.b,c.c,c.d,c.e,c.f],s.join(",")==="1,0,0,1,0,0"?Gr:s):(s===Gr&&!e.offsetParent&&e!==ir&&!n.svg&&(c=i.display,i.display="block",a=e.parentNode,(!a||!e.offsetParent&&!e.getBoundingClientRect().width)&&(l=1,o=e.nextElementSibling,ir.appendChild(e)),s=Nc(e),c?i.display=c:Di(e,"display"),l&&(o?a.insertBefore(e,o):a?a.appendChild(e):ir.removeChild(e))),t&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},Bo=function(e,t,n,i,s,a){var o=e._gsap,c=s||ml(e,!0),l=o.xOrigin||0,u=o.yOrigin||0,h=o.xOffset||0,f=o.yOffset||0,p=c[0],g=c[1],_=c[2],m=c[3],d=c[4],E=c[5],T=t.split(" "),M=parseFloat(T[0])||0,b=parseFloat(T[1])||0,w,R,C,x;n?c!==Gr&&(R=p*m-g*_)&&(C=M*(m/R)+b*(-_/R)+(_*E-m*d)/R,x=M*(-g/R)+b*(p/R)-(p*E-g*d)/R,M=C,b=x):(w=lh(e),M=w.x+(~T[0].indexOf("%")?M/100*w.width:M),b=w.y+(~(T[1]||T[0]).indexOf("%")?b/100*w.height:b)),i||i!==!1&&o.smooth?(d=M-l,E=b-u,o.xOffset=h+(d*p+E*_)-d,o.yOffset=f+(d*g+E*m)-E):o.xOffset=o.yOffset=0,o.xOrigin=M,o.yOrigin=b,o.smooth=!!i,o.origin=t,o.originIsAbsolute=!!n,e.style[Ht]="0px 0px",a&&(Zn(a,o,"xOrigin",l,M),Zn(a,o,"yOrigin",u,b),Zn(a,o,"xOffset",h,o.xOffset),Zn(a,o,"yOffset",f,o.yOffset)),e.setAttribute("data-svg-origin",M+" "+b)},Wr=function(e,t){var n=e._gsap||new Ku(e);if("x"in n&&!t&&!n.uncache)return n;var i=e.style,s=n.scaleX<0,a="px",o="deg",c=getComputedStyle(e),l=ln(e,Ht)||"0",u,h,f,p,g,_,m,d,E,T,M,b,w,R,C,x,y,D,N,O,q,V,G,K,z,se,le,_e,be,Oe,He,Be;return u=h=f=_=m=d=E=T=M=0,p=g=1,n.svg=!!(e.getCTM&&ch(e)),c.translate&&((c.translate!=="none"||c.scale!=="none"||c.rotate!=="none")&&(i[ut]=(c.translate!=="none"?"translate3d("+(c.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(c.rotate!=="none"?"rotate("+c.rotate+") ":"")+(c.scale!=="none"?"scale("+c.scale.split(" ").join(",")+") ":"")+(c[ut]!=="none"?c[ut]:"")),i.scale=i.rotate=i.translate="none"),R=ml(e,n.svg),n.svg&&(n.uncache?(z=e.getBBox(),l=n.xOrigin-z.x+"px "+(n.yOrigin-z.y)+"px",K=""):K=!t&&e.getAttribute("data-svg-origin"),Bo(e,K||l,!!K||n.originIsAbsolute,n.smooth!==!1,R)),b=n.xOrigin||0,w=n.yOrigin||0,R!==Gr&&(D=R[0],N=R[1],O=R[2],q=R[3],u=V=R[4],h=G=R[5],R.length===6?(p=Math.sqrt(D*D+N*N),g=Math.sqrt(q*q+O*O),_=D||N?$i(N,D)*xi:0,E=O||q?$i(O,q)*xi+_:0,E&&(g*=Math.abs(Math.cos(E*rr))),n.svg&&(u-=b-(b*D+w*O),h-=w-(b*N+w*q))):(Be=R[6],Oe=R[7],le=R[8],_e=R[9],be=R[10],He=R[11],u=R[12],h=R[13],f=R[14],C=$i(Be,be),m=C*xi,C&&(x=Math.cos(-C),y=Math.sin(-C),K=V*x+le*y,z=G*x+_e*y,se=Be*x+be*y,le=V*-y+le*x,_e=G*-y+_e*x,be=Be*-y+be*x,He=Oe*-y+He*x,V=K,G=z,Be=se),C=$i(-O,be),d=C*xi,C&&(x=Math.cos(-C),y=Math.sin(-C),K=D*x-le*y,z=N*x-_e*y,se=O*x-be*y,He=q*y+He*x,D=K,N=z,O=se),C=$i(N,D),_=C*xi,C&&(x=Math.cos(C),y=Math.sin(C),K=D*x+N*y,z=V*x+G*y,N=N*x-D*y,G=G*x-V*y,D=K,V=z),m&&Math.abs(m)+Math.abs(_)>359.9&&(m=_=0,d=180-d),p=pt(Math.sqrt(D*D+N*N+O*O)),g=pt(Math.sqrt(G*G+Be*Be)),C=$i(V,G),E=Math.abs(C)>2e-4?C*xi:0,M=He?1/(He<0?-He:He):0),n.svg&&(K=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!hh(ln(e,ut)),K&&e.setAttribute("transform",K))),Math.abs(E)>90&&Math.abs(E)<270&&(s?(p*=-1,E+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,E+=E<=0?180:-180)),t=t||n.uncache,n.x=u-((n.xPercent=u&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-u)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+a,n.y=h-((n.yPercent=h&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-h)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+a,n.z=f+a,n.scaleX=pt(p),n.scaleY=pt(g),n.rotation=pt(_)+o,n.rotationX=pt(m)+o,n.rotationY=pt(d)+o,n.skewX=E+o,n.skewY=T+o,n.transformPerspective=M+a,(n.zOrigin=parseFloat(l.split(" ")[2])||!t&&n.zOrigin||0)&&(i[Ht]=Bs(l)),n.xOffset=n.yOffset=0,n.force3D=Zt.force3D,n.renderTransform=n.svg?q0:oh?fh:X0,n.uncache=0,n},Bs=function(e){return(e=e.split(" "))[0]+" "+e[1]},Ia=function(e,t,n){var i=wt(t);return pt(parseFloat(t)+parseFloat(ri(e,"x",n+"px",i)))+i},X0=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,fh(e,t)},mi="0deg",Tr="0px",_i=") ",fh=function(e,t){var n=t||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,c=n.z,l=n.rotation,u=n.rotationY,h=n.rotationX,f=n.skewX,p=n.skewY,g=n.scaleX,_=n.scaleY,m=n.transformPerspective,d=n.force3D,E=n.target,T=n.zOrigin,M="",b=d==="auto"&&e&&e!==1||d===!0;if(T&&(h!==mi||u!==mi)){var w=parseFloat(u)*rr,R=Math.sin(w),C=Math.cos(w),x;w=parseFloat(h)*rr,x=Math.cos(w),a=Ia(E,a,R*x*-T),o=Ia(E,o,-Math.sin(w)*-T),c=Ia(E,c,C*x*-T+T)}m!==Tr&&(M+="perspective("+m+_i),(i||s)&&(M+="translate("+i+"%, "+s+"%) "),(b||a!==Tr||o!==Tr||c!==Tr)&&(M+=c!==Tr||b?"translate3d("+a+", "+o+", "+c+") ":"translate("+a+", "+o+_i),l!==mi&&(M+="rotate("+l+_i),u!==mi&&(M+="rotateY("+u+_i),h!==mi&&(M+="rotateX("+h+_i),(f!==mi||p!==mi)&&(M+="skew("+f+", "+p+_i),(g!==1||_!==1)&&(M+="scale("+g+", "+_+_i),E.style[ut]=M||"translate(0, 0)"},q0=function(e,t){var n=t||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,c=n.rotation,l=n.skewX,u=n.skewY,h=n.scaleX,f=n.scaleY,p=n.target,g=n.xOrigin,_=n.yOrigin,m=n.xOffset,d=n.yOffset,E=n.forceCSS,T=parseFloat(a),M=parseFloat(o),b,w,R,C,x;c=parseFloat(c),l=parseFloat(l),u=parseFloat(u),u&&(u=parseFloat(u),l+=u,c+=u),c||l?(c*=rr,l*=rr,b=Math.cos(c)*h,w=Math.sin(c)*h,R=Math.sin(c-l)*-f,C=Math.cos(c-l)*f,l&&(u*=rr,x=Math.tan(l-u),x=Math.sqrt(1+x*x),R*=x,C*=x,u&&(x=Math.tan(u),x=Math.sqrt(1+x*x),b*=x,w*=x)),b=pt(b),w=pt(w),R=pt(R),C=pt(C)):(b=h,C=f,w=R=0),(T&&!~(a+"").indexOf("px")||M&&!~(o+"").indexOf("px"))&&(T=ri(p,"x",a,"px"),M=ri(p,"y",o,"px")),(g||_||m||d)&&(T=pt(T+g-(g*b+_*R)+m),M=pt(M+_-(g*w+_*C)+d)),(i||s)&&(x=p.getBBox(),T=pt(T+i/100*x.width),M=pt(M+s/100*x.height)),x="matrix("+b+","+w+","+R+","+C+","+T+","+M+")",p.setAttribute("transform",x),E&&(p.style[ut]=x)},Y0=function(e,t,n,i,s){var a=360,o=Et(s),c=parseFloat(s)*(o&&~s.indexOf("rad")?xi:1),l=c-i,u=i+l+"deg",h,f;return o&&(h=s.split("_")[1],h==="short"&&(l%=a,l!==l%(a/2)&&(l+=l<0?a:-a)),h==="cw"&&l<0?l=(l+a*Cc)%a-~~(l/a)*a:h==="ccw"&&l>0&&(l=(l-a*Cc)%a-~~(l/a)*a)),e._pt=f=new kt(e._pt,t,n,i,l,P0),f.e=u,f.u="deg",e._props.push(n),f},Fc=function(e,t){for(var n in t)e[n]=t[n];return e},K0=function(e,t,n){var i=Fc({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,c,l,u,h,f,p,g;i.svg?(l=n.getAttribute("transform"),n.setAttribute("transform",""),a[ut]=t,o=Wr(n,1),Di(n,ut),n.setAttribute("transform",l)):(l=getComputedStyle(n)[ut],a[ut]=t,o=Wr(n,1),a[ut]=l);for(c in kn)l=i[c],u=o[c],l!==u&&s.indexOf(c)<0&&(p=wt(l),g=wt(u),h=p!==g?ri(n,c,l,g):parseFloat(l),f=parseFloat(u),e._pt=new kt(e._pt,o,c,h,f-h,No),e._pt.u=g||0,e._props.push(c));Fc(o,i)};zt("padding,margin,Width,Radius",function(r,e){var t="Top",n="Right",i="Bottom",s="Left",a=(e<3?[t,n,i,s]:[t+s,t+n,i+n,i+s]).map(function(o){return e<2?r+o:"border"+o+r});Os[e>1?"border"+r:r]=function(o,c,l,u,h){var f,p;if(arguments.length<4)return f=a.map(function(g){return Fn(o,g,l)}),p=f.join(" "),p.split(f[0]).length===5?f[0]:p;f=(u+"").split(" "),p={},a.forEach(function(g,_){return p[g]=f[_]=f[_]||f[(_-1)/2|0]}),o.init(c,p,h)}});var dh={name:"css",register:Oo,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,i,s){var a=this._props,o=e.style,c=n.vars.startAt,l,u,h,f,p,g,_,m,d,E,T,M,b,w,R,C;fl||Oo(),this.styles=this.styles||ah(e),C=this.styles.props,this.tween=n;for(_ in t)if(_!=="autoRound"&&(u=t[_],!(Yt[_]&&$u(_,t,n,i,e,s)))){if(p=typeof u,g=Os[_],p==="function"&&(u=u.call(n,i,e,s),p=typeof u),p==="string"&&~u.indexOf("random(")&&(u=kr(u)),g)g(this,e,_,u,n)&&(R=1);else if(_.substr(0,2)==="--")l=(getComputedStyle(e).getPropertyValue(_)+"").trim(),u+="",ei.lastIndex=0,ei.test(l)||(m=wt(l),d=wt(u)),d?m!==d&&(l=ri(e,_,l,d)+d):m&&(u+=m),this.add(o,"setProperty",l,u,i,s,0,0,_),a.push(_),C.push(_,0,o[_]);else if(p!=="undefined"){if(c&&_ in c?(l=typeof c[_]=="function"?c[_].call(n,i,e,s):c[_],Et(l)&&~l.indexOf("random(")&&(l=kr(l)),wt(l+"")||l==="auto"||(l+=Zt.units[_]||wt(Fn(e,_))||""),(l+"").charAt(1)==="="&&(l=Fn(e,_))):l=Fn(e,_),f=parseFloat(l),E=p==="string"&&u.charAt(1)==="="&&u.substr(0,2),E&&(u=u.substr(2)),h=parseFloat(u),_ in yn&&(_==="autoAlpha"&&(f===1&&Fn(e,"visibility")==="hidden"&&h&&(f=0),C.push("visibility",0,o.visibility),Zn(this,o,"visibility",f?"inherit":"hidden",h?"inherit":"hidden",!h)),_!=="scale"&&_!=="transform"&&(_=yn[_],~_.indexOf(",")&&(_=_.split(",")[0]))),T=_ in kn,T){if(this.styles.save(_),p==="string"&&u.substring(0,6)==="var(--"&&(u=ln(e,u.substring(4,u.indexOf(")"))),h=parseFloat(u)),M||(b=e._gsap,b.renderTransform&&!t.parseTransform||Wr(e,t.parseTransform),w=t.smoothOrigin!==!1&&b.smooth,M=this._pt=new kt(this._pt,o,ut,0,1,b.renderTransform,b,0,-1),M.dep=1),_==="scale")this._pt=new kt(this._pt,b,"scaleY",b.scaleY,(E?nr(b.scaleY,E+h):h)-b.scaleY||0,No),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){C.push(Ht,0,o[Ht]),u=G0(u),b.svg?Bo(e,u,0,w,0,this):(d=parseFloat(u.split(" ")[2])||0,d!==b.zOrigin&&Zn(this,b,"zOrigin",b.zOrigin,d),Zn(this,o,_,Bs(l),Bs(u)));continue}else if(_==="svgOrigin"){Bo(e,u,1,w,0,this);continue}else if(_ in uh){Y0(this,b,_,f,E?nr(f,E+u):u);continue}else if(_==="smoothOrigin"){Zn(this,b,"smooth",b.smooth,u);continue}else if(_==="force3D"){b[_]=u;continue}else if(_==="transform"){K0(this,u,e);continue}}else _ in o||(_=mr(_)||_);if(T||(h||h===0)&&(f||f===0)&&!C0.test(u)&&_ in o)m=(l+"").substr((f+"").length),h||(h=0),d=wt(u)||(_ in Zt.units?Zt.units[_]:m),m!==d&&(f=ri(e,_,l,d)),this._pt=new kt(this._pt,T?b:o,_,f,(E?nr(f,E+h):h)-f,!T&&(d==="px"||_==="zIndex")&&t.autoRound!==!1?L0:No),this._pt.u=d||0,m!==d&&d!=="%"&&(this._pt.b=l,this._pt.r=D0);else if(_ in o)V0.call(this,e,_,l,E?E+u:u);else if(_ in e)this.add(e,_,l||e[_],E?E+u:u,i,s);else if(_!=="parseTransform"){nl(_,u);continue}T||(_ in o?C.push(_,0,o[_]):typeof e[_]=="function"?C.push(_,2,e[_]()):C.push(_,1,l||e[_])),a.push(_)}}R&&th(this)},render:function(e,t){if(t.tween._time||!dl())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:Fn,aliases:yn,getSetter:function(e,t,n){var i=yn[t];return i&&i.indexOf(",")<0&&(t=i),t in kn&&t!==Ht&&(e._gsap.x||Fn(e,"x"))?n&&Rc===n?t==="scale"?F0:N0:(Rc=n||{})&&(t==="scale"?O0:B0):e.style&&!Qo(e.style[t])?I0:~t.indexOf("-")?U0:ul(e,t)},core:{_removeProperty:Di,_getMatrix:ml}};Vt.utils.checkPrefix=mr;Vt.core.getStyleSaver=ah;(function(r,e,t,n){var i=zt(r+","+e+","+t,function(s){kn[s]=1});zt(e,function(s){Zt.units[s]="deg",uh[s]=1}),yn[i[13]]=r+","+e,zt(n,function(s){var a=s.split(":");yn[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");zt("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){Zt.units[r]="px"});Vt.registerPlugin(dh);var Zi=Vt.registerPlugin(dh)||Vt;Zi.core.Tween;document.addEventListener("DOMContentLoaded",()=>{const r=document.getElementById("cd-scene"),e=document.getElementById("zoomWrapper"),t=document.getElementById("desktop"),n=document.getElementById("trainContainer"),i=document.getElementById("taskbar"),s=document.getElementById("aboutMeBtn"),a=document.getElementById("contactBtn"),o=document.getElementById("formBtn");document.getElementById("suggestions");const c=document.getElementById("bookmarksBar"),l=document.getElementById("travelIcon"),u=document.getElementById("mysteryIcon"),h=document.getElementById("homeContent"),f=document.getElementById("companyOverview");let p=0,g=0,_=0,m=0;const d=new Ff,E=new sn(75,1,.001,1e3),T=new Ug({canvas:r,alpha:!0}),M=new br,b=new $o(.7,4.3,64),w=new qf,R=w.load("/kieran.jpg",$=>{$.minFilter=It,$.magFilter=It}),C=new ql({map:R,side:fn}),x=new mn(b,C);M.add(x);const y=w.load("/cd.png",$=>{$.repeat.set(.75,.75),$.offset.set(.126,.126),$.minFilter=It,$.magFilter=It}),D=new ql({map:y,side:fn,transparent:!0,opacity:.7}),N=new mn(b,D);M.add(N),d.add(M);const O=new Zf(16777215,1.2);d.add(O);const q=new $f(16777215,1.5);q.position.set(5,5,5),d.add(q);function V(){const $=window.innerWidth<=768;E.aspect=window.innerWidth/window.innerHeight,E.updateProjectionMatrix(),T.setSize(window.innerWidth,window.innerHeight),p=$?0:-3.3,g=$?1:-.5,M.position.x=p,M.position.y=g;const W=$?.65:1;M.scale.set(W,W,W)}function G(){Zi.to(M.rotation,{z:M.rotation.z+6.283,duration:.8,ease:"power2.out"})}const K=["<li>I studied abroad in Seoul, South Korea for the fall of 2025! And I did trips to Jeju Island, Taiwan, Hong Kong, and Macau. </li><img src='/sk_flag.gif' style='width: 100px; image-rendering: pixelated;' />","<li>I play violin in the <a href='https://umd.gamersymphony.org/' target='_blank'>UMD Gamer Symphony Orchestra</a>. We play video game music that's been student-arranged for a full orchestra. Check us out!</li>","<li><img src='/internet_connection_wiz-2.png' style='height: 50px;' /><br>I love the <a href='https://win98icons.alexmeub.com/' target='_blank'>windows 98 icons</a>.</li>","<li>My favorite artist of all time is Masayoshi Takanaka. If you like jazz fusion with insane guitar, definitely give him a listen.</li><img src='/all_of_me.jpeg' style='width: 100px;' />","<li>In summer 2025, I interned in Seattle. My favorite hikes were Mt. Rainier -> Lake 22 -> Lake Serene (brutal).</li><img src='/DSC07653-3.jpg' style='width: 150px;' />","<li>Kung Fu Panda is my favorite animated movie.</li>","<li>I like taking pictures sometimes.</li><div style='display: flex; flex-direction: row; justify-content: left; gap: 10px;'><img src='/DSC00399.jpg' style='width: 150px;' /><img src='/DSC00455-2.jpg' style='width: 150px;' /><img src='/Sunflower.jpg' style='width: 150px;' /></div>"],z={microsoft:`
        ...
        `};V(),window.addEventListener("resize",()=>{V()}),document.addEventListener("mousemove",$=>{_=$.clientX/window.innerWidth*2-1,m=$.clientY/window.innerHeight*2-1}),E.position.x=p,E.position.y=g,E.position.z=.1,E.rotation.x=-.1;function se(){const $=document.getElementById("loading-screen"),W=document.getElementById("zoomWrapper");W&&(W.style.transition="opacity 1s ease-in",W.style.opacity="1"),$&&($.style.opacity="0",setTimeout(()=>{$.remove()},2e3)),r.style.zIndex=2,n.classList.add("driving"),i.classList.add("show"),Zi.to(E.position,{x:0,y:0,z:10,duration:2.5,ease:"power2.inOut"}),Zi.to(E.rotation,{x:0,duration:2.5,ease:"power2.inOut"})}window.onload=()=>{V(),setTimeout(se,500)};const le=document.getElementById("tryMeArrow");le&&setTimeout(()=>{le.classList.add("fade-out"),setTimeout(()=>{le.remove()},1e3)},2e4);function _e(){requestAnimationFrame(_e),M.rotation.z+=.005;const $=.25,W=m*$*-1,xe=(_-100)*$,ee=.012;M.rotation.x+=(W-M.rotation.x)*ee,M.rotation.y+=(xe-M.rotation.y)*ee,T.render(d,E)}_e();const be=document.getElementById("addressBar"),Oe=document.getElementById("suggestions"),He=document.getElementById("window-template"),Be=document.getElementById("closeBtn");let Z=10,J=null,me=0,Pe=0;const ye=["resume","projects","github","linkedin"];Be.addEventListener("click",$=>{document.querySelectorAll(".draggable-window, .alert-window, .contact-window").forEach(xe=>xe.remove()),r.style.zIndex=13,n.classList.remove("driving"),i.classList.remove("show"),Zi.to(E.position,{x:p,y:g,z:.1,duration:2.5,ease:"power2.inOut"}),Zi.to(E.rotation,{x:-.1,duration:2.5,ease:"power2.inOut",onComplete:se})}),be.addEventListener("input",$=>{const W=$.target.value.toLowerCase();if(W){const xe=ye.filter(ee=>ee.includes(W));xe.length>0?(Oe.innerHTML=xe.map(ee=>`<div class="suggestion-item" data-value="${ee}">${ee}</div>`).join(""),Oe.classList.add("show")):Oe.classList.remove("show")}else Oe.classList.remove("show")}),Oe.addEventListener("click",$=>{if($.target.classList.contains("suggestion-item")){const W=$.target.dataset.value;be.value=W,Oe.classList.remove("show"),_t(W),be.value=""}}),be.addEventListener("keydown",$=>{$.key==="Enter"&&($.preventDefault(),Oe.classList.remove("show"),_t(be.value),be.value="")});const ke=document.getElementById("searchIcon");ke&&ke.addEventListener("click",()=>{const $=be.value;$&&(Oe.classList.remove("show"),_t($),be.value="")}),document.addEventListener("click",$=>{!be.contains($.target)&&!Oe.contains($.target)&&Oe.classList.remove("show")});function _t($){switch($.toLowerCase().trim()){case"resume":Ze({title:"My Resume",icon:"📄",contentUrl:"/resume.html"});break;case"projects":Ze({title:"My Projects",icon:"💡",contentUrl:"/projects.html"});break;case"inception":Ze({title:"Inception",icon:"👁️",contentUrl:"/inception.html"});break;case"travel":Ze({title:"My Travels",icon:"✈️",contentUrl:"/travel.html",width:"1200px",height:"600px"});break;case"github":window.open("https://github.com/kierankhan","_blank");break;case"linkedin":window.open("https://linkedin.com/in/kierankhan","_blank");break;case"are my balls wrinkly?":window.open("https://wrinkle-identifier-db48a.web.app/","_blank");break;case"flashbang":const xe=document.createElement("div");xe.className="flashbang-overlay",e.appendChild(xe),xe.offsetHeight,xe.style.opacity="1";const ee=new Audio("/csgo-flashbang.mp3");ee.volume=.5,ee.play().catch(v=>console.log("Audio error:",v)),setTimeout(()=>{xe.style.opacity="0",setTimeout(()=>{xe.remove()},5e3)},100);break;case"bangladesh jumpscare":const Ye=document.getElementById("gif-template").content.cloneNode(!0).firstElementChild,je=Ye.querySelector(".alert-close-btn"),A=()=>Ye.remove();je.addEventListener("click",A),e.appendChild(Ye),setTimeout(A,1e3);break;default:P(`Address not found.
Try: resume, projects, github, or linkedin`)}be.value=""}function P($){const xe=document.getElementById("simple-alert-template").content.cloneNode(!0).firstElementChild,ee=xe.querySelector(".alert-text");ee.innerText=$;const de=xe.querySelector(".alert-close-btn"),Ye=xe.querySelector(".alert-ok-btn"),je=()=>xe.remove();de.onclick=je,Ye.onclick=je,e.appendChild(xe)}function Ze($){const W=He.content.cloneNode(!0).firstElementChild;W.querySelector(".window-title").textContent=$.title,W.querySelector(".window-icon").textContent=$.icon;const xe=W.querySelector(".window-content"),ee=document.createElement("iframe");if(ee.src=$.contentUrl,xe.appendChild(ee),Z++,W.style.zIndex=Z,$.width&&(W.style.width=$.width,W.style.maxWidth="100vw"),$.height&&(W.style.height=$.height,W.style.maxHeight="100vh"),window.innerWidth>768){const de=Math.floor(Math.random()*100)-50,Ye=Math.floor(Math.random()*100)-50;W.style.transform=`translate(calc(-50% + ${de}px), calc(-50% + ${Ye}px))`}e.appendChild(W)}e.addEventListener("mousedown",$=>{const W=$.target.closest(".draggable-window");W&&(Z++,W.style.zIndex=Z)}),e.addEventListener("click",$=>{if($.target.classList.contains("close-btn")){const W=$.target.closest(".draggable-window");W&&W.remove()}}),e.addEventListener("mousedown",$=>{if($.target.classList.contains("title-bar")){if(window.innerWidth<=768||(J=$.target.closest(".draggable-window"),!J))return;const W=J.getBoundingClientRect();me=$.clientX-W.left,Pe=$.clientY-W.top}}),document.addEventListener("mousemove",$=>{if(J){$.preventDefault();const W=t.getBoundingClientRect();let xe=$.clientX-me-W.left,ee=$.clientY-Pe-W.top;const de=J.getBoundingClientRect();xe=Math.max(0,Math.min(xe,W.width-de.width)),ee=Math.max(0,Math.min(ee,W.height-de.height)),J.style.left=`${xe}px`,J.style.top=`${ee}px`,J.style.transform="none"}}),document.addEventListener("mouseup",()=>{J=null}),s.addEventListener("click",()=>{const W=document.getElementById("alert-template").content.cloneNode(!0).firstElementChild,xe=W.querySelector(".alert-ok-btn"),ee=W.querySelector(".alert-close-btn"),de=()=>W.remove();xe.addEventListener("click",de),ee.addEventListener("click",de),e.appendChild(W)}),a.addEventListener("click",()=>{const W=document.getElementById("contact-template").content.cloneNode(!0).firstElementChild,xe=W.querySelector(".alert-ok-btn"),ee=W.querySelector(".alert-close-btn"),de=()=>W.remove();xe.addEventListener("click",de),ee.addEventListener("click",de),e.appendChild(W)}),o.addEventListener("click",()=>{const W=document.getElementById("form-template").content.cloneNode(!0).firstElementChild,xe=W.querySelector(".alert-close-btn"),ee=W.querySelector("#contact-form"),de=W.querySelector(".alert-ok-btn"),Ye=()=>W.remove();xe.addEventListener("click",Ye),ee.addEventListener("submit",je=>{je.preventDefault(),de.textContent="Sending...",de.disabled=!0;const A=new FormData(ee);fetch(ee.action,{method:"POST",body:A,headers:{Accept:"application/json"}}).then(v=>{v.ok?(de.textContent="Sent!",setTimeout(Ye,1e3)):v.json().then(F=>{Object.hasOwn(F,"errors")?alert(F.errors.map(Y=>Y.message).join(", ")):alert("Oops! Something went wrong."),de.textContent="Send",de.disabled=!1})}).catch(v=>{alert("Oops! A network error occurred."),de.textContent="Send",de.disabled=!1})}),e.appendChild(W)}),l.addEventListener("click",()=>{Ze({title:"My Travels",icon:"✈️",contentUrl:"/travel.html",width:"1200px",height:"600px"})});const Ie=document.getElementById("songIcon");Ie.addEventListener("click",()=>{const $=Ie.getAttribute("href");$&&window.open($,"_blank")}),u.addEventListener("click",()=>{Ze({title:"Huh?",icon:"",contentUrl:"/mystery.html",width:"400px",height:"400px"})}),c.addEventListener("click",$=>{const W=$.target.closest(".bookmark-btn");if(!W)return;const xe=W.dataset.target;if(G(),c.querySelectorAll(".bookmark-btn").forEach(ee=>{ee.classList.remove("selected")}),W.classList.add("selected"),xe==="home")h.style.display="block",f.style.display="none";else if(h.style.display="none",f.innerHTML=z[xe],f.style.display="block",xe==="fun_facts"){const ee=document.getElementById("fun-fact-display"),de=document.getElementById("reroll-btn"),Ye=()=>{const A=Math.floor(Math.random()*K.length);ee.innerHTML=K[A]},je=()=>{Ye(),de.disabled=!0;let A=5;const v=de.innerHTML;de.innerText=`Wait ${A}s...`;const F=setInterval(()=>{A--,A>0?de.innerText=`Wait ${A}s...`:(clearInterval(F),de.disabled=!1,de.innerHTML=v)},1e3)};Ye(),de.addEventListener("click",je)}})});
