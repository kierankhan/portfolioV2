...
`)+`
`+d);const T=y+m+a,M=y+d+o,b=uc(i,i.VERTEX_SHADER,T),A=uc(i,i.FRAGMENT_SHADER,M);i.attachShader(_,b),i.attachShader(_,A),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.morphTargets===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function w(D){if(r.debug.checkShaderErrors){const N=i.getProgramInfoLog(_)||"",O=i.getShaderInfoLog(b)||"",X=i.getShaderInfoLog(A)||"",H=N.trim(),G=O.trim(),q=X.trim();let z=!0,te=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(z=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,b,A);else{const re=fc(i,b,"vertex"),ve=fc(i,A,"fragment");console.error("THREE.WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
...
}`;function Eg(r,e,t){let n=new Ko;const i=new Ye,s=new Ye,a=new ht,o=new Vf({depthPacking:Jh}),c=new Hf,l={},u=t.maxTextureSize,h={[ti]:Ft,[Ft]:ti,[hn]:hn},f=new ni({defines:{VSM_SAMPLES:8},uniforms:{shadow_pass:{value:null},resolution:{value:new Ye},radius:{value:4}},vertexShader:Mg,fragmentShader:Sg}),p=f.clone();p.defines.HORIZONTAL_PASS=1;const g=new si;g.setAttribute("position",new yn(new Float32Array([-1,-1,.5,3,-1,.5,-1,3,.5]),3));const _=new pn(g,f),m=this;this.enabled=!1,this.autoUpdate=!0,this.needsUpdate=!1,this.type=Oc;let d=this.type;this.render=function(A,w,P){if(m.enabled===!1||m.autoUpdate===!1&&m.needsUpdate===!1||A.length===0)return;const x=r.getRenderTarget(),E=r.getActiveCubeFace(),D=r.getActiveMipmapLevel(),N=r.state;N.setBlending(jn),N.buffers.depth.getReversed()===!0?N.buffers.color.setClear(0,0,0,0):N.buffers.color.setClear(1,1,1,1),N.buffers.depth.setTest(!0),N.setScissorTest(!1);const O=d!==Un&&this.type===Un,X=d===Un&&this.type!==Un;for(let H=0,G=A.length;H<G;H++){const q=A[H],z=q.shadow;if(z===void 0){console.warn("THREE.WebGLShadowMap:",q,"has no shadow.");continue}if(z.autoUpdate===!1&&z.needsUpdate===!1)continue;i.copy(z.mapSize);const te=z.getFrameExtents();if(i.multiply(te),s.copy(z.mapSize),(i.x>u||i.y>u)&&(i.x>u&&(s.x=Math.floor(u/te.x),i.x=s.x*te.x,z.mapSize.x=s.x),i.y>u&&(s.y=Math.floor(u/te.y),i.y=s.y*te.y,z.mapSize.y=s.y)),z.map===null||O===!0||X===!0){const ve=this.type!==Un?{minFilter:mn,magFilter:mn}:{};z.map!==null&&z.map.dispose(),z.map=new Pi(i.x,i.y,ve),z.map.texture.name=q.name+".shadowMap",z.camera.updateProjectionMatrix()}r.setRenderTarget(z.map),r.clear();const re=z.getViewportCount();for(let ve=0;ve<re;ve++){const Ie=z.getViewport(ve);a.set(s.x*Ie.x,s.y*Ie.y,s.x*Ie.z,s.y*Ie.w),N.viewport(a),z.updateMatrices(q,ve),n=z.getFrustum(),M(w,P,z.camera,q,this.type)}z.isPointLightShadow!==!0&&this.type===Un&&y(z,P),z.needsUpdate=!1}d=this.type,m.needsUpdate=!1,r.setRenderTarget(x,E,D)};function y(A,w){const P=e.update(_);f.defines.VSM_SAMPLES!==A.blurSamples&&(f.defines.VSM_SAMPLES=A.blurSamples,p.defines.VSM_SAMPLES=A.blurSamples,f.needsUpdate=!0,p.needsUpdate=!0),A.mapPass===null&&(A.mapPass=new Pi(i.x,i.y)),f.uniforms.shadow_pass.value=A.map.texture,f.uniforms.resolution.value=A.mapSize,f.uniforms.radius.value=A.radius,r.setRenderTarget(A.mapPass),r.clear(),r.renderBufferDirect(w,null,P,f,_,null),p.uniforms.shadow_pass.value=A.mapPass.texture,p.uniforms.resolution.value=A.mapSize,p.uniforms.radius.value=A.radius,r.setRenderTarget(A.map),r.clear(),r.renderBufferDirect(w,null,P,p,_,null)}function T(A,w,P,x){let E=null;const D=P.isPointLight===!0?A.customDistanceMaterial:A.customDepthMaterial;if(D!==void 0)E=D;else if(E=P.isPointLight===!0?c:o,r.localClippingEnabled&&w.clipShadows===!0&&Array.isArray(w.clippingPlanes)&&w.clippingPlanes.length!==0||w.displacementMap&&w.displacementScale!==0||w.alphaMap&&w.alphaTest>0||w.map&&w.alphaTest>0||w.alphaToCoverage===!0){const N=E.uuid,O=w.uuid;let X=l[N];X===void 0&&(X={},l[N]=X);let H=X[O];H===void 0&&(H=E.clone(),X[O]=H,w.addEventListener("dispose",b)),E=H}if(E.visible=w.visible,E.wireframe=w.wireframe,x===Un?E.side=w.shadowSide!==null?w.shadowSide:w.side:E.side=w.shadowSide!==null?w.shadowSide:h[w.side],E.alphaMap=w.alphaMap,E.alphaTest=w.alphaToCoverage===!0?.5:w.alphaTest,E.map=w.map,E.clipShadows=w.clipShadows,E.clippingPlanes=w.clippingPlanes,E.clipIntersection=w.clipIntersection,E.displacementMap=w.displacementMap,E.displacementScale=w.displacementScale,E.displacementBias=w.displacementBias,E.wireframeLinewidth=w.wireframeLinewidth,E.linewidth=w.linewidth,P.isPointLight===!0&&E.isMeshDistanceMaterial===!0){const N=r.properties.get(E);N.light=P}return E}function M(A,w,P,x,E){if(A.visible===!1)return;if(A.layers.test(w.layers)&&(A.isMesh||A.isLine||A.isPoints)&&(A.castShadow||A.receiveShadow&&E===Un)&&(!A.frustumCulled||n.intersectsObject(A))){A.modelViewMatrix.multiplyMatrices(P.matrixWorldInverse,A.matrixWorld);const O=e.update(A),X=A.material;if(Array.isArray(X)){const H=O.groups;for(let G=0,q=H.length;G<q;G++){const z=H[G],te=X[z.materialIndex];if(te&&te.visible){const re=T(A,te,x,E);A.onBeforeShadow(r,A,w,P,O,re,z),r.renderBufferDirect(P,null,O,re,A,z),A.onAfterShadow(r,A,w,P,O,re,z)}}}else if(X.visible){const H=T(A,X,x,E);A.onBeforeShadow(r,A,w,P,O,H,null),r.renderBufferDirect(P,null,O,H,A,null),A.onAfterShadow(r,A,w,P,O,H,null)}}const N=A.children;for(let O=0,X=N.length;O<X;O++)M(N[O],w,P,x,E)}function b(A){A.target.removeEventListener("dispose",b);for(const P in l){const x=l[P],E=A.target.uuid;E in x&&(x[E].dispose(),delete x[E])}}}const yg={[Fa]:Oa,[Ba]:Va,[za]:Ha,[sr]:ka,[Oa]:Fa,[Va]:Ba,[Ha]:za,[ka]:sr};function Tg(r,e){function t(){let L=!1;const ie=new ht;let ae=null;const ge=new ht(0,0,0,0);return{setMask:function(Q){ae!==Q&&!L&&(r.colorMask(Q,Q,Q,Q),ae=Q)},setLocked:function(Q){L=Q},setClear:function(Q,$,Se,Oe,it){it===!0&&(Q*=Oe,$*=Oe,Se*=Oe),ie.set(Q,$,Se,Oe),ge.equals(ie)===!1&&(r.clearColor(Q,$,Se,Oe),ge.copy(ie))},reset:function(){L=!1,ae=null,ge.set(-1,0,0,0)}}}function n(){let L=!1,ie=!1,ae=null,ge=null,Q=null;return{setReversed:function($){if(ie!==$){const Se=e.get("EXT_clip_control");$?Se.clipControlEXT(Se.LOWER_LEFT_EXT,Se.ZERO_TO_ONE_EXT):Se.clipControlEXT(Se.LOWER_LEFT_EXT,Se.NEGATIVE_ONE_TO_ONE_EXT),ie=$;const Oe=Q;Q=null,this.setClear(Oe)}},getReversed:function(){return ie},setTest:function($){$?Z(r.DEPTH_TEST):pe(r.DEPTH_TEST)},setMask:function($){ae!==$&&!L&&(r.depthMask($),ae=$)},setFunc:function($){if(ie&&($=yg[$]),ge!==$){switch($){case Fa:r.depthFunc(r.NEVER);break;case Oa:r.depthFunc(r.ALWAYS);break;case Ba:r.depthFunc(r.LESS);break;case sr:r.depthFunc(r.LEQUAL);break;case za:r.depthFunc(r.EQUAL);break;case ka:r.depthFunc(r.GEQUAL);break;case Va:r.depthFunc(r.GREATER);break;case Ha:r.depthFunc(r.NOTEQUAL);break;default:r.depthFunc(r.LEQUAL)}ge=$}},setLocked:function($){L=$},setClear:function($){Q!==$&&(ie&&($=1-$),r.clearDepth($),Q=$)},reset:function(){L=!1,ae=null,ge=null,Q=null,ie=!1}}}function i(){let L=!1,ie=null,ae=null,ge=null,Q=null,$=null,Se=null,Oe=null,it=null;return{setTest:function(Ze){L||(Ze?Z(r.STENCIL_TEST):pe(r.STENCIL_TEST))},setMask:function(Ze){ie!==Ze&&!L&&(r.stencilMask(Ze),ie=Ze)},setFunc:function(Ze,Rn,_n){(ae!==Ze||ge!==Rn||Q!==_n)&&(r.stencilFunc(Ze,Rn,_n),ae=Ze,ge=Rn,Q=_n)},setOp:function(Ze,Rn,_n){($!==Ze||Se!==Rn||Oe!==_n)&&(r.stencilOp(Ze,Rn,_n),$=Ze,Se=Rn,Oe=_n)},setLocked:function(Ze){L=Ze},setClear:function(Ze){it!==Ze&&(r.clearStencil(Ze),it=Ze)},reset:function(){L=!1,ie=null,ae=null,ge=null,Q=null,$=null,Se=null,Oe=null,it=null}}}const s=new t,a=new n,o=new i,c=new WeakMap,l=new WeakMap;let u={},h={},f=new WeakMap,p=[],g=null,_=!1,m=null,d=null,y=null,T=null,M=null,b=null,A=null,w=new qe(0,0,0),P=0,x=!1,E=null,D=null,N=null,O=null,X=null;const H=r.getParameter(r.MAX_COMBINED_TEXTURE_IMAGE_UNITS);let G=!1,q=0;const z=r.getParameter(r.VERSION);z.indexOf("WebGL")!==-1?(q=parseFloat(/^WebGL (\d)/.exec(z)[1]),G=q>=1):z.indexOf("OpenGL ES")!==-1&&(q=parseFloat(/^OpenGL ES (\d)/.exec(z)[1]),G=q>=2);let te=null,re={};const ve=r.getParameter(r.SCISSOR_BOX),Ie=r.getParameter(r.VIEWPORT),Xe=new ht().fromArray(ve),Ne=new ht().fromArray(Ie);function Be(L,ie,ae,ge){const Q=new Uint8Array(4),$=r.createTexture();r.bindTexture(L,$),r.texParameteri(L,r.TEXTURE_MIN_FILTER,r.NEAREST),r.texParameteri(L,r.TEXTURE_MAG_FILTER,r.NEAREST);for(let Se=0;Se<ae;Se++)L===r.TEXTURE_3D||L===r.TEXTURE_2D_ARRAY?r.texImage3D(ie,0,r.RGBA,1,1,ge,0,r.RGBA,r.UNSIGNED_BYTE,Q):r.texImage2D(ie+Se,0,r.RGBA,1,1,0,r.RGBA,r.UNSIGNED_BYTE,Q);return $}const K={};K[r.TEXTURE_2D]=Be(r.TEXTURE_2D,r.TEXTURE_2D,1),K[r.TEXTURE_CUBE_MAP]=Be(r.TEXTURE_CUBE_MAP,r.TEXTURE_CUBE_MAP_POSITIVE_X,6),K[r.TEXTURE_2D_ARRAY]=Be(r.TEXTURE_2D_ARRAY,r.TEXTURE_2D_ARRAY,1,1),K[r.TEXTURE_3D]=Be(r.TEXTURE_3D,r.TEXTURE_3D,1,1),s.setClear(0,0,0,1),a.setClear(1),o.setClear(0),Z(r.DEPTH_TEST),a.setFunc(sr),Ae(!1),me(El),Z(r.CULL_FACE),Ce(jn);function Z(L){u[L]!==!0&&(r.enable(L),u[L]=!0)}function pe(L){u[L]!==!1&&(r.disable(L),u[L]=!1)}function Pe(L,ie){return h[L]!==ie?(r.bindFramebuffer(L,ie),h[L]=ie,L===r.DRAW_FRAMEBUFFER&&(h[r.FRAMEBUFFER]=ie),L===r.FRAMEBUFFER&&(h[r.DRAW_FRAMEBUFFER]=ie),!0):!1}function Me(L,ie){let ae=p,ge=!1;if(L){ae=f.get(ie),ae===void 0&&(ae=[],f.set(ie,ae));const Q=L.textures;if(ae.length!==Q.length||ae[0]!==r.COLOR_ATTACHMENT0){for(let $=0,Se=Q.length;$<Se;$++)ae[$]=r.COLOR_ATTACHMENT0+$;ae.length=Q.length,ge=!0}}else ae[0]!==r.BACK&&(ae[0]=r.BACK,ge=!0);ge&&r.drawBuffers(ae)}function J(L){return g!==L?(r.useProgram(L),g=L,!0):!1}const le={[Mi]:r.FUNC_ADD,[Th]:r.FUNC_SUBTRACT,[bh]:r.FUNC_REVERSE_SUBTRACT};le[Ah]=r.MIN,le[wh]=r.MAX;const C={[Rh]:r.ZERO,[Ch]:r.ONE,[Ph]:r.SRC_COLOR,[Ua]:r.SRC_ALPHA,[Fh]:r.SRC_ALPHA_SATURATE,[Uh]:r.DST_COLOR,[Lh]:r.DST_ALPHA,[Dh]:r.ONE_MINUS_SRC_COLOR,[Na]:r.ONE_MINUS_SRC_ALPHA,[Nh]:r.ONE_MINUS_DST_COLOR,[Ih]:r.ONE_MINUS_DST_ALPHA,[Oh]:r.CONSTANT_COLOR,[Bh]:r.ONE_MINUS_CONSTANT_COLOR,[zh]:r.CONSTANT_ALPHA,[kh]:r.ONE_MINUS_CONSTANT_ALPHA};function Ce(L,ie,ae,ge,Q,$,Se,Oe,it,Ze){if(L===jn){_===!0&&(pe(r.BLEND),_=!1);return}if(_===!1&&(Z(r.BLEND),_=!0),L!==yh){if(L!==m||Ze!==x){if((d!==Mi||M!==Mi)&&(r.blendEquation(r.FUNC_ADD),d=Mi,M=Mi),Ze)switch(L){case er:r.blendFuncSeparate(r.ONE,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case yl:r.blendFunc(r.ONE,r.ONE);break;case Tl:r.blendFuncSeparate(r.ZERO,r.ONE_MINUS_SRC_COLOR,r.ZERO,r.ONE);break;case bl:r.blendFuncSeparate(r.DST_COLOR,r.ONE_MINUS_SRC_ALPHA,r.ZERO,r.ONE);break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}else switch(L){case er:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE_MINUS_SRC_ALPHA,r.ONE,r.ONE_MINUS_SRC_ALPHA);break;case yl:r.blendFuncSeparate(r.SRC_ALPHA,r.ONE,r.ONE,r.ONE);break;case Tl:console.error("THREE.WebGLState: SubtractiveBlending requires material.premultipliedAlpha = true");break;case bl:console.error("THREE.WebGLState: MultiplyBlending requires material.premultipliedAlpha = true");break;default:console.error("THREE.WebGLState: Invalid blending: ",L);break}y=null,T=null,b=null,A=null,w.set(0,0,0),P=0,m=L,x=Ze}return}Q=Q||ie,$=$||ae,Se=Se||ge,(ie!==d||Q!==M)&&(r.blendEquationSeparate(le[ie],le[Q]),d=ie,M=Q),(ae!==y||ge!==T||$!==b||Se!==A)&&(r.blendFuncSeparate(C[ae],C[ge],C[$],C[Se]),y=ae,T=ge,b=$,A=Se),(Oe.equals(w)===!1||it!==P)&&(r.blendColor(Oe.r,Oe.g,Oe.b,it),w.copy(Oe),P=it),m=L,x=!1}function fe(L,ie){L.side===hn?pe(r.CULL_FACE):Z(r.CULL_FACE);let ae=L.side===Ft;ie&&(ae=!ae),Ae(ae),L.blending===er&&L.transparent===!1?Ce(jn):Ce(L.blending,L.blendEquation,L.blendSrc,L.blendDst,L.blendEquationAlpha,L.blendSrcAlpha,L.blendDstAlpha,L.blendColor,L.blendAlpha,L.premultipliedAlpha),a.setFunc(L.depthFunc),a.setTest(L.depthTest),a.setMask(L.depthWrite),s.setMask(L.colorWrite);const ge=L.stencilWrite;o.setTest(ge),ge&&(o.setMask(L.stencilWriteMask),o.setFunc(L.stencilFunc,L.stencilRef,L.stencilFuncMask),o.setOp(L.stencilFail,L.stencilZFail,L.stencilZPass)),_e(L.polygonOffset,L.polygonOffsetFactor,L.polygonOffsetUnits),L.alphaToCoverage===!0?Z(r.SAMPLE_ALPHA_TO_COVERAGE):pe(r.SAMPLE_ALPHA_TO_COVERAGE)}function Ae(L){E!==L&&(L?r.frontFace(r.CW):r.frontFace(r.CCW),E=L)}function me(L){L!==Mh?(Z(r.CULL_FACE),L!==D&&(L===El?r.cullFace(r.BACK):L===Sh?r.cullFace(r.FRONT):r.cullFace(r.FRONT_AND_BACK))):pe(r.CULL_FACE),D=L}function nt(L){L!==N&&(G&&r.lineWidth(L),N=L)}function _e(L,ie,ae){L?(Z(r.POLYGON_OFFSET_FILL),(O!==ie||X!==ae)&&(r.polygonOffset(ie,ae),O=ie,X=ae)):pe(r.POLYGON_OFFSET_FILL)}function Fe(L){L?Z(r.SCISSOR_TEST):pe(r.SCISSOR_TEST)}function _t(L){L===void 0&&(L=r.TEXTURE0+H-1),te!==L&&(r.activeTexture(L),te=L)}function dt(L,ie,ae){ae===void 0&&(te===null?ae=r.TEXTURE0+H-1:ae=te);let ge=re[ae];ge===void 0&&(ge={type:void 0,texture:void 0},re[ae]=ge),(ge.type!==L||ge.texture!==ie)&&(te!==ae&&(r.activeTexture(ae),te=ae),r.bindTexture(L,ie||K[L]),ge.type=L,ge.texture=ie)}function R(){const L=re[te];L!==void 0&&L.type!==void 0&&(r.bindTexture(L.type,null),L.type=void 0,L.texture=void 0)}function v(){try{r.compressedTexImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function F(){try{r.compressedTexImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Y(){try{r.texSubImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function j(){try{r.texSubImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function W(){try{r.compressedTexSubImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function be(){try{r.compressedTexSubImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function se(){try{r.texStorage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function Ee(){try{r.texStorage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ye(){try{r.texImage2D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function ne(){try{r.texImage3D(...arguments)}catch(L){console.error("THREE.WebGLState:",L)}}function he(L){Xe.equals(L)===!1&&(r.scissor(L.x,L.y,L.z,L.w),Xe.copy(L))}function Le(L){Ne.equals(L)===!1&&(r.viewport(L.x,L.y,L.z,L.w),Ne.copy(L))}function Te(L,ie){let ae=l.get(ie);ae===void 0&&(ae=new WeakMap,l.set(ie,ae));let ge=ae.get(L);ge===void 0&&(ge=r.getUniformBlockIndex(ie,L.name),ae.set(L,ge))}function ce(L,ie){const ge=l.get(ie).get(L);c.get(ie)!==ge&&(r.uniformBlockBinding(ie,ge,L.__bindingPointIndex),c.set(ie,ge))}function ze(){r.disable(r.BLEND),r.disable(r.CULL_FACE),r.disable(r.DEPTH_TEST),r.disable(r.POLYGON_OFFSET_FILL),r.disable(r.SCISSOR_TEST),r.disable(r.STENCIL_TEST),r.disable(r.SAMPLE_ALPHA_TO_COVERAGE),r.blendEquation(r.FUNC_ADD),r.blendFunc(r.ONE,r.ZERO),r.blendFuncSeparate(r.ONE,r.ZERO,r.ONE,r.ZERO),r.blendColor(0,0,0,0),r.colorMask(!0,!0,!0,!0),r.clearColor(0,0,0,0),r.depthMask(!0),r.depthFunc(r.LESS),a.setReversed(!1),r.clearDepth(1),r.stencilMask(4294967295),r.stencilFunc(r.ALWAYS,0,4294967295),r.stencilOp(r.KEEP,r.KEEP,r.KEEP),r.clearStencil(0),r.cullFace(r.BACK),r.frontFace(r.CCW),r.polygonOffset(0,0),r.activeTexture(r.TEXTURE0),r.bindFramebuffer(r.FRAMEBUFFER,null),r.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),r.bindFramebuffer(r.READ_FRAMEBUFFER,null),r.useProgram(null),r.lineWidth(1),r.scissor(0,0,r.canvas.width,r.canvas.height),r.viewport(0,0,r.canvas.width,r.canvas.height),u={},te=null,re={},h={},f=new WeakMap,p=[],g=null,_=!1,m=null,d=null,y=null,T=null,M=null,b=null,A=null,w=new qe(0,0,0),P=0,x=!1,E=null,D=null,N=null,O=null,X=null,Xe.set(0,0,r.canvas.width,r.canvas.height),Ne.set(0,0,r.canvas.width,r.canvas.height),s.reset(),a.reset(),o.reset()}return{buffers:{color:s,depth:a,stencil:o},enable:Z,disable:pe,bindFramebuffer:Pe,drawBuffers:Me,useProgram:J,setBlending:Ce,setMaterial:fe,setFlipSided:Ae,setCullFace:me,setLineWidth:nt,setPolygonOffset:_e,setScissorTest:Fe,activeTexture:_t,bindTexture:dt,unbindTexture:R,compressedTexImage2D:v,compressedTexImage3D:F,texImage2D:ye,texImage3D:ne,updateUBOMapping:Te,uniformBlockBinding:ce,texStorage2D:se,texStorage3D:Ee,texSubImage2D:Y,texSubImage3D:j,compressedTexSubImage2D:W,compressedTexSubImage3D:be,scissor:he,viewport:Le,reset:ze}}function bg(r,e,t,n,i,s,a){const o=e.has("WEBGL_multisampled_render_to_texture")?e.get("WEBGL_multisampled_render_to_texture"):null,c=typeof navigator>"u"?!1:/OculusBrowser/g.test(navigator.userAgent),l=new Ye,u=new WeakMap;let h;const f=new WeakMap;let p=!1;try{p=typeof OffscreenCanvas<"u"&&new OffscreenCanvas(1,1).getContext("2d")!==null}catch{}function g(R,v){return p?new OffscreenCanvas(R,v):Fr("canvas")}function _(R,v,F){let Y=1;const j=dt(R);if((j.width>F||j.height>F)&&(Y=F/Math.max(j.width,j.height)),Y<1)if(typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement||typeof HTMLCanvasElement<"u"&&R instanceof HTMLCanvasElement||typeof ImageBitmap<"u"&&R instanceof ImageBitmap||typeof VideoFrame<"u"&&R instanceof VideoFrame){const W=Math.floor(Y*j.width),be=Math.floor(Y*j.height);h===void 0&&(h=g(W,be));const se=v?g(W,be):h;return se.width=W,se.height=be,se.getContext("2d").drawImage(R,0,0,W,be),console.warn("THREE.WebGLRenderer: Texture has been resized from ("+j.width+"x"+j.height+") to ("+W+"x"+be+")."),se}else return"data"in R&&console.warn("THREE.WebGLRenderer: Image in DataTexture is too big ("+j.width+"x"+j.height+")."),R;return R}function m(R){return R.generateMipmaps}function d(R){r.generateMipmap(R)}function y(R){return R.isWebGLCubeRenderTarget?r.TEXTURE_CUBE_MAP:R.isWebGL3DRenderTarget?r.TEXTURE_3D:R.isWebGLArrayRenderTarget||R.isCompressedArrayTexture?r.TEXTURE_2D_ARRAY:r.TEXTURE_2D}function T(R,v,F,Y,j=!1){if(R!==null){if(r[R]!==void 0)return r[R];console.warn("THREE.WebGLRenderer: Attempt to use non-existing WebGL internal format '"+R+"'")}let W=v;if(v===r.RED&&(F===r.FLOAT&&(W=r.R32F),F===r.HALF_FLOAT&&(W=r.R16F),F===r.UNSIGNED_BYTE&&(W=r.R8)),v===r.RED_INTEGER&&(F===r.UNSIGNED_BYTE&&(W=r.R8UI),F===r.UNSIGNED_SHORT&&(W=r.R16UI),F===r.UNSIGNED_INT&&(W=r.R32UI),F===r.BYTE&&(W=r.R8I),F===r.SHORT&&(W=r.R16I),F===r.INT&&(W=r.R32I)),v===r.RG&&(F===r.FLOAT&&(W=r.RG32F),F===r.HALF_FLOAT&&(W=r.RG16F),F===r.UNSIGNED_BYTE&&(W=r.RG8)),v===r.RG_INTEGER&&(F===r.UNSIGNED_BYTE&&(W=r.RG8UI),F===r.UNSIGNED_SHORT&&(W=r.RG16UI),F===r.UNSIGNED_INT&&(W=r.RG32UI),F===r.BYTE&&(W=r.RG8I),F===r.SHORT&&(W=r.RG16I),F===r.INT&&(W=r.RG32I)),v===r.RGB_INTEGER&&(F===r.UNSIGNED_BYTE&&(W=r.RGB8UI),F===r.UNSIGNED_SHORT&&(W=r.RGB16UI),F===r.UNSIGNED_INT&&(W=r.RGB32UI),F===r.BYTE&&(W=r.RGB8I),F===r.SHORT&&(W=r.RGB16I),F===r.INT&&(W=r.RGB32I)),v===r.RGBA_INTEGER&&(F===r.UNSIGNED_BYTE&&(W=r.RGBA8UI),F===r.UNSIGNED_SHORT&&(W=r.RGBA16UI),F===r.UNSIGNED_INT&&(W=r.RGBA32UI),F===r.BYTE&&(W=r.RGBA8I),F===r.SHORT&&(W=r.RGBA16I),F===r.INT&&(W=r.RGBA32I)),v===r.RGB&&(F===r.UNSIGNED_INT_5_9_9_9_REV&&(W=r.RGB9_E5),F===r.UNSIGNED_INT_10F_11F_11F_REV&&(W=r.R11F_G11F_B10F)),v===r.RGBA){const be=j?Ps:$e.getTransfer(Y);F===r.FLOAT&&(W=r.RGBA32F),F===r.HALF_FLOAT&&(W=r.RGBA16F),F===r.UNSIGNED_BYTE&&(W=be===Je?r.SRGB8_ALPHA8:r.RGBA8),F===r.UNSIGNED_SHORT_4_4_4_4&&(W=r.RGBA4),F===r.UNSIGNED_SHORT_5_5_5_1&&(W=r.RGB5_A1)}return(W===r.R16F||W===r.R32F||W===r.RG16F||W===r.RG32F||W===r.RGBA16F||W===r.RGBA32F)&&e.get("EXT_color_buffer_float"),W}function M(R,v){let F;return R?v===null||v===Ci||v===Ir?F=r.DEPTH24_STENCIL8:v===On?F=r.DEPTH32F_STENCIL8:v===Lr&&(F=r.DEPTH24_STENCIL8,console.warn("DepthTexture: 16 bit depth attachment is not supported with stencil. Using 24-bit attachment.")):v===null||v===Ci||v===Ir?F=r.DEPTH_COMPONENT24:v===On?F=r.DEPTH_COMPONENT32F:v===Lr&&(F=r.DEPTH_COMPONENT16),F}function b(R,v){return m(R)===!0||R.isFramebufferTexture&&R.minFilter!==mn&&R.minFilter!==Mn?Math.log2(Math.max(v.width,v.height))+1:R.mipmaps!==void 0&&R.mipmaps.length>0?R.mipmaps.length:R.isCompressedTexture&&Array.isArray(R.image)?v.mipmaps.length:1}function A(R){const v=R.target;v.removeEventListener("dispose",A),P(v),v.isVideoTexture&&u.delete(v)}function w(R){const v=R.target;v.removeEventListener("dispose",w),E(v)}function P(R){const v=n.get(R);if(v.__webglInit===void 0)return;const F=R.source,Y=f.get(F);if(Y){const j=Y[v.__cacheKey];j.usedTimes--,j.usedTimes===0&&x(R),Object.keys(Y).length===0&&f.delete(F)}n.remove(R)}function x(R){const v=n.get(R);r.deleteTexture(v.__webglTexture);const F=R.source,Y=f.get(F);delete Y[v.__cacheKey],a.memory.textures--}function E(R){const v=n.get(R);if(R.depthTexture&&(R.depthTexture.dispose(),n.remove(R.depthTexture)),R.isWebGLCubeRenderTarget)for(let Y=0;Y<6;Y++){if(Array.isArray(v.__webglFramebuffer[Y]))for(let j=0;j<v.__webglFramebuffer[Y].length;j++)r.deleteFramebuffer(v.__webglFramebuffer[Y][j]);else r.deleteFramebuffer(v.__webglFramebuffer[Y]);v.__webglDepthbuffer&&r.deleteRenderbuffer(v.__webglDepthbuffer[Y])}else{if(Array.isArray(v.__webglFramebuffer))for(let Y=0;Y<v.__webglFramebuffer.length;Y++)r.deleteFramebuffer(v.__webglFramebuffer[Y]);else r.deleteFramebuffer(v.__webglFramebuffer);if(v.__webglDepthbuffer&&r.deleteRenderbuffer(v.__webglDepthbuffer),v.__webglMultisampledFramebuffer&&r.deleteFramebuffer(v.__webglMultisampledFramebuffer),v.__webglColorRenderbuffer)for(let Y=0;Y<v.__webglColorRenderbuffer.length;Y++)v.__webglColorRenderbuffer[Y]&&r.deleteRenderbuffer(v.__webglColorRenderbuffer[Y]);v.__webglDepthRenderbuffer&&r.deleteRenderbuffer(v.__webglDepthRenderbuffer)}const F=R.textures;for(let Y=0,j=F.length;Y<j;Y++){const W=n.get(F[Y]);W.__webglTexture&&(r.deleteTexture(W.__webglTexture),a.memory.textures--),n.remove(F[Y])}n.remove(R)}let D=0;function N(){D=0}function O(){const R=D;return R>=i.maxTextures&&console.warn("THREE.WebGLTextures: Trying to use "+R+" texture units while this GPU supports only "+i.maxTextures),D+=1,R}function X(R){const v=[];return v.push(R.wrapS),v.push(R.wrapT),v.push(R.wrapR||0),v.push(R.magFilter),v.push(R.minFilter),v.push(R.anisotropy),v.push(R.internalFormat),v.push(R.format),v.push(R.type),v.push(R.generateMipmaps),v.push(R.premultiplyAlpha),v.push(R.flipY),v.push(R.unpackAlignment),v.push(R.colorSpace),v.join()}function H(R,v){const F=n.get(R);if(R.isVideoTexture&&Fe(R),R.isRenderTargetTexture===!1&&R.isExternalTexture!==!0&&R.version>0&&F.__version!==R.version){const Y=R.image;if(Y===null)console.warn("THREE.WebGLRenderer: Texture marked for update but no image data found.");else if(Y.complete===!1)console.warn("THREE.WebGLRenderer: Texture marked for update but image is incomplete");else{K(F,R,v);return}}else R.isExternalTexture&&(F.__webglTexture=R.sourceTexture?R.sourceTexture:null);t.bindTexture(r.TEXTURE_2D,F.__webglTexture,r.TEXTURE0+v)}function G(R,v){const F=n.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&F.__version!==R.version){K(F,R,v);return}t.bindTexture(r.TEXTURE_2D_ARRAY,F.__webglTexture,r.TEXTURE0+v)}function q(R,v){const F=n.get(R);if(R.isRenderTargetTexture===!1&&R.version>0&&F.__version!==R.version){K(F,R,v);return}t.bindTexture(r.TEXTURE_3D,F.__webglTexture,r.TEXTURE0+v)}function z(R,v){const F=n.get(R);if(R.version>0&&F.__version!==R.version){Z(F,R,v);return}t.bindTexture(r.TEXTURE_CUBE_MAP,F.__webglTexture,r.TEXTURE0+v)}const te={[Xa]:r.REPEAT,[Ei]:r.CLAMP_TO_EDGE,[qa]:r.MIRRORED_REPEAT},re={[mn]:r.NEAREST,[Zh]:r.NEAREST_MIPMAP_NEAREST,[es]:r.NEAREST_MIPMAP_LINEAR,[Mn]:r.LINEAR,[Ys]:r.LINEAR_MIPMAP_NEAREST,[yi]:r.LINEAR_MIPMAP_LINEAR},ve={[ef]:r.NEVER,[of]:r.ALWAYS,[tf]:r.LESS,[$c]:r.LEQUAL,[nf]:r.EQUAL,[af]:r.GEQUAL,[rf]:r.GREATER,[sf]:r.NOTEQUAL};function Ie(R,v){if(v.type===On&&e.has("OES_texture_float_linear")===!1&&(v.magFilter===Mn||v.magFilter===Ys||v.magFilter===es||v.magFilter===yi||v.minFilter===Mn||v.minFilter===Ys||v.minFilter===es||v.minFilter===yi)&&console.warn("THREE.WebGLRenderer: Unable to use linear filtering with floating point textures. OES_texture_float_linear not supported on this device."),r.texParameteri(R,r.TEXTURE_WRAP_S,te[v.wrapS]),r.texParameteri(R,r.TEXTURE_WRAP_T,te[v.wrapT]),(R===r.TEXTURE_3D||R===r.TEXTURE_2D_ARRAY)&&r.texParameteri(R,r.TEXTURE_WRAP_R,te[v.wrapR]),r.texParameteri(R,r.TEXTURE_MAG_FILTER,re[v.magFilter]),r.texParameteri(R,r.TEXTURE_MIN_FILTER,re[v.minFilter]),v.compareFunction&&(r.texParameteri(R,r.TEXTURE_COMPARE_MODE,r.COMPARE_REF_TO_TEXTURE),r.texParameteri(R,r.TEXTURE_COMPARE_FUNC,ve[v.compareFunction])),e.has("EXT_texture_filter_anisotropic")===!0){if(v.magFilter===mn||v.minFilter!==es&&v.minFilter!==yi||v.type===On&&e.has("OES_texture_float_linear")===!1)return;if(v.anisotropy>1||n.get(v).__currentAnisotropy){const F=e.get("EXT_texture_filter_anisotropic");r.texParameterf(R,F.TEXTURE_MAX_ANISOTROPY_EXT,Math.min(v.anisotropy,i.getMaxAnisotropy())),n.get(v).__currentAnisotropy=v.anisotropy}}}function Xe(R,v){let F=!1;R.__webglInit===void 0&&(R.__webglInit=!0,v.addEventListener("dispose",A));const Y=v.source;let j=f.get(Y);j===void 0&&(j={},f.set(Y,j));const W=X(v);if(W!==R.__cacheKey){j[W]===void 0&&(j[W]={texture:r.createTexture(),usedTimes:0},a.memory.textures++,F=!0),j[W].usedTimes++;const be=j[R.__cacheKey];be!==void 0&&(j[R.__cacheKey].usedTimes--,be.usedTimes===0&&x(v)),R.__cacheKey=W,R.__webglTexture=j[W].texture}return F}function Ne(R,v,F){return Math.floor(Math.floor(R/F)/v)}function Be(R,v,F,Y){const W=R.updateRanges;if(W.length===0)t.texSubImage2D(r.TEXTURE_2D,0,0,0,v.width,v.height,F,Y,v.data);else{W.sort((ne,he)=>ne.start-he.start);let be=0;for(let ne=1;ne<W.length;ne++){const he=W[be],Le=W[ne],Te=he.start+he.count,ce=Ne(Le.start,v.width,4),ze=Ne(he.start,v.width,4);Le.start<=Te+1&&ce===ze&&Ne(Le.start+Le.count-1,v.width,4)===ce?he.count=Math.max(he.count,Le.start+Le.count-he.start):(++be,W[be]=Le)}W.length=be+1;const se=r.getParameter(r.UNPACK_ROW_LENGTH),Ee=r.getParameter(r.UNPACK_SKIP_PIXELS),ye=r.getParameter(r.UNPACK_SKIP_ROWS);r.pixelStorei(r.UNPACK_ROW_LENGTH,v.width);for(let ne=0,he=W.length;ne<he;ne++){const Le=W[ne],Te=Math.floor(Le.start/4),ce=Math.ceil(Le.count/4),ze=Te%v.width,L=Math.floor(Te/v.width),ie=ce,ae=1;r.pixelStorei(r.UNPACK_SKIP_PIXELS,ze),r.pixelStorei(r.UNPACK_SKIP_ROWS,L),t.texSubImage2D(r.TEXTURE_2D,0,ze,L,ie,ae,F,Y,v.data)}R.clearUpdateRanges(),r.pixelStorei(r.UNPACK_ROW_LENGTH,se),r.pixelStorei(r.UNPACK_SKIP_PIXELS,Ee),r.pixelStorei(r.UNPACK_SKIP_ROWS,ye)}}function K(R,v,F){let Y=r.TEXTURE_2D;(v.isDataArrayTexture||v.isCompressedArrayTexture)&&(Y=r.TEXTURE_2D_ARRAY),v.isData3DTexture&&(Y=r.TEXTURE_3D);const j=Xe(R,v),W=v.source;t.bindTexture(Y,R.__webglTexture,r.TEXTURE0+F);const be=n.get(W);if(W.version!==be.__version||j===!0){t.activeTexture(r.TEXTURE0+F);const se=$e.getPrimaries($e.workingColorSpace),Ee=v.colorSpace===Yn?null:$e.getPrimaries(v.colorSpace),ye=v.colorSpace===Yn||se===Ee?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,v.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,v.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,ye);let ne=_(v.image,!1,i.maxTextureSize);ne=_t(v,ne);const he=s.convert(v.format,v.colorSpace),Le=s.convert(v.type);let Te=T(v.internalFormat,he,Le,v.colorSpace,v.isVideoTexture);Ie(Y,v);let ce;const ze=v.mipmaps,L=v.isVideoTexture!==!0,ie=be.__version===void 0||j===!0,ae=W.dataReady,ge=b(v,ne);if(v.isDepthTexture)Te=M(v.format===Nr,v.type),ie&&(L?t.texStorage2D(r.TEXTURE_2D,1,Te,ne.width,ne.height):t.texImage2D(r.TEXTURE_2D,0,Te,ne.width,ne.height,0,he,Le,null));else if(v.isDataTexture)if(ze.length>0){L&&ie&&t.texStorage2D(r.TEXTURE_2D,ge,Te,ze[0].width,ze[0].height);for(let Q=0,$=ze.length;Q<$;Q++)ce=ze[Q],L?ae&&t.texSubImage2D(r.TEXTURE_2D,Q,0,0,ce.width,ce.height,he,Le,ce.data):t.texImage2D(r.TEXTURE_2D,Q,Te,ce.width,ce.height,0,he,Le,ce.data);v.generateMipmaps=!1}else L?(ie&&t.texStorage2D(r.TEXTURE_2D,ge,Te,ne.width,ne.height),ae&&Be(v,ne,he,Le)):t.texImage2D(r.TEXTURE_2D,0,Te,ne.width,ne.height,0,he,Le,ne.data);else if(v.isCompressedTexture)if(v.isCompressedArrayTexture){L&&ie&&t.texStorage3D(r.TEXTURE_2D_ARRAY,ge,Te,ze[0].width,ze[0].height,ne.depth);for(let Q=0,$=ze.length;Q<$;Q++)if(ce=ze[Q],v.format!==dn)if(he!==null)if(L){if(ae)if(v.layerUpdates.size>0){const Se=$l(ce.width,ce.height,v.format,v.type);for(const Oe of v.layerUpdates){const it=ce.data.subarray(Oe*Se/ce.data.BYTES_PER_ELEMENT,(Oe+1)*Se/ce.data.BYTES_PER_ELEMENT);t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,Q,0,0,Oe,ce.width,ce.height,1,he,it)}v.clearLayerUpdates()}else t.compressedTexSubImage3D(r.TEXTURE_2D_ARRAY,Q,0,0,0,ce.width,ce.height,ne.depth,he,ce.data)}else t.compressedTexImage3D(r.TEXTURE_2D_ARRAY,Q,Te,ce.width,ce.height,ne.depth,0,ce.data,0,0);else console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()");else L?ae&&t.texSubImage3D(r.TEXTURE_2D_ARRAY,Q,0,0,0,ce.width,ce.height,ne.depth,he,Le,ce.data):t.texImage3D(r.TEXTURE_2D_ARRAY,Q,Te,ce.width,ce.height,ne.depth,0,he,Le,ce.data)}else{L&&ie&&t.texStorage2D(r.TEXTURE_2D,ge,Te,ze[0].width,ze[0].height);for(let Q=0,$=ze.length;Q<$;Q++)ce=ze[Q],v.format!==dn?he!==null?L?ae&&t.compressedTexSubImage2D(r.TEXTURE_2D,Q,0,0,ce.width,ce.height,he,ce.data):t.compressedTexImage2D(r.TEXTURE_2D,Q,Te,ce.width,ce.height,0,ce.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .uploadTexture()"):L?ae&&t.texSubImage2D(r.TEXTURE_2D,Q,0,0,ce.width,ce.height,he,Le,ce.data):t.texImage2D(r.TEXTURE_2D,Q,Te,ce.width,ce.height,0,he,Le,ce.data)}else if(v.isDataArrayTexture)if(L){if(ie&&t.texStorage3D(r.TEXTURE_2D_ARRAY,ge,Te,ne.width,ne.height,ne.depth),ae)if(v.layerUpdates.size>0){const Q=$l(ne.width,ne.height,v.format,v.type);for(const $ of v.layerUpdates){const Se=ne.data.subarray($*Q/ne.data.BYTES_PER_ELEMENT,($+1)*Q/ne.data.BYTES_PER_ELEMENT);t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,$,ne.width,ne.height,1,he,Le,Se)}v.clearLayerUpdates()}else t.texSubImage3D(r.TEXTURE_2D_ARRAY,0,0,0,0,ne.width,ne.height,ne.depth,he,Le,ne.data)}else t.texImage3D(r.TEXTURE_2D_ARRAY,0,Te,ne.width,ne.height,ne.depth,0,he,Le,ne.data);else if(v.isData3DTexture)L?(ie&&t.texStorage3D(r.TEXTURE_3D,ge,Te,ne.width,ne.height,ne.depth),ae&&t.texSubImage3D(r.TEXTURE_3D,0,0,0,0,ne.width,ne.height,ne.depth,he,Le,ne.data)):t.texImage3D(r.TEXTURE_3D,0,Te,ne.width,ne.height,ne.depth,0,he,Le,ne.data);else if(v.isFramebufferTexture){if(ie)if(L)t.texStorage2D(r.TEXTURE_2D,ge,Te,ne.width,ne.height);else{let Q=ne.width,$=ne.height;for(let Se=0;Se<ge;Se++)t.texImage2D(r.TEXTURE_2D,Se,Te,Q,$,0,he,Le,null),Q>>=1,$>>=1}}else if(ze.length>0){if(L&&ie){const Q=dt(ze[0]);t.texStorage2D(r.TEXTURE_2D,ge,Te,Q.width,Q.height)}for(let Q=0,$=ze.length;Q<$;Q++)ce=ze[Q],L?ae&&t.texSubImage2D(r.TEXTURE_2D,Q,0,0,he,Le,ce):t.texImage2D(r.TEXTURE_2D,Q,Te,he,Le,ce);v.generateMipmaps=!1}else if(L){if(ie){const Q=dt(ne);t.texStorage2D(r.TEXTURE_2D,ge,Te,Q.width,Q.height)}ae&&t.texSubImage2D(r.TEXTURE_2D,0,0,0,he,Le,ne)}else t.texImage2D(r.TEXTURE_2D,0,Te,he,Le,ne);m(v)&&d(Y),be.__version=W.version,v.onUpdate&&v.onUpdate(v)}R.__version=v.version}function Z(R,v,F){if(v.image.length!==6)return;const Y=Xe(R,v),j=v.source;t.bindTexture(r.TEXTURE_CUBE_MAP,R.__webglTexture,r.TEXTURE0+F);const W=n.get(j);if(j.version!==W.__version||Y===!0){t.activeTexture(r.TEXTURE0+F);const be=$e.getPrimaries($e.workingColorSpace),se=v.colorSpace===Yn?null:$e.getPrimaries(v.colorSpace),Ee=v.colorSpace===Yn||be===se?r.NONE:r.BROWSER_DEFAULT_WEBGL;r.pixelStorei(r.UNPACK_FLIP_Y_WEBGL,v.flipY),r.pixelStorei(r.UNPACK_PREMULTIPLY_ALPHA_WEBGL,v.premultiplyAlpha),r.pixelStorei(r.UNPACK_ALIGNMENT,v.unpackAlignment),r.pixelStorei(r.UNPACK_COLORSPACE_CONVERSION_WEBGL,Ee);const ye=v.isCompressedTexture||v.image[0].isCompressedTexture,ne=v.image[0]&&v.image[0].isDataTexture,he=[];for(let $=0;$<6;$++)!ye&&!ne?he[$]=_(v.image[$],!0,i.maxCubemapSize):he[$]=ne?v.image[$].image:v.image[$],he[$]=_t(v,he[$]);const Le=he[0],Te=s.convert(v.format,v.colorSpace),ce=s.convert(v.type),ze=T(v.internalFormat,Te,ce,v.colorSpace),L=v.isVideoTexture!==!0,ie=W.__version===void 0||Y===!0,ae=j.dataReady;let ge=b(v,Le);Ie(r.TEXTURE_CUBE_MAP,v);let Q;if(ye){L&&ie&&t.texStorage2D(r.TEXTURE_CUBE_MAP,ge,ze,Le.width,Le.height);for(let $=0;$<6;$++){Q=he[$].mipmaps;for(let Se=0;Se<Q.length;Se++){const Oe=Q[Se];v.format!==dn?Te!==null?L?ae&&t.compressedTexSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,Se,0,0,Oe.width,Oe.height,Te,Oe.data):t.compressedTexImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,Se,ze,Oe.width,Oe.height,0,Oe.data):console.warn("THREE.WebGLRenderer: Attempt to load unsupported compressed texture format in .setTextureCube()"):L?ae&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,Se,0,0,Oe.width,Oe.height,Te,ce,Oe.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,Se,ze,Oe.width,Oe.height,0,Te,ce,Oe.data)}}}else{if(Q=v.mipmaps,L&&ie){Q.length>0&&ge++;const $=dt(he[0]);t.texStorage2D(r.TEXTURE_CUBE_MAP,ge,ze,$.width,$.height)}for(let $=0;$<6;$++)if(ne){L?ae&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,he[$].width,he[$].height,Te,ce,he[$].data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,ze,he[$].width,he[$].height,0,Te,ce,he[$].data);for(let Se=0;Se<Q.length;Se++){const it=Q[Se].image[$].image;L?ae&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,Se+1,0,0,it.width,it.height,Te,ce,it.data):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,Se+1,ze,it.width,it.height,0,Te,ce,it.data)}}else{L?ae&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,0,0,Te,ce,he[$]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,0,ze,Te,ce,he[$]);for(let Se=0;Se<Q.length;Se++){const Oe=Q[Se];L?ae&&t.texSubImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,Se+1,0,0,Te,ce,Oe.image[$]):t.texImage2D(r.TEXTURE_CUBE_MAP_POSITIVE_X+$,Se+1,ze,Te,ce,Oe.image[$])}}}m(v)&&d(r.TEXTURE_CUBE_MAP),W.__version=j.version,v.onUpdate&&v.onUpdate(v)}R.__version=v.version}function pe(R,v,F,Y,j,W){const be=s.convert(F.format,F.colorSpace),se=s.convert(F.type),Ee=T(F.internalFormat,be,se,F.colorSpace),ye=n.get(v),ne=n.get(F);if(ne.__renderTarget=v,!ye.__hasExternalTextures){const he=Math.max(1,v.width>>W),Le=Math.max(1,v.height>>W);j===r.TEXTURE_3D||j===r.TEXTURE_2D_ARRAY?t.texImage3D(j,W,Ee,he,Le,v.depth,0,be,se,null):t.texImage2D(j,W,Ee,he,Le,0,be,se,null)}t.bindFramebuffer(r.FRAMEBUFFER,R),_e(v)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,Y,j,ne.__webglTexture,0,nt(v)):(j===r.TEXTURE_2D||j>=r.TEXTURE_CUBE_MAP_POSITIVE_X&&j<=r.TEXTURE_CUBE_MAP_NEGATIVE_Z)&&r.framebufferTexture2D(r.FRAMEBUFFER,Y,j,ne.__webglTexture,W),t.bindFramebuffer(r.FRAMEBUFFER,null)}function Pe(R,v,F){if(r.bindRenderbuffer(r.RENDERBUFFER,R),v.depthBuffer){const Y=v.depthTexture,j=Y&&Y.isDepthTexture?Y.type:null,W=M(v.stencilBuffer,j),be=v.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,se=nt(v);_e(v)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,se,W,v.width,v.height):F?r.renderbufferStorageMultisample(r.RENDERBUFFER,se,W,v.width,v.height):r.renderbufferStorage(r.RENDERBUFFER,W,v.width,v.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,be,r.RENDERBUFFER,R)}else{const Y=v.textures;for(let j=0;j<Y.length;j++){const W=Y[j],be=s.convert(W.format,W.colorSpace),se=s.convert(W.type),Ee=T(W.internalFormat,be,se,W.colorSpace),ye=nt(v);F&&_e(v)===!1?r.renderbufferStorageMultisample(r.RENDERBUFFER,ye,Ee,v.width,v.height):_e(v)?o.renderbufferStorageMultisampleEXT(r.RENDERBUFFER,ye,Ee,v.width,v.height):r.renderbufferStorage(r.RENDERBUFFER,Ee,v.width,v.height)}}r.bindRenderbuffer(r.RENDERBUFFER,null)}function Me(R,v){if(v&&v.isWebGLCubeRenderTarget)throw new Error("Depth Texture with cube render targets is not supported");if(t.bindFramebuffer(r.FRAMEBUFFER,R),!(v.depthTexture&&v.depthTexture.isDepthTexture))throw new Error("renderTarget.depthTexture must be an instance of THREE.DepthTexture");const Y=n.get(v.depthTexture);Y.__renderTarget=v,(!Y.__webglTexture||v.depthTexture.image.width!==v.width||v.depthTexture.image.height!==v.height)&&(v.depthTexture.image.width=v.width,v.depthTexture.image.height=v.height,v.depthTexture.needsUpdate=!0),H(v.depthTexture,0);const j=Y.__webglTexture,W=nt(v);if(v.depthTexture.format===Ur)_e(v)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,j,0,W):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_ATTACHMENT,r.TEXTURE_2D,j,0);else if(v.depthTexture.format===Nr)_e(v)?o.framebufferTexture2DMultisampleEXT(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,j,0,W):r.framebufferTexture2D(r.FRAMEBUFFER,r.DEPTH_STENCIL_ATTACHMENT,r.TEXTURE_2D,j,0);else throw new Error("Unknown depthTexture format")}function J(R){const v=n.get(R),F=R.isWebGLCubeRenderTarget===!0;if(v.__boundDepthTexture!==R.depthTexture){const Y=R.depthTexture;if(v.__depthDisposeCallback&&v.__depthDisposeCallback(),Y){const j=()=>{delete v.__boundDepthTexture,delete v.__depthDisposeCallback,Y.removeEventListener("dispose",j)};Y.addEventListener("dispose",j),v.__depthDisposeCallback=j}v.__boundDepthTexture=Y}if(R.depthTexture&&!v.__autoAllocateDepthBuffer){if(F)throw new Error("target.depthTexture not supported in Cube render targets");const Y=R.texture.mipmaps;Y&&Y.length>0?Me(v.__webglFramebuffer[0],R):Me(v.__webglFramebuffer,R)}else if(F){v.__webglDepthbuffer=[];for(let Y=0;Y<6;Y++)if(t.bindFramebuffer(r.FRAMEBUFFER,v.__webglFramebuffer[Y]),v.__webglDepthbuffer[Y]===void 0)v.__webglDepthbuffer[Y]=r.createRenderbuffer(),Pe(v.__webglDepthbuffer[Y],R,!1);else{const j=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,W=v.__webglDepthbuffer[Y];r.bindRenderbuffer(r.RENDERBUFFER,W),r.framebufferRenderbuffer(r.FRAMEBUFFER,j,r.RENDERBUFFER,W)}}else{const Y=R.texture.mipmaps;if(Y&&Y.length>0?t.bindFramebuffer(r.FRAMEBUFFER,v.__webglFramebuffer[0]):t.bindFramebuffer(r.FRAMEBUFFER,v.__webglFramebuffer),v.__webglDepthbuffer===void 0)v.__webglDepthbuffer=r.createRenderbuffer(),Pe(v.__webglDepthbuffer,R,!1);else{const j=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,W=v.__webglDepthbuffer;r.bindRenderbuffer(r.RENDERBUFFER,W),r.framebufferRenderbuffer(r.FRAMEBUFFER,j,r.RENDERBUFFER,W)}}t.bindFramebuffer(r.FRAMEBUFFER,null)}function le(R,v,F){const Y=n.get(R);v!==void 0&&pe(Y.__webglFramebuffer,R,R.texture,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,0),F!==void 0&&J(R)}function C(R){const v=R.texture,F=n.get(R),Y=n.get(v);R.addEventListener("dispose",w);const j=R.textures,W=R.isWebGLCubeRenderTarget===!0,be=j.length>1;if(be||(Y.__webglTexture===void 0&&(Y.__webglTexture=r.createTexture()),Y.__version=v.version,a.memory.textures++),W){F.__webglFramebuffer=[];for(let se=0;se<6;se++)if(v.mipmaps&&v.mipmaps.length>0){F.__webglFramebuffer[se]=[];for(let Ee=0;Ee<v.mipmaps.length;Ee++)F.__webglFramebuffer[se][Ee]=r.createFramebuffer()}else F.__webglFramebuffer[se]=r.createFramebuffer()}else{if(v.mipmaps&&v.mipmaps.length>0){F.__webglFramebuffer=[];for(let se=0;se<v.mipmaps.length;se++)F.__webglFramebuffer[se]=r.createFramebuffer()}else F.__webglFramebuffer=r.createFramebuffer();if(be)for(let se=0,Ee=j.length;se<Ee;se++){const ye=n.get(j[se]);ye.__webglTexture===void 0&&(ye.__webglTexture=r.createTexture(),a.memory.textures++)}if(R.samples>0&&_e(R)===!1){F.__webglMultisampledFramebuffer=r.createFramebuffer(),F.__webglColorRenderbuffer=[],t.bindFramebuffer(r.FRAMEBUFFER,F.__webglMultisampledFramebuffer);for(let se=0;se<j.length;se++){const Ee=j[se];F.__webglColorRenderbuffer[se]=r.createRenderbuffer(),r.bindRenderbuffer(r.RENDERBUFFER,F.__webglColorRenderbuffer[se]);const ye=s.convert(Ee.format,Ee.colorSpace),ne=s.convert(Ee.type),he=T(Ee.internalFormat,ye,ne,Ee.colorSpace,R.isXRRenderTarget===!0),Le=nt(R);r.renderbufferStorageMultisample(r.RENDERBUFFER,Le,he,R.width,R.height),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+se,r.RENDERBUFFER,F.__webglColorRenderbuffer[se])}r.bindRenderbuffer(r.RENDERBUFFER,null),R.depthBuffer&&(F.__webglDepthRenderbuffer=r.createRenderbuffer(),Pe(F.__webglDepthRenderbuffer,R,!0)),t.bindFramebuffer(r.FRAMEBUFFER,null)}}if(W){t.bindTexture(r.TEXTURE_CUBE_MAP,Y.__webglTexture),Ie(r.TEXTURE_CUBE_MAP,v);for(let se=0;se<6;se++)if(v.mipmaps&&v.mipmaps.length>0)for(let Ee=0;Ee<v.mipmaps.length;Ee++)pe(F.__webglFramebuffer[se][Ee],R,v,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+se,Ee);else pe(F.__webglFramebuffer[se],R,v,r.COLOR_ATTACHMENT0,r.TEXTURE_CUBE_MAP_POSITIVE_X+se,0);m(v)&&d(r.TEXTURE_CUBE_MAP),t.unbindTexture()}else if(be){for(let se=0,Ee=j.length;se<Ee;se++){const ye=j[se],ne=n.get(ye);let he=r.TEXTURE_2D;(R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(he=R.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(he,ne.__webglTexture),Ie(he,ye),pe(F.__webglFramebuffer,R,ye,r.COLOR_ATTACHMENT0+se,he,0),m(ye)&&d(he)}t.unbindTexture()}else{let se=r.TEXTURE_2D;if((R.isWebGL3DRenderTarget||R.isWebGLArrayRenderTarget)&&(se=R.isWebGL3DRenderTarget?r.TEXTURE_3D:r.TEXTURE_2D_ARRAY),t.bindTexture(se,Y.__webglTexture),Ie(se,v),v.mipmaps&&v.mipmaps.length>0)for(let Ee=0;Ee<v.mipmaps.length;Ee++)pe(F.__webglFramebuffer[Ee],R,v,r.COLOR_ATTACHMENT0,se,Ee);else pe(F.__webglFramebuffer,R,v,r.COLOR_ATTACHMENT0,se,0);m(v)&&d(se),t.unbindTexture()}R.depthBuffer&&J(R)}function Ce(R){const v=R.textures;for(let F=0,Y=v.length;F<Y;F++){const j=v[F];if(m(j)){const W=y(R),be=n.get(j).__webglTexture;t.bindTexture(W,be),d(W),t.unbindTexture()}}}const fe=[],Ae=[];function me(R){if(R.samples>0){if(_e(R)===!1){const v=R.textures,F=R.width,Y=R.height;let j=r.COLOR_BUFFER_BIT;const W=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT,be=n.get(R),se=v.length>1;if(se)for(let ye=0;ye<v.length;ye++)t.bindFramebuffer(r.FRAMEBUFFER,be.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+ye,r.RENDERBUFFER,null),t.bindFramebuffer(r.FRAMEBUFFER,be.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+ye,r.TEXTURE_2D,null,0);t.bindFramebuffer(r.READ_FRAMEBUFFER,be.__webglMultisampledFramebuffer);const Ee=R.texture.mipmaps;Ee&&Ee.length>0?t.bindFramebuffer(r.DRAW_FRAMEBUFFER,be.__webglFramebuffer[0]):t.bindFramebuffer(r.DRAW_FRAMEBUFFER,be.__webglFramebuffer);for(let ye=0;ye<v.length;ye++){if(R.resolveDepthBuffer&&(R.depthBuffer&&(j|=r.DEPTH_BUFFER_BIT),R.stencilBuffer&&R.resolveStencilBuffer&&(j|=r.STENCIL_BUFFER_BIT)),se){r.framebufferRenderbuffer(r.READ_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.RENDERBUFFER,be.__webglColorRenderbuffer[ye]);const ne=n.get(v[ye]).__webglTexture;r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0,r.TEXTURE_2D,ne,0)}r.blitFramebuffer(0,0,F,Y,0,0,F,Y,j,r.NEAREST),c===!0&&(fe.length=0,Ae.length=0,fe.push(r.COLOR_ATTACHMENT0+ye),R.depthBuffer&&R.resolveDepthBuffer===!1&&(fe.push(W),Ae.push(W),r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,Ae)),r.invalidateFramebuffer(r.READ_FRAMEBUFFER,fe))}if(t.bindFramebuffer(r.READ_FRAMEBUFFER,null),t.bindFramebuffer(r.DRAW_FRAMEBUFFER,null),se)for(let ye=0;ye<v.length;ye++){t.bindFramebuffer(r.FRAMEBUFFER,be.__webglMultisampledFramebuffer),r.framebufferRenderbuffer(r.FRAMEBUFFER,r.COLOR_ATTACHMENT0+ye,r.RENDERBUFFER,be.__webglColorRenderbuffer[ye]);const ne=n.get(v[ye]).__webglTexture;t.bindFramebuffer(r.FRAMEBUFFER,be.__webglFramebuffer),r.framebufferTexture2D(r.DRAW_FRAMEBUFFER,r.COLOR_ATTACHMENT0+ye,r.TEXTURE_2D,ne,0)}t.bindFramebuffer(r.DRAW_FRAMEBUFFER,be.__webglMultisampledFramebuffer)}else if(R.depthBuffer&&R.resolveDepthBuffer===!1&&c){const v=R.stencilBuffer?r.DEPTH_STENCIL_ATTACHMENT:r.DEPTH_ATTACHMENT;r.invalidateFramebuffer(r.DRAW_FRAMEBUFFER,[v])}}}function nt(R){return Math.min(i.maxSamples,R.samples)}function _e(R){const v=n.get(R);return R.samples>0&&e.has("WEBGL_multisampled_render_to_texture")===!0&&v.__useRenderToTexture!==!1}function Fe(R){const v=a.render.frame;u.get(R)!==v&&(u.set(R,v),R.update())}function _t(R,v){const F=R.colorSpace,Y=R.format,j=R.type;return R.isCompressedTexture===!0||R.isVideoTexture===!0||F!==lr&&F!==Yn&&($e.getTransfer(F)===Je?(Y!==dn||j!==bn)&&console.warn("THREE.WebGLTextures: sRGB encoded textures have to use RGBAFormat and UnsignedByteType."):console.error("THREE.WebGLTextures: Unsupported texture color space:",F)),v}function dt(R){return typeof HTMLImageElement<"u"&&R instanceof HTMLImageElement?(l.width=R.naturalWidth||R.width,l.height=R.naturalHeight||R.height):typeof VideoFrame<"u"&&R instanceof VideoFrame?(l.width=R.displayWidth,l.height=R.displayHeight):(l.width=R.width,l.height=R.height),l}this.allocateTextureUnit=O,this.resetTextureUnits=N,this.setTexture2D=H,this.setTexture2DArray=G,this.setTexture3D=q,this.setTextureCube=z,this.rebindTextures=le,this.setupRenderTarget=C,this.updateRenderTargetMipmap=Ce,this.updateMultisampleRenderTarget=me,this.setupDepthRenderbuffer=J,this.setupFrameBufferTexture=pe,this.useMultisampledRTT=_e}function Ag(r,e){function t(n,i=Yn){let s;const a=$e.getTransfer(i);if(n===bn)return r.UNSIGNED_BYTE;if(n===Vo)return r.UNSIGNED_SHORT_4_4_4_4;if(n===Ho)return r.UNSIGNED_SHORT_5_5_5_1;if(n===Hc)return r.UNSIGNED_INT_5_9_9_9_REV;if(n===Gc)return r.UNSIGNED_INT_10F_11F_11F_REV;if(n===kc)return r.BYTE;if(n===Vc)return r.SHORT;if(n===Lr)return r.UNSIGNED_SHORT;if(n===ko)return r.INT;if(n===Ci)return r.UNSIGNED_INT;if(n===On)return r.FLOAT;if(n===Xr)return r.HALF_FLOAT;if(n===Wc)return r.ALPHA;if(n===Xc)return r.RGB;if(n===dn)return r.RGBA;if(n===Ur)return r.DEPTH_COMPONENT;if(n===Nr)return r.DEPTH_STENCIL;if(n===qc)return r.RED;if(n===Go)return r.RED_INTEGER;if(n===Yc)return r.RG;if(n===Wo)return r.RG_INTEGER;if(n===Xo)return r.RGBA_INTEGER;if(n===Es||n===ys||n===Ts||n===bs)if(a===Je)if(s=e.get("WEBGL_compressed_texture_s3tc_srgb"),s!==null){if(n===Es)return s.COMPRESSED_SRGB_S3TC_DXT1_EXT;if(n===ys)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT1_EXT;if(n===Ts)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT3_EXT;if(n===bs)return s.COMPRESSED_SRGB_ALPHA_S3TC_DXT5_EXT}else return null;else if(s=e.get("WEBGL_compressed_texture_s3tc"),s!==null){if(n===Es)return s.COMPRESSED_RGB_S3TC_DXT1_EXT;if(n===ys)return s.COMPRESSED_RGBA_S3TC_DXT1_EXT;if(n===Ts)return s.COMPRESSED_RGBA_S3TC_DXT3_EXT;if(n===bs)return s.COMPRESSED_RGBA_S3TC_DXT5_EXT}else return null;if(n===Ya||n===Ka||n===$a||n===Za)if(s=e.get("WEBGL_compressed_texture_pvrtc"),s!==null){if(n===Ya)return s.COMPRESSED_RGB_PVRTC_4BPPV1_IMG;if(n===Ka)return s.COMPRESSED_RGB_PVRTC_2BPPV1_IMG;if(n===$a)return s.COMPRESSED_RGBA_PVRTC_4BPPV1_IMG;if(n===Za)return s.COMPRESSED_RGBA_PVRTC_2BPPV1_IMG}else return null;if(n===ja||n===Ja||n===Qa)if(s=e.get("WEBGL_compressed_texture_etc"),s!==null){if(n===ja||n===Ja)return a===Je?s.COMPRESSED_SRGB8_ETC2:s.COMPRESSED_RGB8_ETC2;if(n===Qa)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ETC2_EAC:s.COMPRESSED_RGBA8_ETC2_EAC}else return null;if(n===eo||n===to||n===no||n===io||n===ro||n===so||n===ao||n===oo||n===lo||n===co||n===uo||n===ho||n===fo||n===po)if(s=e.get("WEBGL_compressed_texture_astc"),s!==null){if(n===eo)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_4x4_KHR:s.COMPRESSED_RGBA_ASTC_4x4_KHR;if(n===to)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x4_KHR:s.COMPRESSED_RGBA_ASTC_5x4_KHR;if(n===no)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_5x5_KHR:s.COMPRESSED_RGBA_ASTC_5x5_KHR;if(n===io)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x5_KHR:s.COMPRESSED_RGBA_ASTC_6x5_KHR;if(n===ro)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_6x6_KHR:s.COMPRESSED_RGBA_ASTC_6x6_KHR;if(n===so)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x5_KHR:s.COMPRESSED_RGBA_ASTC_8x5_KHR;if(n===ao)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x6_KHR:s.COMPRESSED_RGBA_ASTC_8x6_KHR;if(n===oo)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_8x8_KHR:s.COMPRESSED_RGBA_ASTC_8x8_KHR;if(n===lo)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x5_KHR:s.COMPRESSED_RGBA_ASTC_10x5_KHR;if(n===co)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x6_KHR:s.COMPRESSED_RGBA_ASTC_10x6_KHR;if(n===uo)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x8_KHR:s.COMPRESSED_RGBA_ASTC_10x8_KHR;if(n===ho)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_10x10_KHR:s.COMPRESSED_RGBA_ASTC_10x10_KHR;if(n===fo)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x10_KHR:s.COMPRESSED_RGBA_ASTC_12x10_KHR;if(n===po)return a===Je?s.COMPRESSED_SRGB8_ALPHA8_ASTC_12x12_KHR:s.COMPRESSED_RGBA_ASTC_12x12_KHR}else return null;if(n===mo||n===_o||n===go)if(s=e.get("EXT_texture_compression_bptc"),s!==null){if(n===mo)return a===Je?s.COMPRESSED_SRGB_ALPHA_BPTC_UNORM_EXT:s.COMPRESSED_RGBA_BPTC_UNORM_EXT;if(n===_o)return s.COMPRESSED_RGB_BPTC_SIGNED_FLOAT_EXT;if(n===go)return s.COMPRESSED_RGB_BPTC_UNSIGNED_FLOAT_EXT}else return null;if(n===vo||n===xo||n===Mo||n===So)if(s=e.get("EXT_texture_compression_rgtc"),s!==null){if(n===vo)return s.COMPRESSED_RED_RGTC1_EXT;if(n===xo)return s.COMPRESSED_SIGNED_RED_RGTC1_EXT;if(n===Mo)return s.COMPRESSED_RED_GREEN_RGTC2_EXT;if(n===So)return s.COMPRESSED_SIGNED_RED_GREEN_RGTC2_EXT}else return null;return n===Ir?r.UNSIGNED_INT_24_8:r[n]!==void 0?r[n]:null}return{convert:t}}const wg=`
void main() {
...
}`;class Cg{constructor(){this.texture=null,this.mesh=null,this.depthNear=0,this.depthFar=0}init(e,t){if(this.texture===null){const n=new ou(e.texture);(e.depthNear!==t.depthNear||e.depthFar!==t.depthFar)&&(this.depthNear=e.depthNear,this.depthFar=e.depthFar),this.texture=n}}getMesh(e){if(this.texture!==null&&this.mesh===null){const t=e.cameras[0].viewport,n=new ni({vertexShader:wg,fragmentShader:Rg,uniforms:{depthColor:{value:this.texture},depthWidth:{value:t.z},depthHeight:{value:t.w}}});this.mesh=new pn(new ks(20,20),n)}return this.mesh}reset(){this.texture=null,this.mesh=null}getDepthTexture(){return this.texture}}class Pg extends _r{constructor(e,t){super();const n=this;let i=null,s=1,a=null,o="local-floor",c=1,l=null,u=null,h=null,f=null,p=null,g=null;const _=typeof XRWebGLBinding<"u",m=new Cg,d={},y=t.getContextAttributes();let T=null,M=null;const b=[],A=[],w=new Ye;let P=null;const x=new rn;x.viewport=new ht;const E=new rn;E.viewport=new ht;const D=[x,E],N=new jf;let O=null,X=null;this.cameraAutoUpdate=!0,this.enabled=!1,this.isPresenting=!1,this.getController=function(K){let Z=b[K];return Z===void 0&&(Z=new _a,b[K]=Z),Z.getTargetRaySpace()},this.getControllerGrip=function(K){let Z=b[K];return Z===void 0&&(Z=new _a,b[K]=Z),Z.getGripSpace()},this.getHand=function(K){let Z=b[K];return Z===void 0&&(Z=new _a,b[K]=Z),Z.getHandSpace()};function H(K){const Z=A.indexOf(K.inputSource);if(Z===-1)return;const pe=b[Z];pe!==void 0&&(pe.update(K.inputSource,K.frame,l||a),pe.dispatchEvent({type:K.type,data:K.inputSource}))}function G(){i.removeEventListener("select",H),i.removeEventListener("selectstart",H),i.removeEventListener("selectend",H),i.removeEventListener("squeeze",H),i.removeEventListener("squeezestart",H),i.removeEventListener("squeezeend",H),i.removeEventListener("end",G),i.removeEventListener("inputsourceschange",q);for(let K=0;K<b.length;K++){const Z=A[K];Z!==null&&(A[K]=null,b[K].disconnect(Z))}O=null,X=null,m.reset();for(const K in d)delete d[K];e.setRenderTarget(T),p=null,f=null,h=null,i=null,M=null,Be.stop(),n.isPresenting=!1,e.setPixelRatio(P),e.setSize(w.width,w.height,!1),n.dispatchEvent({type:"sessionend"})}this.setFramebufferScaleFactor=function(K){s=K,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change framebuffer scale while presenting.")},this.setReferenceSpaceType=function(K){o=K,n.isPresenting===!0&&console.warn("THREE.WebXRManager: Cannot change reference space type while presenting.")},this.getReferenceSpace=function(){return l||a},this.setReferenceSpace=function(K){l=K},this.getBaseLayer=function(){return f!==null?f:p},this.getBinding=function(){return h===null&&_&&(h=new XRWebGLBinding(i,t)),h},this.getFrame=function(){return g},this.getSession=function(){return i},this.setSession=async function(K){if(i=K,i!==null){if(T=e.getRenderTarget(),i.addEventListener("select",H),i.addEventListener("selectstart",H),i.addEventListener("selectend",H),i.addEventListener("squeeze",H),i.addEventListener("squeezestart",H),i.addEventListener("squeezeend",H),i.addEventListener("end",G),i.addEventListener("inputsourceschange",q),y.xrCompatible!==!0&&await t.makeXRCompatible(),P=e.getPixelRatio(),e.getSize(w),_&&"createProjectionLayer"in XRWebGLBinding.prototype){let pe=null,Pe=null,Me=null;y.depth&&(Me=y.stencil?t.DEPTH24_STENCIL8:t.DEPTH_COMPONENT24,pe=y.stencil?Nr:Ur,Pe=y.stencil?Ir:Ci);const J={colorFormat:t.RGBA8,depthFormat:Me,scaleFactor:s};h=this.getBinding(),f=h.createProjectionLayer(J),i.updateRenderState({layers:[f]}),e.setPixelRatio(1),e.setSize(f.textureWidth,f.textureHeight,!1),M=new Pi(f.textureWidth,f.textureHeight,{format:dn,type:bn,depthTexture:new au(f.textureWidth,f.textureHeight,Pe,void 0,void 0,void 0,void 0,void 0,void 0,pe),stencilBuffer:y.stencil,colorSpace:e.outputColorSpace,samples:y.antialias?4:0,resolveDepthBuffer:f.ignoreDepthValues===!1,resolveStencilBuffer:f.ignoreDepthValues===!1})}else{const pe={antialias:y.antialias,alpha:!0,depth:y.depth,stencil:y.stencil,framebufferScaleFactor:s};p=new XRWebGLLayer(i,t,pe),i.updateRenderState({baseLayer:p}),e.setPixelRatio(1),e.setSize(p.framebufferWidth,p.framebufferHeight,!1),M=new Pi(p.framebufferWidth,p.framebufferHeight,{format:dn,type:bn,colorSpace:e.outputColorSpace,stencilBuffer:y.stencil,resolveDepthBuffer:p.ignoreDepthValues===!1,resolveStencilBuffer:p.ignoreDepthValues===!1})}M.isXRRenderTarget=!0,this.setFoveation(c),l=null,a=await i.requestReferenceSpace(o),Be.setContext(i),Be.start(),n.isPresenting=!0,n.dispatchEvent({type:"sessionstart"})}},this.getEnvironmentBlendMode=function(){if(i!==null)return i.environmentBlendMode},this.getDepthTexture=function(){return m.getDepthTexture()};function q(K){for(let Z=0;Z<K.removed.length;Z++){const pe=K.removed[Z],Pe=A.indexOf(pe);Pe>=0&&(A[Pe]=null,b[Pe].disconnect(pe))}for(let Z=0;Z<K.added.length;Z++){const pe=K.added[Z];let Pe=A.indexOf(pe);if(Pe===-1){for(let J=0;J<b.length;J++)if(J>=A.length){A.push(pe),Pe=J;break}else if(A[J]===null){A[J]=pe,Pe=J;break}if(Pe===-1)break}const Me=b[Pe];Me&&Me.connect(pe)}}const z=new B,te=new B;function re(K,Z,pe){z.setFromMatrixPosition(Z.matrixWorld),te.setFromMatrixPosition(pe.matrixWorld);const Pe=z.distanceTo(te),Me=Z.projectionMatrix.elements,J=pe.projectionMatrix.elements,le=Me[14]/(Me[10]-1),C=Me[14]/(Me[10]+1),Ce=(Me[9]+1)/Me[5],fe=(Me[9]-1)/Me[5],Ae=(Me[8]-1)/Me[0],me=(J[8]+1)/J[0],nt=le*Ae,_e=le*me,Fe=Pe/(-Ae+me),_t=Fe*-Ae;if(Z.matrixWorld.decompose(K.position,K.quaternion,K.scale),K.translateX(_t),K.translateZ(Fe),K.matrixWorld.compose(K.position,K.quaternion,K.scale),K.matrixWorldInverse.copy(K.matrixWorld).invert(),Me[10]===-1)K.projectionMatrix.copy(Z.projectionMatrix),K.projectionMatrixInverse.copy(Z.projectionMatrixInverse);else{const dt=le+Fe,R=C+Fe,v=nt-_t,F=_e+(Pe-_t),Y=Ce*C/R*dt,j=fe*C/R*dt;K.projectionMatrix.makePerspective(v,F,Y,j,dt,R),K.projectionMatrixInverse.copy(K.projectionMatrix).invert()}}function ve(K,Z){Z===null?K.matrixWorld.copy(K.matrix):K.matrixWorld.multiplyMatrices(Z.matrixWorld,K.matrix),K.matrixWorldInverse.copy(K.matrixWorld).invert()}this.updateCamera=function(K){if(i===null)return;let Z=K.near,pe=K.far;m.texture!==null&&(m.depthNear>0&&(Z=m.depthNear),m.depthFar>0&&(pe=m.depthFar)),N.near=E.near=x.near=Z,N.far=E.far=x.far=pe,(O!==N.near||X!==N.far)&&(i.updateRenderState({depthNear:N.near,depthFar:N.far}),O=N.near,X=N.far),N.layers.mask=K.layers.mask|6,x.layers.mask=N.layers.mask&3,E.layers.mask=N.layers.mask&5;const Pe=K.parent,Me=N.cameras;ve(N,Pe);for(let J=0;J<Me.length;J++)ve(Me[J],Pe);Me.length===2?re(N,x,E):N.projectionMatrix.copy(x.projectionMatrix),Ie(K,N,Pe)};function Ie(K,Z,pe){pe===null?K.matrix.copy(Z.matrixWorld):(K.matrix.copy(pe.matrixWorld),K.matrix.invert(),K.matrix.multiply(Z.matrixWorld)),K.matrix.decompose(K.position,K.quaternion,K.scale),K.updateMatrixWorld(!0),K.projectionMatrix.copy(Z.projectionMatrix),K.projectionMatrixInverse.copy(Z.projectionMatrixInverse),K.isPerspectiveCamera&&(K.fov=Eo*2*Math.atan(1/K.projectionMatrix.elements[5]),K.zoom=1)}this.getCamera=function(){return N},this.getFoveation=function(){if(!(f===null&&p===null))return c},this.setFoveation=function(K){c=K,f!==null&&(f.fixedFoveation=K),p!==null&&p.fixedFoveation!==void 0&&(p.fixedFoveation=K)},this.hasDepthSensing=function(){return m.texture!==null},this.getDepthSensingMesh=function(){return m.getMesh(N)},this.getCameraTexture=function(K){return d[K]};let Xe=null;function Ne(K,Z){if(u=Z.getViewerPose(l||a),g=Z,u!==null){const pe=u.views;p!==null&&(e.setRenderTargetFramebuffer(M,p.framebuffer),e.setRenderTarget(M));let Pe=!1;pe.length!==N.cameras.length&&(N.cameras.length=0,Pe=!0);for(let C=0;C<pe.length;C++){const Ce=pe[C];let fe=null;if(p!==null)fe=p.getViewport(Ce);else{const me=h.getViewSubImage(f,Ce);fe=me.viewport,C===0&&(e.setRenderTargetTextures(M,me.colorTexture,me.depthStencilTexture),e.setRenderTarget(M))}let Ae=D[C];Ae===void 0&&(Ae=new rn,Ae.layers.enable(C),Ae.viewport=new ht,D[C]=Ae),Ae.matrix.fromArray(Ce.transform.matrix),Ae.matrix.decompose(Ae.position,Ae.quaternion,Ae.scale),Ae.projectionMatrix.fromArray(Ce.projectionMatrix),Ae.projectionMatrixInverse.copy(Ae.projectionMatrix).invert(),Ae.viewport.set(fe.x,fe.y,fe.width,fe.height),C===0&&(N.matrix.copy(Ae.matrix),N.matrix.decompose(N.position,N.quaternion,N.scale)),Pe===!0&&N.cameras.push(Ae)}const Me=i.enabledFeatures;if(Me&&Me.includes("depth-sensing")&&i.depthUsage=="gpu-optimized"&&_){h=n.getBinding();const C=h.getDepthInformation(pe[0]);C&&C.isValid&&C.texture&&m.init(C,i.renderState)}if(Me&&Me.includes("camera-access")&&_){e.state.unbindTexture(),h=n.getBinding();for(let C=0;C<pe.length;C++){const Ce=pe[C].camera;if(Ce){let fe=d[Ce];fe||(fe=new ou,d[Ce]=fe);const Ae=h.getCameraImage(Ce);fe.sourceTexture=Ae}}}}for(let pe=0;pe<b.length;pe++){const Pe=A[pe],Me=b[pe];Pe!==null&&Me!==void 0&&Me.update(Pe,Z,l||a)}Xe&&Xe(K,Z),Z.detectedPlanes&&n.dispatchEvent({type:"planesdetected",data:Z}),g=null}const Be=new uu;Be.setAnimationLoop(Ne),this.setAnimationLoop=function(K){Xe=K},this.dispose=function(){}}}const pi=new An,Dg=new mt;function Lg(r,e){function t(m,d){m.matrixAutoUpdate===!0&&m.updateMatrix(),d.value.copy(m.matrix)}function n(m,d){d.color.getRGB(m.fogColor.value,iu(r)),d.isFog?(m.fogNear.value=d.near,m.fogFar.value=d.far):d.isFogExp2&&(m.fogDensity.value=d.density)}function i(m,d,y,T,M){d.isMeshBasicMaterial||d.isMeshLambertMaterial?s(m,d):d.isMeshToonMaterial?(s(m,d),h(m,d)):d.isMeshPhongMaterial?(s(m,d),u(m,d)):d.isMeshStandardMaterial?(s(m,d),f(m,d),d.isMeshPhysicalMaterial&&p(m,d,M)):d.isMeshMatcapMaterial?(s(m,d),g(m,d)):d.isMeshDepthMaterial?s(m,d):d.isMeshDistanceMaterial?(s(m,d),_(m,d)):d.isMeshNormalMaterial?s(m,d):d.isLineBasicMaterial?(a(m,d),d.isLineDashedMaterial&&o(m,d)):d.isPointsMaterial?c(m,d,y,T):d.isSpriteMaterial?l(m,d):d.isShadowMaterial?(m.color.value.copy(d.color),m.opacity.value=d.opacity):d.isShaderMaterial&&(d.uniformsNeedUpdate=!1)}function s(m,d){m.opacity.value=d.opacity,d.color&&m.diffuse.value.copy(d.color),d.emissive&&m.emissive.value.copy(d.emissive).multiplyScalar(d.emissiveIntensity),d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.bumpMap&&(m.bumpMap.value=d.bumpMap,t(d.bumpMap,m.bumpMapTransform),m.bumpScale.value=d.bumpScale,d.side===Ft&&(m.bumpScale.value*=-1)),d.normalMap&&(m.normalMap.value=d.normalMap,t(d.normalMap,m.normalMapTransform),m.normalScale.value.copy(d.normalScale),d.side===Ft&&m.normalScale.value.negate()),d.displacementMap&&(m.displacementMap.value=d.displacementMap,t(d.displacementMap,m.displacementMapTransform),m.displacementScale.value=d.displacementScale,m.displacementBias.value=d.displacementBias),d.emissiveMap&&(m.emissiveMap.value=d.emissiveMap,t(d.emissiveMap,m.emissiveMapTransform)),d.specularMap&&(m.specularMap.value=d.specularMap,t(d.specularMap,m.specularMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest);const y=e.get(d),T=y.envMap,M=y.envMapRotation;T&&(m.envMap.value=T,pi.copy(M),pi.x*=-1,pi.y*=-1,pi.z*=-1,T.isCubeTexture&&T.isRenderTargetTexture===!1&&(pi.y*=-1,pi.z*=-1),m.envMapRotation.value.setFromMatrix4(Dg.makeRotationFromEuler(pi)),m.flipEnvMap.value=T.isCubeTexture&&T.isRenderTargetTexture===!1?-1:1,m.reflectivity.value=d.reflectivity,m.ior.value=d.ior,m.refractionRatio.value=d.refractionRatio),d.lightMap&&(m.lightMap.value=d.lightMap,m.lightMapIntensity.value=d.lightMapIntensity,t(d.lightMap,m.lightMapTransform)),d.aoMap&&(m.aoMap.value=d.aoMap,m.aoMapIntensity.value=d.aoMapIntensity,t(d.aoMap,m.aoMapTransform))}function a(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform))}function o(m,d){m.dashSize.value=d.dashSize,m.totalSize.value=d.dashSize+d.gapSize,m.scale.value=d.scale}function c(m,d,y,T){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.size.value=d.size*y,m.scale.value=T*.5,d.map&&(m.map.value=d.map,t(d.map,m.uvTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function l(m,d){m.diffuse.value.copy(d.color),m.opacity.value=d.opacity,m.rotation.value=d.rotation,d.map&&(m.map.value=d.map,t(d.map,m.mapTransform)),d.alphaMap&&(m.alphaMap.value=d.alphaMap,t(d.alphaMap,m.alphaMapTransform)),d.alphaTest>0&&(m.alphaTest.value=d.alphaTest)}function u(m,d){m.specular.value.copy(d.specular),m.shininess.value=Math.max(d.shininess,1e-4)}function h(m,d){d.gradientMap&&(m.gradientMap.value=d.gradientMap)}function f(m,d){m.metalness.value=d.metalness,d.metalnessMap&&(m.metalnessMap.value=d.metalnessMap,t(d.metalnessMap,m.metalnessMapTransform)),m.roughness.value=d.roughness,d.roughnessMap&&(m.roughnessMap.value=d.roughnessMap,t(d.roughnessMap,m.roughnessMapTransform)),d.envMap&&(m.envMapIntensity.value=d.envMapIntensity)}function p(m,d,y){m.ior.value=d.ior,d.sheen>0&&(m.sheenColor.value.copy(d.sheenColor).multiplyScalar(d.sheen),m.sheenRoughness.value=d.sheenRoughness,d.sheenColorMap&&(m.sheenColorMap.value=d.sheenColorMap,t(d.sheenColorMap,m.sheenColorMapTransform)),d.sheenRoughnessMap&&(m.sheenRoughnessMap.value=d.sheenRoughnessMap,t(d.sheenRoughnessMap,m.sheenRoughnessMapTransform))),d.clearcoat>0&&(m.clearcoat.value=d.clearcoat,m.clearcoatRoughness.value=d.clearcoatRoughness,d.clearcoatMap&&(m.clearcoatMap.value=d.clearcoatMap,t(d.clearcoatMap,m.clearcoatMapTransform)),d.clearcoatRoughnessMap&&(m.clearcoatRoughnessMap.value=d.clearcoatRoughnessMap,t(d.clearcoatRoughnessMap,m.clearcoatRoughnessMapTransform)),d.clearcoatNormalMap&&(m.clearcoatNormalMap.value=d.clearcoatNormalMap,t(d.clearcoatNormalMap,m.clearcoatNormalMapTransform),m.clearcoatNormalScale.value.copy(d.clearcoatNormalScale),d.side===Ft&&m.clearcoatNormalScale.value.negate())),d.dispersion>0&&(m.dispersion.value=d.dispersion),d.iridescence>0&&(m.iridescence.value=d.iridescence,m.iridescenceIOR.value=d.iridescenceIOR,m.iridescenceThicknessMinimum.value=d.iridescenceThicknessRange[0],m.iridescenceThicknessMaximum.value=d.iridescenceThicknessRange[1],d.iridescenceMap&&(m.iridescenceMap.value=d.iridescenceMap,t(d.iridescenceMap,m.iridescenceMapTransform)),d.iridescenceThicknessMap&&(m.iridescenceThicknessMap.value=d.iridescenceThicknessMap,t(d.iridescenceThicknessMap,m.iridescenceThicknessMapTransform))),d.transmission>0&&(m.transmission.value=d.transmission,m.transmissionSamplerMap.value=y.texture,m.transmissionSamplerSize.value.set(y.width,y.height),d.transmissionMap&&(m.transmissionMap.value=d.transmissionMap,t(d.transmissionMap,m.transmissionMapTransform)),m.thickness.value=d.thickness,d.thicknessMap&&(m.thicknessMap.value=d.thicknessMap,t(d.thicknessMap,m.thicknessMapTransform)),m.attenuationDistance.value=d.attenuationDistance,m.attenuationColor.value.copy(d.attenuationColor)),d.anisotropy>0&&(m.anisotropyVector.value.set(d.anisotropy*Math.cos(d.anisotropyRotation),d.anisotropy*Math.sin(d.anisotropyRotation)),d.anisotropyMap&&(m.anisotropyMap.value=d.anisotropyMap,t(d.anisotropyMap,m.anisotropyMapTransform))),m.specularIntensity.value=d.specularIntensity,m.specularColor.value.copy(d.specularColor),d.specularColorMap&&(m.specularColorMap.value=d.specularColorMap,t(d.specularColorMap,m.specularColorMapTransform)),d.specularIntensityMap&&(m.specularIntensityMap.value=d.specularIntensityMap,t(d.specularIntensityMap,m.specularIntensityMapTransform))}function g(m,d){d.matcap&&(m.matcap.value=d.matcap)}function _(m,d){const y=e.get(d).light;m.referencePosition.value.setFromMatrixPosition(y.matrixWorld),m.nearDistance.value=y.shadow.camera.near,m.farDistance.value=y.shadow.camera.far}return{refreshFogUniforms:n,refreshMaterialUniforms:i}}function Ig(r,e,t,n){let i={},s={},a=[];const o=r.getParameter(r.MAX_UNIFORM_BUFFER_BINDINGS);function c(y,T){const M=T.program;n.uniformBlockBinding(y,M)}function l(y,T){let M=i[y.id];M===void 0&&(g(y),M=u(y),i[y.id]=M,y.addEventListener("dispose",m));const b=T.program;n.updateUBOMapping(y,b);const A=e.render.frame;s[y.id]!==A&&(f(y),s[y.id]=A)}function u(y){const T=h();y.__bindingPointIndex=T;const M=r.createBuffer(),b=y.__size,A=y.usage;return r.bindBuffer(r.UNIFORM_BUFFER,M),r.bufferData(r.UNIFORM_BUFFER,b,A),r.bindBuffer(r.UNIFORM_BUFFER,null),r.bindBufferBase(r.UNIFORM_BUFFER,T,M),M}function h(){for(let y=0;y<o;y++)if(a.indexOf(y)===-1)return a.push(y),y;return console.error("THREE.WebGLRenderer: Maximum number of simultaneously usable uniforms groups reached."),0}function f(y){const T=i[y.id],M=y.uniforms,b=y.__cache;r.bindBuffer(r.UNIFORM_BUFFER,T);for(let A=0,w=M.length;A<w;A++){const P=Array.isArray(M[A])?M[A]:[M[A]];for(let x=0,E=P.length;x<E;x++){const D=P[x];if(p(D,A,x,b)===!0){const N=D.__offset,O=Array.isArray(D.value)?D.value:[D.value];let X=0;for(let H=0;H<O.length;H++){const G=O[H],q=_(G);typeof G=="number"||typeof G=="boolean"?(D.__data[0]=G,r.bufferSubData(r.UNIFORM_BUFFER,N+X,D.__data)):G.isMatrix3?(D.__data[0]=G.elements[0],D.__data[1]=G.elements[1],D.__data[2]=G.elements[2],D.__data[3]=0,D.__data[4]=G.elements[3],D.__data[5]=G.elements[4],D.__data[6]=G.elements[5],D.__data[7]=0,D.__data[8]=G.elements[6],D.__data[9]=G.elements[7],D.__data[10]=G.elements[8],D.__data[11]=0):(G.toArray(D.__data,X),X+=q.storage/Float32Array.BYTES_PER_ELEMENT)}r.bufferSubData(r.UNIFORM_BUFFER,N,D.__data)}}}r.bindBuffer(r.UNIFORM_BUFFER,null)}function p(y,T,M,b){const A=y.value,w=T+"_"+M;if(b[w]===void 0)return typeof A=="number"||typeof A=="boolean"?b[w]=A:b[w]=A.clone(),!0;{const P=b[w];if(typeof A=="number"||typeof A=="boolean"){if(P!==A)return b[w]=A,!0}else if(P.equals(A)===!1)return P.copy(A),!0}return!1}function g(y){const T=y.uniforms;let M=0;const b=16;for(let w=0,P=T.length;w<P;w++){const x=Array.isArray(T[w])?T[w]:[T[w]];for(let E=0,D=x.length;E<D;E++){const N=x[E],O=Array.isArray(N.value)?N.value:[N.value];for(let X=0,H=O.length;X<H;X++){const G=O[X],q=_(G),z=M%b,te=z%q.boundary,re=z+te;M+=te,re!==0&&b-re<q.storage&&(M+=b-re),N.__data=new Float32Array(q.storage/Float32Array.BYTES_PER_ELEMENT),N.__offset=M,M+=q.storage}}}const A=M%b;return A>0&&(M+=b-A),y.__size=M,y.__cache={},this}function _(y){const T={boundary:0,storage:0};return typeof y=="number"||typeof y=="boolean"?(T.boundary=4,T.storage=4):y.isVector2?(T.boundary=8,T.storage=8):y.isVector3||y.isColor?(T.boundary=16,T.storage=12):y.isVector4?(T.boundary=16,T.storage=16):y.isMatrix3?(T.boundary=48,T.storage=48):y.isMatrix4?(T.boundary=64,T.storage=64):y.isTexture?console.warn("THREE.WebGLRenderer: Texture samplers can not be part of an uniforms group."):console.warn("THREE.WebGLRenderer: Unsupported uniform value type.",y),T}function m(y){const T=y.target;T.removeEventListener("dispose",m);const M=a.indexOf(T.__bindingPointIndex);a.splice(M,1),r.deleteBuffer(i[T.id]),delete i[T.id],delete s[T.id]}function d(){for(const y in i)r.deleteBuffer(i[y]);a=[],i={},s={}}return{bind:c,update:l,dispose:d}}class Ug{constructor(e={}){const{canvas:t=cf(),context:n=null,depth:i=!0,stencil:s=!1,alpha:a=!1,antialias:o=!1,premultipliedAlpha:c=!0,preserveDrawingBuffer:l=!1,powerPreference:u="default",failIfMajorPerformanceCaveat:h=!1,reversedDepthBuffer:f=!1}=e;this.isWebGLRenderer=!0;let p;if(n!==null){if(typeof WebGLRenderingContext<"u"&&n instanceof WebGLRenderingContext)throw new Error("THREE.WebGLRenderer: WebGL 1 is not supported since r163.");p=n.getContextAttributes().alpha}else p=a;const g=new Uint32Array(4),_=new Int32Array(4);let m=null,d=null;const y=[],T=[];this.domElement=t,this.debug={checkShaderErrors:!0,onShaderError:null},this.autoClear=!0,this.autoClearColor=!0,this.autoClearDepth=!0,this.autoClearStencil=!0,this.sortObjects=!0,this.clippingPlanes=[],this.localClippingEnabled=!1,this.toneMapping=Jn,this.toneMappingExposure=1,this.transmissionResolutionScale=1;const M=this;let b=!1;this._outputColorSpace=nn;let A=0,w=0,P=null,x=-1,E=null;const D=new ht,N=new ht;let O=null;const X=new qe(0);let H=0,G=t.width,q=t.height,z=1,te=null,re=null;const ve=new ht(0,0,G,q),Ie=new ht(0,0,G,q);let Xe=!1;const Ne=new Ko;let Be=!1,K=!1;const Z=new mt,pe=new B,Pe=new ht,Me={background:null,fog:null,environment:null,overrideMaterial:null,isScene:!0};let J=!1;function le(){return P===null?z:1}let C=n;function Ce(S,I){return t.getContext(S,I)}try{const S={alpha:!0,depth:i,stencil:s,antialias:o,premultipliedAlpha:c,preserveDrawingBuffer:l,powerPreference:u,failIfMajorPerformanceCaveat:h};if("setAttribute"in t&&t.setAttribute("data-engine",`three.js r${zo}`),t.addEventListener("webglcontextlost",ae,!1),t.addEventListener("webglcontextrestored",ge,!1),t.addEventListener("webglcontextcreationerror",Q,!1),C===null){const I="webgl2";if(C=Ce(I,S),C===null)throw Ce(I)?new Error("Error creating WebGL context with your selected attributes."):new Error("Error creating WebGL context.")}}catch(S){throw console.error("THREE.WebGLRenderer: "+S.message),S}let fe,Ae,me,nt,_e,Fe,_t,dt,R,v,F,Y,j,W,be,se,Ee,ye,ne,he,Le,Te,ce,ze;function L(){fe=new Wm(C),fe.init(),Te=new Ag(C,fe),Ae=new Om(C,fe,e,Te),me=new Tg(C,fe),Ae.reversedDepthBuffer&&f&&me.buffers.depth.setReversed(!0),nt=new Ym(C),_e=new hg,Fe=new bg(C,fe,me,_e,Ae,Te,nt),_t=new zm(M),dt=new Gm(M),R=new Qf(C),ce=new Nm(C,R),v=new Xm(C,R,nt,ce),F=new $m(C,v,R,nt),ne=new Km(C,Ae,Fe),se=new Bm(_e),Y=new ug(M,_t,dt,fe,Ae,ce,se),j=new Lg(M,_e),W=new dg,be=new xg(fe),ye=new Um(M,_t,dt,me,F,p,c),Ee=new Eg(M,F,Ae),ze=new Ig(C,nt,Ae,me),he=new Fm(C,fe,nt),Le=new qm(C,fe,nt),nt.programs=Y.programs,M.capabilities=Ae,M.extensions=fe,M.properties=_e,M.renderLists=W,M.shadowMap=Ee,M.state=me,M.info=nt}L();const ie=new Pg(M,C);this.xr=ie,this.getContext=function(){return C},this.getContextAttributes=function(){return C.getContextAttributes()},this.forceContextLoss=function(){const S=fe.get("WEBGL_lose_context");S&&S.loseContext()},this.forceContextRestore=function(){const S=fe.get("WEBGL_lose_context");S&&S.restoreContext()},this.getPixelRatio=function(){return z},this.setPixelRatio=function(S){S!==void 0&&(z=S,this.setSize(G,q,!1))},this.getSize=function(S){return S.set(G,q)},this.setSize=function(S,I,k=!0){if(ie.isPresenting){console.warn("THREE.WebGLRenderer: Can't change size while VR device is presenting.");return}G=S,q=I,t.width=Math.floor(S*z),t.height=Math.floor(I*z),k===!0&&(t.style.width=S+"px",t.style.height=I+"px"),this.setViewport(0,0,S,I)},this.getDrawingBufferSize=function(S){return S.set(G*z,q*z).floor()},this.setDrawingBufferSize=function(S,I,k){G=S,q=I,z=k,t.width=Math.floor(S*k),t.height=Math.floor(I*k),this.setViewport(0,0,S,I)},this.getCurrentViewport=function(S){return S.copy(D)},this.getViewport=function(S){return S.copy(ve)},this.setViewport=function(S,I,k,V){S.isVector4?ve.set(S.x,S.y,S.z,S.w):ve.set(S,I,k,V),me.viewport(D.copy(ve).multiplyScalar(z).round())},this.getScissor=function(S){return S.copy(Ie)},this.setScissor=function(S,I,k,V){S.isVector4?Ie.set(S.x,S.y,S.z,S.w):Ie.set(S,I,k,V),me.scissor(N.copy(Ie).multiplyScalar(z).round())},this.getScissorTest=function(){return Xe},this.setScissorTest=function(S){me.setScissorTest(Xe=S)},this.setOpaqueSort=function(S){te=S},this.setTransparentSort=function(S){re=S},this.getClearColor=function(S){return S.copy(ye.getClearColor())},this.setClearColor=function(){ye.setClearColor(...arguments)},this.getClearAlpha=function(){return ye.getClearAlpha()},this.setClearAlpha=function(){ye.setClearAlpha(...arguments)},this.clear=function(S=!0,I=!0,k=!0){let V=0;if(S){let U=!1;if(P!==null){const ee=P.texture.format;U=ee===Xo||ee===Wo||ee===Go}if(U){const ee=P.texture.type,ue=ee===bn||ee===Ci||ee===Lr||ee===Ir||ee===Vo||ee===Ho,xe=ye.getClearColor(),de=ye.getClearAlpha(),De=xe.r,Ue=xe.g,we=xe.b;ue?(g[0]=De,g[1]=Ue,g[2]=we,g[3]=de,C.clearBufferuiv(C.COLOR,0,g)):(_[0]=De,_[1]=Ue,_[2]=we,_[3]=de,C.clearBufferiv(C.COLOR,0,_))}else V|=C.COLOR_BUFFER_BIT}I&&(V|=C.DEPTH_BUFFER_BIT),k&&(V|=C.STENCIL_BUFFER_BIT,this.state.buffers.stencil.setMask(4294967295)),C.clear(V)},this.clearColor=function(){this.clear(!0,!1,!1)},this.clearDepth=function(){this.clear(!1,!0,!1)},this.clearStencil=function(){this.clear(!1,!1,!0)},this.dispose=function(){t.removeEventListener("webglcontextlost",ae,!1),t.removeEventListener("webglcontextrestored",ge,!1),t.removeEventListener("webglcontextcreationerror",Q,!1),ye.dispose(),W.dispose(),be.dispose(),_e.dispose(),_t.dispose(),dt.dispose(),F.dispose(),ce.dispose(),ze.dispose(),Y.dispose(),ie.dispose(),ie.removeEventListener("sessionstart",_n),ie.removeEventListener("sessionend",_l),oi.stop()};function ae(S){S.preventDefault(),console.log("THREE.WebGLRenderer: Context Lost."),b=!0}function ge(){console.log("THREE.WebGLRenderer: Context Restored."),b=!1;const S=nt.autoReset,I=Ee.enabled,k=Ee.autoUpdate,V=Ee.needsUpdate,U=Ee.type;L(),nt.autoReset=S,Ee.enabled=I,Ee.autoUpdate=k,Ee.needsUpdate=V,Ee.type=U}function Q(S){console.error("THREE.WebGLRenderer: A WebGL context could not be created. Reason: ",S.statusMessage)}function $(S){const I=S.target;I.removeEventListener("dispose",$),Se(I)}function Se(S){Oe(S),_e.remove(S)}function Oe(S){const I=_e.get(S).programs;I!==void 0&&(I.forEach(function(k){Y.releaseProgram(k)}),S.isShaderMaterial&&Y.releaseShaderCache(S))}this.renderBufferDirect=function(S,I,k,V,U,ee){I===null&&(I=Me);const ue=U.isMesh&&U.matrixWorld.determinant()<0,xe=ph(S,I,k,V,U);me.setMaterial(V,ue);let de=k.index,De=1;if(V.wireframe===!0){if(de=v.getWireframeAttribute(k),de===void 0)return;De=2}const Ue=k.drawRange,we=k.attributes.position;let He=Ue.start*De,je=(Ue.start+Ue.count)*De;ee!==null&&(He=Math.max(He,ee.start*De),je=Math.min(je,(ee.start+ee.count)*De)),de!==null?(He=Math.max(He,0),je=Math.min(je,de.count)):we!=null&&(He=Math.max(He,0),je=Math.min(je,we.count));const ut=je-He;if(ut<0||ut===1/0)return;ce.setup(U,V,xe,k,de);let rt,Qe=he;if(de!==null&&(rt=R.get(de),Qe=Le,Qe.setIndex(rt)),U.isMesh)V.wireframe===!0?(me.setLineWidth(V.wireframeLinewidth*le()),Qe.setMode(C.LINES)):Qe.setMode(C.TRIANGLES);else if(U.isLine){let Re=V.linewidth;Re===void 0&&(Re=1),me.setLineWidth(Re*le()),U.isLineSegments?Qe.setMode(C.LINES):U.isLineLoop?Qe.setMode(C.LINE_LOOP):Qe.setMode(C.LINE_STRIP)}else U.isPoints?Qe.setMode(C.POINTS):U.isSprite&&Qe.setMode(C.TRIANGLES);if(U.isBatchedMesh)if(U._multiDrawInstances!==null)Or("THREE.WebGLRenderer: renderMultiDrawInstances has been deprecated and will be removed in r184. Append to renderMultiDraw arguments and use indirection."),Qe.renderMultiDrawInstances(U._multiDrawStarts,U._multiDrawCounts,U._multiDrawCount,U._multiDrawInstances);else if(fe.get("WEBGL_multi_draw"))Qe.renderMultiDraw(U._multiDrawStarts,U._multiDrawCounts,U._multiDrawCount);else{const Re=U._multiDrawStarts,at=U._multiDrawCounts,Ke=U._multiDrawCount,Ht=de?R.get(de).bytesPerElement:1,Ii=_e.get(V).currentProgram.getUniforms();for(let Gt=0;Gt<Ke;Gt++)Ii.setValue(C,"_gl_DrawID",Gt),Qe.render(Re[Gt]/Ht,at[Gt])}else if(U.isInstancedMesh)Qe.renderInstances(He,ut,U.count);else if(k.isInstancedBufferGeometry){const Re=k._maxInstanceCount!==void 0?k._maxInstanceCount:1/0,at=Math.min(k.instanceCount,Re);Qe.renderInstances(He,ut,at)}else Qe.render(He,ut)};function it(S,I,k){S.transparent===!0&&S.side===hn&&S.forceSinglePass===!1?(S.side=Ft,S.needsUpdate=!0,Qr(S,I,k),S.side=ti,S.needsUpdate=!0,Qr(S,I,k),S.side=hn):Qr(S,I,k)}this.compile=function(S,I,k=null){k===null&&(k=S),d=be.get(k),d.init(I),T.push(d),k.traverseVisible(function(U){U.isLight&&U.layers.test(I.layers)&&(d.pushLight(U),U.castShadow&&d.pushShadow(U))}),S!==k&&S.traverseVisible(function(U){U.isLight&&U.layers.test(I.layers)&&(d.pushLight(U),U.castShadow&&d.pushShadow(U))}),d.setupLights();const V=new Set;return S.traverse(function(U){if(!(U.isMesh||U.isPoints||U.isLine||U.isSprite))return;const ee=U.material;if(ee)if(Array.isArray(ee))for(let ue=0;ue<ee.length;ue++){const xe=ee[ue];it(xe,k,U),V.add(xe)}else it(ee,k,U),V.add(ee)}),d=T.pop(),V},this.compileAsync=function(S,I,k=null){const V=this.compile(S,I,k);return new Promise(U=>{function ee(){if(V.forEach(function(ue){_e.get(ue).currentProgram.isReady()&&V.delete(ue)}),V.size===0){U(S);return}setTimeout(ee,10)}fe.get("KHR_parallel_shader_compile")!==null?ee():setTimeout(ee,10)})};let Ze=null;function Rn(S){Ze&&Ze(S)}function _n(){oi.stop()}function _l(){oi.start()}const oi=new uu;oi.setAnimationLoop(Rn),typeof self<"u"&&oi.setContext(self),this.setAnimationLoop=function(S){Ze=S,ie.setAnimationLoop(S),S===null?oi.stop():oi.start()},ie.addEventListener("sessionstart",_n),ie.addEventListener("sessionend",_l),this.render=function(S,I){if(I!==void 0&&I.isCamera!==!0){console.error("THREE.WebGLRenderer.render: camera is not an instance of THREE.Camera.");return}if(b===!0)return;if(S.matrixWorldAutoUpdate===!0&&S.updateMatrixWorld(),I.parent===null&&I.matrixWorldAutoUpdate===!0&&I.updateMatrixWorld(),ie.enabled===!0&&ie.isPresenting===!0&&(ie.cameraAutoUpdate===!0&&ie.updateCamera(I),I=ie.getCamera()),S.isScene===!0&&S.onBeforeRender(M,S,I,P),d=be.get(S,T.length),d.init(I),T.push(d),Z.multiplyMatrices(I.projectionMatrix,I.matrixWorldInverse),Ne.setFromProjectionMatrix(Z,Sn,I.reversedDepth),K=this.localClippingEnabled,Be=se.init(this.clippingPlanes,K),m=W.get(S,y.length),m.init(),y.push(m),ie.enabled===!0&&ie.isPresenting===!0){const ee=M.xr.getDepthSensingMesh();ee!==null&&Xs(ee,I,-1/0,M.sortObjects)}Xs(S,I,0,M.sortObjects),m.finish(),M.sortObjects===!0&&m.sort(te,re),J=ie.enabled===!1||ie.isPresenting===!1||ie.hasDepthSensing()===!1,J&&ye.addToRenderList(m,S),this.info.render.frame++,Be===!0&&se.beginShadows();const k=d.state.shadowsArray;Ee.render(k,S,I),Be===!0&&se.endShadows(),this.info.autoReset===!0&&this.info.reset();const V=m.opaque,U=m.transmissive;if(d.setupLights(),I.isArrayCamera){const ee=I.cameras;if(U.length>0)for(let ue=0,xe=ee.length;ue<xe;ue++){const de=ee[ue];vl(V,U,S,de)}J&&ye.render(S);for(let ue=0,xe=ee.length;ue<xe;ue++){const de=ee[ue];gl(m,S,de,de.viewport)}}else U.length>0&&vl(V,U,S,I),J&&ye.render(S),gl(m,S,I);P!==null&&w===0&&(Fe.updateMultisampleRenderTarget(P),Fe.updateRenderTargetMipmap(P)),S.isScene===!0&&S.onAfterRender(M,S,I),ce.resetDefaultState(),x=-1,E=null,T.pop(),T.length>0?(d=T[T.length-1],Be===!0&&se.setGlobalState(M.clippingPlanes,d.state.camera)):d=null,y.pop(),y.length>0?m=y[y.length-1]:m=null};function Xs(S,I,k,V){if(S.visible===!1)return;if(S.layers.test(I.layers)){if(S.isGroup)k=S.renderOrder;else if(S.isLOD)S.autoUpdate===!0&&S.update(I);else if(S.isLight)d.pushLight(S),S.castShadow&&d.pushShadow(S);else if(S.isSprite){if(!S.frustumCulled||Ne.intersectsSprite(S)){V&&Pe.setFromMatrixPosition(S.matrixWorld).applyMatrix4(Z);const ue=F.update(S),xe=S.material;xe.visible&&m.push(S,ue,xe,k,Pe.z,null)}}else if((S.isMesh||S.isLine||S.isPoints)&&(!S.frustumCulled||Ne.intersectsObject(S))){const ue=F.update(S),xe=S.material;if(V&&(S.boundingSphere!==void 0?(S.boundingSphere===null&&S.computeBoundingSphere(),Pe.copy(S.boundingSphere.center)):(ue.boundingSphere===null&&ue.computeBoundingSphere(),Pe.copy(ue.boundingSphere.center)),Pe.applyMatrix4(S.matrixWorld).applyMatrix4(Z)),Array.isArray(xe)){const de=ue.groups;for(let De=0,Ue=de.length;De<Ue;De++){const we=de[De],He=xe[we.materialIndex];He&&He.visible&&m.push(S,ue,He,k,Pe.z,we)}}else xe.visible&&m.push(S,ue,xe,k,Pe.z,null)}}const ee=S.children;for(let ue=0,xe=ee.length;ue<xe;ue++)Xs(ee[ue],I,k,V)}function gl(S,I,k,V){const U=S.opaque,ee=S.transmissive,ue=S.transparent;d.setupLightsView(k),Be===!0&&se.setGlobalState(M.clippingPlanes,k),V&&me.viewport(D.copy(V)),U.length>0&&Jr(U,I,k),ee.length>0&&Jr(ee,I,k),ue.length>0&&Jr(ue,I,k),me.buffers.depth.setTest(!0),me.buffers.depth.setMask(!0),me.buffers.color.setMask(!0),me.setPolygonOffset(!1)}function vl(S,I,k,V){if((k.isScene===!0?k.overrideMaterial:null)!==null)return;d.state.transmissionRenderTarget[V.id]===void 0&&(d.state.transmissionRenderTarget[V.id]=new Pi(1,1,{generateMipmaps:!0,type:fe.has("EXT_color_buffer_half_float")||fe.has("EXT_color_buffer_float")?Xr:bn,minFilter:yi,samples:4,stencilBuffer:s,resolveDepthBuffer:!1,resolveStencilBuffer:!1,colorSpace:$e.workingColorSpace}));const ee=d.state.transmissionRenderTarget[V.id],ue=V.viewport||D;ee.setSize(ue.z*M.transmissionResolutionScale,ue.w*M.transmissionResolutionScale);const xe=M.getRenderTarget(),de=M.getActiveCubeFace(),De=M.getActiveMipmapLevel();M.setRenderTarget(ee),M.getClearColor(X),H=M.getClearAlpha(),H<1&&M.setClearColor(16777215,.5),M.clear(),J&&ye.render(k);const Ue=M.toneMapping;M.toneMapping=Jn;const we=V.viewport;if(V.viewport!==void 0&&(V.viewport=void 0),d.setupLightsView(V),Be===!0&&se.setGlobalState(M.clippingPlanes,V),Jr(S,k,V),Fe.updateMultisampleRenderTarget(ee),Fe.updateRenderTargetMipmap(ee),fe.has("WEBGL_multisampled_render_to_texture")===!1){let He=!1;for(let je=0,ut=I.length;je<ut;je++){const rt=I[je],Qe=rt.object,Re=rt.geometry,at=rt.material,Ke=rt.group;if(at.side===hn&&Qe.layers.test(V.layers)){const Ht=at.side;at.side=Ft,at.needsUpdate=!0,xl(Qe,k,V,Re,at,Ke),at.side=Ht,at.needsUpdate=!0,He=!0}}He===!0&&(Fe.updateMultisampleRenderTarget(ee),Fe.updateRenderTargetMipmap(ee))}M.setRenderTarget(xe,de,De),M.setClearColor(X,H),we!==void 0&&(V.viewport=we),M.toneMapping=Ue}function Jr(S,I,k){const V=I.isScene===!0?I.overrideMaterial:null;for(let U=0,ee=S.length;U<ee;U++){const ue=S[U],xe=ue.object,de=ue.geometry,De=ue.group;let Ue=ue.material;Ue.allowOverride===!0&&V!==null&&(Ue=V),xe.layers.test(k.layers)&&xl(xe,I,k,de,Ue,De)}}function xl(S,I,k,V,U,ee){S.onBeforeRender(M,I,k,V,U,ee),S.modelViewMatrix.multiplyMatrices(k.matrixWorldInverse,S.matrixWorld),S.normalMatrix.getNormalMatrix(S.modelViewMatrix),U.onBeforeRender(M,I,k,V,S,ee),U.transparent===!0&&U.side===hn&&U.forceSinglePass===!1?(U.side=Ft,U.needsUpdate=!0,M.renderBufferDirect(k,I,V,U,S,ee),U.side=ti,U.needsUpdate=!0,M.renderBufferDirect(k,I,V,U,S,ee),U.side=hn):M.renderBufferDirect(k,I,V,U,S,ee),S.onAfterRender(M,I,k,V,U,ee)}function Qr(S,I,k){I.isScene!==!0&&(I=Me);const V=_e.get(S),U=d.state.lights,ee=d.state.shadowsArray,ue=U.state.version,xe=Y.getParameters(S,U.state,ee,I,k),de=Y.getProgramCacheKey(xe);let De=V.programs;V.environment=S.isMeshStandardMaterial?I.environment:null,V.fog=I.fog,V.envMap=(S.isMeshStandardMaterial?dt:_t).get(S.envMap||V.environment),V.envMapRotation=V.environment!==null&&S.envMap===null?I.environmentRotation:S.envMapRotation,De===void 0&&(S.addEventListener("dispose",$),De=new Map,V.programs=De);let Ue=De.get(de);if(Ue!==void 0){if(V.currentProgram===Ue&&V.lightsStateVersion===ue)return Sl(S,xe),Ue}else xe.uniforms=Y.getUniforms(S),S.onBeforeCompile(xe,M),Ue=Y.acquireProgram(xe,de),De.set(de,Ue),V.uniforms=xe.uniforms;const we=V.uniforms;return(!S.isShaderMaterial&&!S.isRawShaderMaterial||S.clipping===!0)&&(we.clippingPlanes=se.uniform),Sl(S,xe),V.needsLights=_h(S),V.lightsStateVersion=ue,V.needsLights&&(we.ambientLightColor.value=U.state.ambient,we.lightProbe.value=U.state.probe,we.directionalLights.value=U.state.directional,we.directionalLightShadows.value=U.state.directionalShadow,we.spotLights.value=U.state.spot,we.spotLightShadows.value=U.state.spotShadow,we.rectAreaLights.value=U.state.rectArea,we.ltc_1.value=U.state.rectAreaLTC1,we.ltc_2.value=U.state.rectAreaLTC2,we.pointLights.value=U.state.point,we.pointLightShadows.value=U.state.pointShadow,we.hemisphereLights.value=U.state.hemi,we.directionalShadowMap.value=U.state.directionalShadowMap,we.directionalShadowMatrix.value=U.state.directionalShadowMatrix,we.spotShadowMap.value=U.state.spotShadowMap,we.spotLightMatrix.value=U.state.spotLightMatrix,we.spotLightMap.value=U.state.spotLightMap,we.pointShadowMap.value=U.state.pointShadowMap,we.pointShadowMatrix.value=U.state.pointShadowMatrix),V.currentProgram=Ue,V.uniformsList=null,Ue}function Ml(S){if(S.uniformsList===null){const I=S.currentProgram.getUniforms();S.uniformsList=As.seqWithValue(I.seq,S.uniforms)}return S.uniformsList}function Sl(S,I){const k=_e.get(S);k.outputColorSpace=I.outputColorSpace,k.batching=I.batching,k.batchingColor=I.batchingColor,k.instancing=I.instancing,k.instancingColor=I.instancingColor,k.instancingMorph=I.instancingMorph,k.skinning=I.skinning,k.morphTargets=I.morphTargets,k.morphNormals=I.morphNormals,k.morphColors=I.morphColors,k.morphTargetsCount=I.morphTargetsCount,k.numClippingPlanes=I.numClippingPlanes,k.numIntersection=I.numClipIntersection,k.vertexAlphas=I.vertexAlphas,k.vertexTangents=I.vertexTangents,k.toneMapping=I.toneMapping}function ph(S,I,k,V,U){I.isScene!==!0&&(I=Me),Fe.resetTextureUnits();const ee=I.fog,ue=V.isMeshStandardMaterial?I.environment:null,xe=P===null?M.outputColorSpace:P.isXRRenderTarget===!0?P.texture.colorSpace:lr,de=(V.isMeshStandardMaterial?dt:_t).get(V.envMap||ue),De=V.vertexColors===!0&&!!k.attributes.color&&k.attributes.color.itemSize===4,Ue=!!k.attributes.tangent&&(!!V.normalMap||V.anisotropy>0),we=!!k.morphAttributes.position,He=!!k.morphAttributes.normal,je=!!k.morphAttributes.color;let ut=Jn;V.toneMapped&&(P===null||P.isXRRenderTarget===!0)&&(ut=M.toneMapping);const rt=k.morphAttributes.position||k.morphAttributes.normal||k.morphAttributes.color,Qe=rt!==void 0?rt.length:0,Re=_e.get(V),at=d.state.lights;if(Be===!0&&(K===!0||S!==E)){const Pt=S===E&&V.id===x;se.setState(V,S,Pt)}let Ke=!1;V.version===Re.__version?(Re.needsLights&&Re.lightsStateVersion!==at.state.version||Re.outputColorSpace!==xe||U.isBatchedMesh&&Re.batching===!1||!U.isBatchedMesh&&Re.batching===!0||U.isBatchedMesh&&Re.batchingColor===!0&&U.colorTexture===null||U.isBatchedMesh&&Re.batchingColor===!1&&U.colorTexture!==null||U.isInstancedMesh&&Re.instancing===!1||!U.isInstancedMesh&&Re.instancing===!0||U.isSkinnedMesh&&Re.skinning===!1||!U.isSkinnedMesh&&Re.skinning===!0||U.isInstancedMesh&&Re.instancingColor===!0&&U.instanceColor===null||U.isInstancedMesh&&Re.instancingColor===!1&&U.instanceColor!==null||U.isInstancedMesh&&Re.instancingMorph===!0&&U.morphTexture===null||U.isInstancedMesh&&Re.instancingMorph===!1&&U.morphTexture!==null||Re.envMap!==de||V.fog===!0&&Re.fog!==ee||Re.numClippingPlanes!==void 0&&(Re.numClippingPlanes!==se.numPlanes||Re.numIntersection!==se.numIntersection)||Re.vertexAlphas!==De||Re.vertexTangents!==Ue||Re.morphTargets!==we||Re.morphNormals!==He||Re.morphColors!==je||Re.toneMapping!==ut||Re.morphTargetsCount!==Qe)&&(Ke=!0):(Ke=!0,Re.__version=V.version);let Ht=Re.currentProgram;Ke===!0&&(Ht=Qr(V,I,U));let Ii=!1,Gt=!1,vr=!1;const ot=Ht.getUniforms(),Jt=Re.uniforms;if(me.useProgram(Ht.program)&&(Ii=!0,Gt=!0,vr=!0),V.id!==x&&(x=V.id,Gt=!0),Ii||E!==S){me.buffers.depth.getReversed()&&S.reversedDepth!==!0&&(S._reversedDepth=!0,S.updateProjectionMatrix()),ot.setValue(C,"projectionMatrix",S.projectionMatrix),ot.setValue(C,"viewMatrix",S.matrixWorldInverse);const Ut=ot.map.cameraPosition;Ut!==void 0&&Ut.setValue(C,pe.setFromMatrixPosition(S.matrixWorld)),Ae.logarithmicDepthBuffer&&ot.setValue(C,"logDepthBufFC",2/(Math.log(S.far+1)/Math.LN2)),(V.isMeshPhongMaterial||V.isMeshToonMaterial||V.isMeshLambertMaterial||V.isMeshBasicMaterial||V.isMeshStandardMaterial||V.isShaderMaterial)&&ot.setValue(C,"isOrthographic",S.isOrthographicCamera===!0),E!==S&&(E=S,Gt=!0,vr=!0)}if(U.isSkinnedMesh){ot.setOptional(C,U,"bindMatrix"),ot.setOptional(C,U,"bindMatrixInverse");const Pt=U.skeleton;Pt&&(Pt.boneTexture===null&&Pt.computeBoneTexture(),ot.setValue(C,"boneTexture",Pt.boneTexture,Fe))}U.isBatchedMesh&&(ot.setOptional(C,U,"batchingTexture"),ot.setValue(C,"batchingTexture",U._matricesTexture,Fe),ot.setOptional(C,U,"batchingIdTexture"),ot.setValue(C,"batchingIdTexture",U._indirectTexture,Fe),ot.setOptional(C,U,"batchingColorTexture"),U._colorsTexture!==null&&ot.setValue(C,"batchingColorTexture",U._colorsTexture,Fe));const Qt=k.morphAttributes;if((Qt.position!==void 0||Qt.normal!==void 0||Qt.color!==void 0)&&ne.update(U,k,Ht),(Gt||Re.receiveShadow!==U.receiveShadow)&&(Re.receiveShadow=U.receiveShadow,ot.setValue(C,"receiveShadow",U.receiveShadow)),V.isMeshGouraudMaterial&&V.envMap!==null&&(Jt.envMap.value=de,Jt.flipEnvMap.value=de.isCubeTexture&&de.isRenderTargetTexture===!1?-1:1),V.isMeshStandardMaterial&&V.envMap===null&&I.environment!==null&&(Jt.envMapIntensity.value=I.environmentIntensity),Gt&&(ot.setValue(C,"toneMappingExposure",M.toneMappingExposure),Re.needsLights&&mh(Jt,vr),ee&&V.fog===!0&&j.refreshFogUniforms(Jt,ee),j.refreshMaterialUniforms(Jt,V,z,q,d.state.transmissionRenderTarget[S.id]),As.upload(C,Ml(Re),Jt,Fe)),V.isShaderMaterial&&V.uniformsNeedUpdate===!0&&(As.upload(C,Ml(Re),Jt,Fe),V.uniformsNeedUpdate=!1),V.isSpriteMaterial&&ot.setValue(C,"center",U.center),ot.setValue(C,"modelViewMatrix",U.modelViewMatrix),ot.setValue(C,"normalMatrix",U.normalMatrix),ot.setValue(C,"modelMatrix",U.matrixWorld),V.isShaderMaterial||V.isRawShaderMaterial){const Pt=V.uniformsGroups;for(let Ut=0,qs=Pt.length;Ut<qs;Ut++){const li=Pt[Ut];ze.update(li,Ht),ze.bind(li,Ht)}}return Ht}function mh(S,I){S.ambientLightColor.needsUpdate=I,S.lightProbe.needsUpdate=I,S.directionalLights.needsUpdate=I,S.directionalLightShadows.needsUpdate=I,S.pointLights.needsUpdate=I,S.pointLightShadows.needsUpdate=I,S.spotLights.needsUpdate=I,S.spotLightShadows.needsUpdate=I,S.rectAreaLights.needsUpdate=I,S.hemisphereLights.needsUpdate=I}function _h(S){return S.isMeshLambertMaterial||S.isMeshToonMaterial||S.isMeshPhongMaterial||S.isMeshStandardMaterial||S.isShadowMaterial||S.isShaderMaterial&&S.lights===!0}this.getActiveCubeFace=function(){return A},this.getActiveMipmapLevel=function(){return w},this.getRenderTarget=function(){return P},this.setRenderTargetTextures=function(S,I,k){const V=_e.get(S);V.__autoAllocateDepthBuffer=S.resolveDepthBuffer===!1,V.__autoAllocateDepthBuffer===!1&&(V.__useRenderToTexture=!1),_e.get(S.texture).__webglTexture=I,_e.get(S.depthTexture).__webglTexture=V.__autoAllocateDepthBuffer?void 0:k,V.__hasExternalTextures=!0},this.setRenderTargetFramebuffer=function(S,I){const k=_e.get(S);k.__webglFramebuffer=I,k.__useDefaultFramebuffer=I===void 0};const gh=C.createFramebuffer();this.setRenderTarget=function(S,I=0,k=0){P=S,A=I,w=k;let V=!0,U=null,ee=!1,ue=!1;if(S){const de=_e.get(S);if(de.__useDefaultFramebuffer!==void 0)me.bindFramebuffer(C.FRAMEBUFFER,null),V=!1;else if(de.__webglFramebuffer===void 0)Fe.setupRenderTarget(S);else if(de.__hasExternalTextures)Fe.rebindTextures(S,_e.get(S.texture).__webglTexture,_e.get(S.depthTexture).__webglTexture);else if(S.depthBuffer){const we=S.depthTexture;if(de.__boundDepthTexture!==we){if(we!==null&&_e.has(we)&&(S.width!==we.image.width||S.height!==we.image.height))throw new Error("WebGLRenderTarget: Attached DepthTexture is initialized to the incorrect size.");Fe.setupDepthRenderbuffer(S)}}const De=S.texture;(De.isData3DTexture||De.isDataArrayTexture||De.isCompressedArrayTexture)&&(ue=!0);const Ue=_e.get(S).__webglFramebuffer;S.isWebGLCubeRenderTarget?(Array.isArray(Ue[I])?U=Ue[I][k]:U=Ue[I],ee=!0):S.samples>0&&Fe.useMultisampledRTT(S)===!1?U=_e.get(S).__webglMultisampledFramebuffer:Array.isArray(Ue)?U=Ue[k]:U=Ue,D.copy(S.viewport),N.copy(S.scissor),O=S.scissorTest}else D.copy(ve).multiplyScalar(z).floor(),N.copy(Ie).multiplyScalar(z).floor(),O=Xe;if(k!==0&&(U=gh),me.bindFramebuffer(C.FRAMEBUFFER,U)&&V&&me.drawBuffers(S,U),me.viewport(D),me.scissor(N),me.setScissorTest(O),ee){const de=_e.get(S.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_CUBE_MAP_POSITIVE_X+I,de.__webglTexture,k)}else if(ue){const de=I;for(let De=0;De<S.textures.length;De++){const Ue=_e.get(S.textures[De]);C.framebufferTextureLayer(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0+De,Ue.__webglTexture,k,de)}}else if(S!==null&&k!==0){const de=_e.get(S.texture);C.framebufferTexture2D(C.FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,de.__webglTexture,k)}x=-1},this.readRenderTargetPixels=function(S,I,k,V,U,ee,ue,xe=0){if(!(S&&S.isWebGLRenderTarget)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");return}let de=_e.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&ue!==void 0&&(de=de[ue]),de){me.bindFramebuffer(C.FRAMEBUFFER,de);try{const De=S.textures[xe],Ue=De.format,we=De.type;if(!Ae.textureFormatReadable(Ue)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in RGBA or implementation defined format.");return}if(!Ae.textureTypeReadable(we)){console.error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not in UnsignedByteType or implementation defined type.");return}I>=0&&I<=S.width-V&&k>=0&&k<=S.height-U&&(S.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+xe),C.readPixels(I,k,V,U,Te.convert(Ue),Te.convert(we),ee))}finally{const De=P!==null?_e.get(P).__webglFramebuffer:null;me.bindFramebuffer(C.FRAMEBUFFER,De)}}},this.readRenderTargetPixelsAsync=async function(S,I,k,V,U,ee,ue,xe=0){if(!(S&&S.isWebGLRenderTarget))throw new Error("THREE.WebGLRenderer.readRenderTargetPixels: renderTarget is not THREE.WebGLRenderTarget.");let de=_e.get(S).__webglFramebuffer;if(S.isWebGLCubeRenderTarget&&ue!==void 0&&(de=de[ue]),de)if(I>=0&&I<=S.width-V&&k>=0&&k<=S.height-U){me.bindFramebuffer(C.FRAMEBUFFER,de);const De=S.textures[xe],Ue=De.format,we=De.type;if(!Ae.textureFormatReadable(Ue))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in RGBA or implementation defined format.");if(!Ae.textureTypeReadable(we))throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: renderTarget is not in UnsignedByteType or implementation defined type.");const He=C.createBuffer();C.bindBuffer(C.PIXEL_PACK_BUFFER,He),C.bufferData(C.PIXEL_PACK_BUFFER,ee.byteLength,C.STREAM_READ),S.textures.length>1&&C.readBuffer(C.COLOR_ATTACHMENT0+xe),C.readPixels(I,k,V,U,Te.convert(Ue),Te.convert(we),0);const je=P!==null?_e.get(P).__webglFramebuffer:null;me.bindFramebuffer(C.FRAMEBUFFER,je);const ut=C.fenceSync(C.SYNC_GPU_COMMANDS_COMPLETE,0);return C.flush(),await uf(C,ut,4),C.bindBuffer(C.PIXEL_PACK_BUFFER,He),C.getBufferSubData(C.PIXEL_PACK_BUFFER,0,ee),C.deleteBuffer(He),C.deleteSync(ut),ee}else throw new Error("THREE.WebGLRenderer.readRenderTargetPixelsAsync: requested read bounds are out of range.")},this.copyFramebufferToTexture=function(S,I=null,k=0){const V=Math.pow(2,-k),U=Math.floor(S.image.width*V),ee=Math.floor(S.image.height*V),ue=I!==null?I.x:0,xe=I!==null?I.y:0;Fe.setTexture2D(S,0),C.copyTexSubImage2D(C.TEXTURE_2D,k,0,0,ue,xe,U,ee),me.unbindTexture()};const vh=C.createFramebuffer(),xh=C.createFramebuffer();this.copyTextureToTexture=function(S,I,k=null,V=null,U=0,ee=null){ee===null&&(U!==0?(Or("WebGLRenderer: copyTextureToTexture function signature has changed to support src and dst mipmap levels."),ee=U,U=0):ee=0);let ue,xe,de,De,Ue,we,He,je,ut;const rt=S.isCompressedTexture?S.mipmaps[ee]:S.image;if(k!==null)ue=k.max.x-k.min.x,xe=k.max.y-k.min.y,de=k.isBox3?k.max.z-k.min.z:1,De=k.min.x,Ue=k.min.y,we=k.isBox3?k.min.z:0;else{const Qt=Math.pow(2,-U);ue=Math.floor(rt.width*Qt),xe=Math.floor(rt.height*Qt),S.isDataArrayTexture?de=rt.depth:S.isData3DTexture?de=Math.floor(rt.depth*Qt):de=1,De=0,Ue=0,we=0}V!==null?(He=V.x,je=V.y,ut=V.z):(He=0,je=0,ut=0);const Qe=Te.convert(I.format),Re=Te.convert(I.type);let at;I.isData3DTexture?(Fe.setTexture3D(I,0),at=C.TEXTURE_3D):I.isDataArrayTexture||I.isCompressedArrayTexture?(Fe.setTexture2DArray(I,0),at=C.TEXTURE_2D_ARRAY):(Fe.setTexture2D(I,0),at=C.TEXTURE_2D),C.pixelStorei(C.UNPACK_FLIP_Y_WEBGL,I.flipY),C.pixelStorei(C.UNPACK_PREMULTIPLY_ALPHA_WEBGL,I.premultiplyAlpha),C.pixelStorei(C.UNPACK_ALIGNMENT,I.unpackAlignment);const Ke=C.getParameter(C.UNPACK_ROW_LENGTH),Ht=C.getParameter(C.UNPACK_IMAGE_HEIGHT),Ii=C.getParameter(C.UNPACK_SKIP_PIXELS),Gt=C.getParameter(C.UNPACK_SKIP_ROWS),vr=C.getParameter(C.UNPACK_SKIP_IMAGES);C.pixelStorei(C.UNPACK_ROW_LENGTH,rt.width),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,rt.height),C.pixelStorei(C.UNPACK_SKIP_PIXELS,De),C.pixelStorei(C.UNPACK_SKIP_ROWS,Ue),C.pixelStorei(C.UNPACK_SKIP_IMAGES,we);const ot=S.isDataArrayTexture||S.isData3DTexture,Jt=I.isDataArrayTexture||I.isData3DTexture;if(S.isDepthTexture){const Qt=_e.get(S),Pt=_e.get(I),Ut=_e.get(Qt.__renderTarget),qs=_e.get(Pt.__renderTarget);me.bindFramebuffer(C.READ_FRAMEBUFFER,Ut.__webglFramebuffer),me.bindFramebuffer(C.DRAW_FRAMEBUFFER,qs.__webglFramebuffer);for(let li=0;li<de;li++)ot&&(C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,_e.get(S).__webglTexture,U,we+li),C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,_e.get(I).__webglTexture,ee,ut+li)),C.blitFramebuffer(De,Ue,ue,xe,He,je,ue,xe,C.DEPTH_BUFFER_BIT,C.NEAREST);me.bindFramebuffer(C.READ_FRAMEBUFFER,null),me.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else if(U!==0||S.isRenderTargetTexture||_e.has(S)){const Qt=_e.get(S),Pt=_e.get(I);me.bindFramebuffer(C.READ_FRAMEBUFFER,vh),me.bindFramebuffer(C.DRAW_FRAMEBUFFER,xh);for(let Ut=0;Ut<de;Ut++)ot?C.framebufferTextureLayer(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,Qt.__webglTexture,U,we+Ut):C.framebufferTexture2D(C.READ_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,Qt.__webglTexture,U),Jt?C.framebufferTextureLayer(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,Pt.__webglTexture,ee,ut+Ut):C.framebufferTexture2D(C.DRAW_FRAMEBUFFER,C.COLOR_ATTACHMENT0,C.TEXTURE_2D,Pt.__webglTexture,ee),U!==0?C.blitFramebuffer(De,Ue,ue,xe,He,je,ue,xe,C.COLOR_BUFFER_BIT,C.NEAREST):Jt?C.copyTexSubImage3D(at,ee,He,je,ut+Ut,De,Ue,ue,xe):C.copyTexSubImage2D(at,ee,He,je,De,Ue,ue,xe);me.bindFramebuffer(C.READ_FRAMEBUFFER,null),me.bindFramebuffer(C.DRAW_FRAMEBUFFER,null)}else Jt?S.isDataTexture||S.isData3DTexture?C.texSubImage3D(at,ee,He,je,ut,ue,xe,de,Qe,Re,rt.data):I.isCompressedArrayTexture?C.compressedTexSubImage3D(at,ee,He,je,ut,ue,xe,de,Qe,rt.data):C.texSubImage3D(at,ee,He,je,ut,ue,xe,de,Qe,Re,rt):S.isDataTexture?C.texSubImage2D(C.TEXTURE_2D,ee,He,je,ue,xe,Qe,Re,rt.data):S.isCompressedTexture?C.compressedTexSubImage2D(C.TEXTURE_2D,ee,He,je,rt.width,rt.height,Qe,rt.data):C.texSubImage2D(C.TEXTURE_2D,ee,He,je,ue,xe,Qe,Re,rt);C.pixelStorei(C.UNPACK_ROW_LENGTH,Ke),C.pixelStorei(C.UNPACK_IMAGE_HEIGHT,Ht),C.pixelStorei(C.UNPACK_SKIP_PIXELS,Ii),C.pixelStorei(C.UNPACK_SKIP_ROWS,Gt),C.pixelStorei(C.UNPACK_SKIP_IMAGES,vr),ee===0&&I.generateMipmaps&&C.generateMipmap(at),me.unbindTexture()},this.initRenderTarget=function(S){_e.get(S).__webglFramebuffer===void 0&&Fe.setupRenderTarget(S)},this.initTexture=function(S){S.isCubeTexture?Fe.setTextureCube(S,0):S.isData3DTexture?Fe.setTexture3D(S,0):S.isDataArrayTexture||S.isCompressedArrayTexture?Fe.setTexture2DArray(S,0):Fe.setTexture2D(S,0),me.unbindTexture()},this.resetState=function(){A=0,w=0,P=null,me.reset(),ce.reset()},typeof __THREE_DEVTOOLS__<"u"&&__THREE_DEVTOOLS__.dispatchEvent(new CustomEvent("observe",{detail:this}))}get coordinateSystem(){return Sn}get outputColorSpace(){return this._outputColorSpace}set outputColorSpace(e){this._outputColorSpace=e;const t=this.getContext();t.drawingBufferColorSpace=$e._getDrawingBufferColorSpace(e),t.unpackColorSpace=$e._getUnpackColorSpace()}}function Nn(r){if(r===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return r}function mu(r,e){r.prototype=Object.create(e.prototype),r.prototype.constructor=r,r.__proto__=e}/*!
 * GSAP 3.13.0
 * https://gsap.com
 *
...
*/var wc,$n,ir,fl,Ti,Rc,dl,w0=function(){return typeof window<"u"},kn={},xi=180/Math.PI,rr=Math.PI/180,$i=Math.atan2,Cc=1e8,pl=/([A-Z])/g,R0=/(left|right|width|margin|padding|x)/i,C0=/[\s,\(]\S/,En={autoAlpha:"opacity,visibility",scale:"scaleX,scaleY",alpha:"opacity"},No=function(e,t){return t.set(t.t,t.p,Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},P0=function(e,t){return t.set(t.t,t.p,e===1?t.e:Math.round((t.s+t.c*e)*1e4)/1e4+t.u,t)},D0=function(e,t){return t.set(t.t,t.p,e?Math.round((t.s+t.c*e)*1e4)/1e4+t.u:t.b,t)},L0=function(e,t){var n=t.s+t.c*e;t.set(t.t,t.p,~~(n+(n<0?-.5:.5))+t.u,t)},ih=function(e,t){return t.set(t.t,t.p,e?t.e:t.b,t)},rh=function(e,t){return t.set(t.t,t.p,e!==1?t.b:t.e,t)},I0=function(e,t,n){return e.style[t]=n},U0=function(e,t,n){return e.style.setProperty(t,n)},N0=function(e,t,n){return e._gsap[t]=n},F0=function(e,t,n){return e._gsap.scaleX=e._gsap.scaleY=n},O0=function(e,t,n,i,s){var a=e._gsap;a.scaleX=a.scaleY=n,a.renderTransform(s,a)},B0=function(e,t,n,i,s){var a=e._gsap;a[t]=n,a.renderTransform(s,a)},ct="transform",kt=ct+"Origin",z0=function r(e,t){var n=this,i=this.target,s=i.style,a=i._gsap;if(e in kn&&s){if(this.tfm=this.tfm||{},e!=="transform")e=En[e]||e,~e.indexOf(",")?e.split(",").forEach(function(o){return n.tfm[o]=Fn(i,o)}):this.tfm[e]=a.x?a[e]:Fn(i,e),e===kt&&(this.tfm.zOrigin=a.zOrigin);else return En.transform.split(",").forEach(function(o){return r.call(n,o,t)});if(this.props.indexOf(ct)>=0)return;a.svg&&(this.svgo=i.getAttribute("data-svg-origin"),this.props.push(kt,t,"")),e=ct}(s||t)&&this.props.push(e,t,s[e])},sh=function(e){e.translate&&(e.removeProperty("translate"),e.removeProperty("scale"),e.removeProperty("rotate"))},k0=function(){var e=this.props,t=this.target,n=t.style,i=t._gsap,s,a;for(s=0;s<e.length;s+=3)e[s+1]?e[s+1]===2?t[e[s]](e[s+2]):t[e[s]]=e[s+2]:e[s+2]?n[e[s]]=e[s+2]:n.removeProperty(e[s].substr(0,2)==="--"?e[s]:e[s].replace(pl,"-$1").toLowerCase());if(this.tfm){for(a in this.tfm)i[a]=this.tfm[a];i.svg&&(i.renderTransform(),t.setAttribute("data-svg-origin",this.svgo||"")),s=dl(),(!s||!s.isStart)&&!n[ct]&&(sh(n),i.zOrigin&&n[kt]&&(n[kt]+=" "+i.zOrigin+"px",i.zOrigin=0,i.renderTransform()),i.uncache=1)}},ah=function(e,t){var n={target:e,props:[],revert:k0,save:z0};return e._gsap||Vt.core.getCache(e),t&&e.style&&e.nodeType&&t.split(",").forEach(function(i){return n.save(i)}),n},oh,Fo=function(e,t){var n=$n.createElementNS?$n.createElementNS((t||"http://www.w3.org/1999/xhtml").replace(/^https/,"http"),e):$n.createElement(e);return n&&n.style?n:$n.createElement(e)},on=function r(e,t,n){var i=getComputedStyle(e);return i[t]||i.getPropertyValue(t.replace(pl,"-$1").toLowerCase())||i.getPropertyValue(t)||!n&&r(e,mr(t)||t,1)||""},Pc="O,Moz,ms,Ms,Webkit".split(","),mr=function(e,t,n){var i=t||Ti,s=i.style,a=5;if(e in s&&!n)return e;for(e=e.charAt(0).toUpperCase()+e.substr(1);a--&&!(Pc[a]+e in s););return a<0?null:(a===3?"ms":a>=0?Pc[a]:"")+e},Oo=function(){w0()&&window.document&&(wc=window,$n=wc.document,ir=$n.documentElement,Ti=Fo("div")||{style:{}},Fo("div"),ct=mr(ct),kt=ct+"Origin",Ti.style.cssText="border-width:0;line-height:0;position:absolute;padding:0",oh=!!mr("perspective"),dl=Vt.core.reverting,fl=1)},Dc=function(e){var t=e.ownerSVGElement,n=Fo("svg",t&&t.getAttribute("xmlns")||"http://www.w3.org/2000/svg"),i=e.cloneNode(!0),s;i.style.display="block",n.appendChild(i),ir.appendChild(n);try{s=i.getBBox()}catch{}return n.removeChild(i),ir.removeChild(n),s},Lc=function(e,t){for(var n=t.length;n--;)if(e.hasAttribute(t[n]))return e.getAttribute(t[n])},lh=function(e){var t,n;try{t=e.getBBox()}catch{t=Dc(e),n=1}return t&&(t.width||t.height)||n||(t=Dc(e)),t&&!t.width&&!t.x&&!t.y?{x:+Lc(e,["x","cx","x1"])||0,y:+Lc(e,["y","cy","y1"])||0,width:0,height:0}:t},ch=function(e){return!!(e.getCTM&&(!e.parentNode||e.ownerSVGElement)&&lh(e))},Di=function(e,t){if(t){var n=e.style,i;t in kn&&t!==kt&&(t=ct),n.removeProperty?(i=t.substr(0,2),(i==="ms"||t.substr(0,6)==="webkit")&&(t="-"+t),n.removeProperty(i==="--"?t:t.replace(pl,"-$1").toLowerCase())):n.removeAttribute(t)}},Zn=function(e,t,n,i,s,a){var o=new zt(e._pt,t,n,0,1,a?rh:ih);return e._pt=o,o.b=i,o.e=s,e._props.push(n),o},Ic={deg:1,rad:1,turn:1},V0={grid:1,flex:1},ri=function r(e,t,n,i){var s=parseFloat(n)||0,a=(n+"").trim().substr((s+"").length)||"px",o=Ti.style,c=R0.test(t),l=e.tagName.toLowerCase()==="svg",u=(l?"client":"offset")+(c?"Width":"Height"),h=100,f=i==="px",p=i==="%",g,_,m,d;if(i===a||!s||Ic[i]||Ic[a])return s;if(a!=="px"&&!f&&(s=r(e,t,n,"px")),d=e.getCTM&&ch(e),(p||a==="%")&&(kn[t]||~t.indexOf("adius")))return g=d?e.getBBox()[c?"width":"height"]:e[u],pt(p?s/g*h:s/100*g);if(o[c?"width":"height"]=h+(f?a:i),_=i!=="rem"&&~t.indexOf("adius")||i==="em"&&e.appendChild&&!l?e:e.parentNode,d&&(_=(e.ownerSVGElement||{}).parentNode),(!_||_===$n||!_.appendChild)&&(_=$n.body),m=_._gsap,m&&p&&m.width&&c&&m.time===Yt.time&&!m.uncache)return pt(s/m.width*h);if(p&&(t==="height"||t==="width")){var y=e.style[t];e.style[t]=h+i,g=e[u],y?e.style[t]=y:Di(e,t)}else(p||a==="%")&&!V0[on(_,"display")]&&(o.position=on(e,"position")),_===e&&(o.position="static"),_.appendChild(Ti),g=Ti[u],_.removeChild(Ti),o.position="absolute";return c&&p&&(m=bi(_),m.time=Yt.time,m.width=_[u]),pt(f?g*s/h:g&&s?h/g*s:0)},Fn=function(e,t,n,i){var s;return fl||Oo(),t in En&&t!=="transform"&&(t=En[t],~t.indexOf(",")&&(t=t.split(",")[0])),kn[t]&&t!=="transform"?(s=Wr(e,i),s=t!=="transformOrigin"?s[t]:s.svg?s.origin:Bs(on(e,kt))+" "+s.zOrigin+"px"):(s=e.style[t],(!s||s==="auto"||i||~(s+"").indexOf("calc("))&&(s=Os[t]&&Os[t](e,t,n)||on(e,t)||bu(e,t)||(t==="opacity"?1:0))),n&&!~(s+"").trim().indexOf(" ")?ri(e,t,s,n)+n:s},H0=function(e,t,n,i){if(!n||n==="none"){var s=mr(t,e,1),a=s&&on(e,s,1);a&&a!==n?(t=s,n=a):t==="borderColor"&&(n=on(e,"borderTopColor"))}var o=new zt(this._pt,e.style,t,0,1,eh),c=0,l=0,u,h,f,p,g,_,m,d,y,T,M,b;if(o.b=n,o.e=i,n+="",i+="",i.substring(0,6)==="var(--"&&(i=on(e,i.substring(4,i.indexOf(")")))),i==="auto"&&(_=e.style[t],e.style[t]=i,i=on(e,t)||i,_?e.style[t]=_:Di(e,t)),u=[n,i],Wu(u),n=u[0],i=u[1],f=n.match(Ji)||[],b=i.match(Ji)||[],b.length){for(;h=Ji.exec(i);)m=h[0],y=i.substring(c,h.index),g?g=(g+1)%5:(y.substr(-5)==="rgba("||y.substr(-5)==="hsla(")&&(g=1),m!==(_=f[l++]||"")&&(p=parseFloat(_)||0,M=_.substr((p+"").length),m.charAt(1)==="="&&(m=nr(p,m)+M),d=parseFloat(m),T=m.substr((d+"").length),c=Ji.lastIndex-T.length,T||(T=T||$t.units[t]||M,c===i.length&&(i+=T,o.e+=T)),M!==T&&(p=ri(e,t,_,T)||0),o._pt={_next:o._pt,p:y||l===1?y:",",s:p,c:d-p,m:g&&g<4||t==="zIndex"?Math.round:0});o.c=c<i.length?i.substring(c,i.length):""}else o.r=t==="display"&&i==="none"?rh:ih;return xu.test(i)&&(o.e=0),this._pt=o,o},Uc={top:"0%",bottom:"100%",left:"0%",right:"100%",center:"50%"},G0=function(e){var t=e.split(" "),n=t[0],i=t[1]||"50%";return(n==="top"||n==="bottom"||i==="left"||i==="right")&&(e=n,n=i,i=e),t[0]=Uc[n]||n,t[1]=Uc[i]||i,t.join(" ")},W0=function(e,t){if(t.tween&&t.tween._time===t.tween._dur){var n=t.t,i=n.style,s=t.u,a=n._gsap,o,c,l;if(s==="all"||s===!0)i.cssText="",c=1;else for(s=s.split(","),l=s.length;--l>-1;)o=s[l],kn[o]&&(c=1,o=o==="transformOrigin"?kt:ct),Di(n,o);c&&(Di(n,ct),a&&(a.svg&&n.removeAttribute("transform"),i.scale=i.rotate=i.translate="none",Wr(n,1),a.uncache=1,sh(i)))}},Os={clearProps:function(e,t,n,i,s){if(s.data!=="isFromStart"){var a=e._pt=new zt(e._pt,t,n,0,0,W0);return a.u=i,a.pr=-10,a.tween=s,e._props.push(n),1}}},Gr=[1,0,0,1,0,0],uh={},hh=function(e){return e==="matrix(1, 0, 0, 1, 0, 0)"||e==="none"||!e},Nc=function(e){var t=on(e,ct);return hh(t)?Gr:t.substr(7).match(vu).map(pt)},ml=function(e,t){var n=e._gsap||bi(e),i=e.style,s=Nc(e),a,o,c,l;return n.svg&&e.getAttribute("transform")?(c=e.transform.baseVal.consolidate().matrix,s=[c.a,c.b,c.c,c.d,c.e,c.f],s.join(",")==="1,0,0,1,0,0"?Gr:s):(s===Gr&&!e.offsetParent&&e!==ir&&!n.svg&&(c=i.display,i.display="block",a=e.parentNode,(!a||!e.offsetParent&&!e.getBoundingClientRect().width)&&(l=1,o=e.nextElementSibling,ir.appendChild(e)),s=Nc(e),c?i.display=c:Di(e,"display"),l&&(o?a.insertBefore(e,o):a?a.appendChild(e):ir.removeChild(e))),t&&s.length>6?[s[0],s[1],s[4],s[5],s[12],s[13]]:s)},Bo=function(e,t,n,i,s,a){var o=e._gsap,c=s||ml(e,!0),l=o.xOrigin||0,u=o.yOrigin||0,h=o.xOffset||0,f=o.yOffset||0,p=c[0],g=c[1],_=c[2],m=c[3],d=c[4],y=c[5],T=t.split(" "),M=parseFloat(T[0])||0,b=parseFloat(T[1])||0,A,w,P,x;n?c!==Gr&&(w=p*m-g*_)&&(P=M*(m/w)+b*(-_/w)+(_*y-m*d)/w,x=M*(-g/w)+b*(p/w)-(p*y-g*d)/w,M=P,b=x):(A=lh(e),M=A.x+(~T[0].indexOf("%")?M/100*A.width:M),b=A.y+(~(T[1]||T[0]).indexOf("%")?b/100*A.height:b)),i||i!==!1&&o.smooth?(d=M-l,y=b-u,o.xOffset=h+(d*p+y*_)-d,o.yOffset=f+(d*g+y*m)-y):o.xOffset=o.yOffset=0,o.xOrigin=M,o.yOrigin=b,o.smooth=!!i,o.origin=t,o.originIsAbsolute=!!n,e.style[kt]="0px 0px",a&&(Zn(a,o,"xOrigin",l,M),Zn(a,o,"yOrigin",u,b),Zn(a,o,"xOffset",h,o.xOffset),Zn(a,o,"yOffset",f,o.yOffset)),e.setAttribute("data-svg-origin",M+" "+b)},Wr=function(e,t){var n=e._gsap||new Ku(e);if("x"in n&&!t&&!n.uncache)return n;var i=e.style,s=n.scaleX<0,a="px",o="deg",c=getComputedStyle(e),l=on(e,kt)||"0",u,h,f,p,g,_,m,d,y,T,M,b,A,w,P,x,E,D,N,O,X,H,G,q,z,te,re,ve,Ie,Xe,Ne,Be;return u=h=f=_=m=d=y=T=M=0,p=g=1,n.svg=!!(e.getCTM&&ch(e)),c.translate&&((c.translate!=="none"||c.scale!=="none"||c.rotate!=="none")&&(i[ct]=(c.translate!=="none"?"translate3d("+(c.translate+" 0 0").split(" ").slice(0,3).join(", ")+") ":"")+(c.rotate!=="none"?"rotate("+c.rotate+") ":"")+(c.scale!=="none"?"scale("+c.scale.split(" ").join(",")+") ":"")+(c[ct]!=="none"?c[ct]:"")),i.scale=i.rotate=i.translate="none"),w=ml(e,n.svg),n.svg&&(n.uncache?(z=e.getBBox(),l=n.xOrigin-z.x+"px "+(n.yOrigin-z.y)+"px",q=""):q=!t&&e.getAttribute("data-svg-origin"),Bo(e,q||l,!!q||n.originIsAbsolute,n.smooth!==!1,w)),b=n.xOrigin||0,A=n.yOrigin||0,w!==Gr&&(D=w[0],N=w[1],O=w[2],X=w[3],u=H=w[4],h=G=w[5],w.length===6?(p=Math.sqrt(D*D+N*N),g=Math.sqrt(X*X+O*O),_=D||N?$i(N,D)*xi:0,y=O||X?$i(O,X)*xi+_:0,y&&(g*=Math.abs(Math.cos(y*rr))),n.svg&&(u-=b-(b*D+A*O),h-=A-(b*N+A*X))):(Be=w[6],Xe=w[7],re=w[8],ve=w[9],Ie=w[10],Ne=w[11],u=w[12],h=w[13],f=w[14],P=$i(Be,Ie),m=P*xi,P&&(x=Math.cos(-P),E=Math.sin(-P),q=H*x+re*E,z=G*x+ve*E,te=Be*x+Ie*E,re=H*-E+re*x,ve=G*-E+ve*x,Ie=Be*-E+Ie*x,Ne=Xe*-E+Ne*x,H=q,G=z,Be=te),P=$i(-O,Ie),d=P*xi,P&&(x=Math.cos(-P),E=Math.sin(-P),q=D*x-re*E,z=N*x-ve*E,te=O*x-Ie*E,Ne=X*E+Ne*x,D=q,N=z,O=te),P=$i(N,D),_=P*xi,P&&(x=Math.cos(P),E=Math.sin(P),q=D*x+N*E,z=H*x+G*E,N=N*x-D*E,G=G*x-H*E,D=q,H=z),m&&Math.abs(m)+Math.abs(_)>359.9&&(m=_=0,d=180-d),p=pt(Math.sqrt(D*D+N*N+O*O)),g=pt(Math.sqrt(G*G+Be*Be)),P=$i(H,G),y=Math.abs(P)>2e-4?P*xi:0,M=Ne?1/(Ne<0?-Ne:Ne):0),n.svg&&(q=e.getAttribute("transform"),n.forceCSS=e.setAttribute("transform","")||!hh(on(e,ct)),q&&e.setAttribute("transform",q))),Math.abs(y)>90&&Math.abs(y)<270&&(s?(p*=-1,y+=_<=0?180:-180,_+=_<=0?180:-180):(g*=-1,y+=y<=0?180:-180)),t=t||n.uncache,n.x=u-((n.xPercent=u&&(!t&&n.xPercent||(Math.round(e.offsetWidth/2)===Math.round(-u)?-50:0)))?e.offsetWidth*n.xPercent/100:0)+a,n.y=h-((n.yPercent=h&&(!t&&n.yPercent||(Math.round(e.offsetHeight/2)===Math.round(-h)?-50:0)))?e.offsetHeight*n.yPercent/100:0)+a,n.z=f+a,n.scaleX=pt(p),n.scaleY=pt(g),n.rotation=pt(_)+o,n.rotationX=pt(m)+o,n.rotationY=pt(d)+o,n.skewX=y+o,n.skewY=T+o,n.transformPerspective=M+a,(n.zOrigin=parseFloat(l.split(" ")[2])||!t&&n.zOrigin||0)&&(i[kt]=Bs(l)),n.xOffset=n.yOffset=0,n.force3D=$t.force3D,n.renderTransform=n.svg?q0:oh?fh:X0,n.uncache=0,n},Bs=function(e){return(e=e.split(" "))[0]+" "+e[1]},Ia=function(e,t,n){var i=wt(t);return pt(parseFloat(t)+parseFloat(ri(e,"x",n+"px",i)))+i},X0=function(e,t){t.z="0px",t.rotationY=t.rotationX="0deg",t.force3D=0,fh(e,t)},mi="0deg",Tr="0px",_i=") ",fh=function(e,t){var n=t||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,c=n.z,l=n.rotation,u=n.rotationY,h=n.rotationX,f=n.skewX,p=n.skewY,g=n.scaleX,_=n.scaleY,m=n.transformPerspective,d=n.force3D,y=n.target,T=n.zOrigin,M="",b=d==="auto"&&e&&e!==1||d===!0;if(T&&(h!==mi||u!==mi)){var A=parseFloat(u)*rr,w=Math.sin(A),P=Math.cos(A),x;A=parseFloat(h)*rr,x=Math.cos(A),a=Ia(y,a,w*x*-T),o=Ia(y,o,-Math.sin(A)*-T),c=Ia(y,c,P*x*-T+T)}m!==Tr&&(M+="perspective("+m+_i),(i||s)&&(M+="translate("+i+"%, "+s+"%) "),(b||a!==Tr||o!==Tr||c!==Tr)&&(M+=c!==Tr||b?"translate3d("+a+", "+o+", "+c+") ":"translate("+a+", "+o+_i),l!==mi&&(M+="rotate("+l+_i),u!==mi&&(M+="rotateY("+u+_i),h!==mi&&(M+="rotateX("+h+_i),(f!==mi||p!==mi)&&(M+="skew("+f+", "+p+_i),(g!==1||_!==1)&&(M+="scale("+g+", "+_+_i),y.style[ct]=M||"translate(0, 0)"},q0=function(e,t){var n=t||this,i=n.xPercent,s=n.yPercent,a=n.x,o=n.y,c=n.rotation,l=n.skewX,u=n.skewY,h=n.scaleX,f=n.scaleY,p=n.target,g=n.xOrigin,_=n.yOrigin,m=n.xOffset,d=n.yOffset,y=n.forceCSS,T=parseFloat(a),M=parseFloat(o),b,A,w,P,x;c=parseFloat(c),l=parseFloat(l),u=parseFloat(u),u&&(u=parseFloat(u),l+=u,c+=u),c||l?(c*=rr,l*=rr,b=Math.cos(c)*h,A=Math.sin(c)*h,w=Math.sin(c-l)*-f,P=Math.cos(c-l)*f,l&&(u*=rr,x=Math.tan(l-u),x=Math.sqrt(1+x*x),w*=x,P*=x,u&&(x=Math.tan(u),x=Math.sqrt(1+x*x),b*=x,A*=x)),b=pt(b),A=pt(A),w=pt(w),P=pt(P)):(b=h,P=f,A=w=0),(T&&!~(a+"").indexOf("px")||M&&!~(o+"").indexOf("px"))&&(T=ri(p,"x",a,"px"),M=ri(p,"y",o,"px")),(g||_||m||d)&&(T=pt(T+g-(g*b+_*w)+m),M=pt(M+_-(g*A+_*P)+d)),(i||s)&&(x=p.getBBox(),T=pt(T+i/100*x.width),M=pt(M+s/100*x.height)),x="matrix("+b+","+A+","+w+","+P+","+T+","+M+")",p.setAttribute("transform",x),y&&(p.style[ct]=x)},Y0=function(e,t,n,i,s){var a=360,o=yt(s),c=parseFloat(s)*(o&&~s.indexOf("rad")?xi:1),l=c-i,u=i+l+"deg",h,f;return o&&(h=s.split("_")[1],h==="short"&&(l%=a,l!==l%(a/2)&&(l+=l<0?a:-a)),h==="cw"&&l<0?l=(l+a*Cc)%a-~~(l/a)*a:h==="ccw"&&l>0&&(l=(l-a*Cc)%a-~~(l/a)*a)),e._pt=f=new zt(e._pt,t,n,i,l,P0),f.e=u,f.u="deg",e._props.push(n),f},Fc=function(e,t){for(var n in t)e[n]=t[n];return e},K0=function(e,t,n){var i=Fc({},n._gsap),s="perspective,force3D,transformOrigin,svgOrigin",a=n.style,o,c,l,u,h,f,p,g;i.svg?(l=n.getAttribute("transform"),n.setAttribute("transform",""),a[ct]=t,o=Wr(n,1),Di(n,ct),n.setAttribute("transform",l)):(l=getComputedStyle(n)[ct],a[ct]=t,o=Wr(n,1),a[ct]=l);for(c in kn)l=i[c],u=o[c],l!==u&&s.indexOf(c)<0&&(p=wt(l),g=wt(u),h=p!==g?ri(n,c,l,g):parseFloat(l),f=parseFloat(u),e._pt=new zt(e._pt,o,c,h,f-h,No),e._pt.u=g||0,e._props.push(c));Fc(o,i)};Bt("padding,margin,Width,Radius",function(r,e){var t="Top",n="Right",i="Bottom",s="Left",a=(e<3?[t,n,i,s]:[t+s,t+n,i+n,i+s]).map(function(o){return e<2?r+o:"border"+o+r});Os[e>1?"border"+r:r]=function(o,c,l,u,h){var f,p;if(arguments.length<4)return f=a.map(function(g){return Fn(o,g,l)}),p=f.join(" "),p.split(f[0]).length===5?f[0]:p;f=(u+"").split(" "),p={},a.forEach(function(g,_){return p[g]=f[_]=f[_]||f[(_-1)/2|0]}),o.init(c,p,h)}});var dh={name:"css",register:Oo,targetTest:function(e){return e.style&&e.nodeType},init:function(e,t,n,i,s){var a=this._props,o=e.style,c=n.vars.startAt,l,u,h,f,p,g,_,m,d,y,T,M,b,A,w,P;fl||Oo(),this.styles=this.styles||ah(e),P=this.styles.props,this.tween=n;for(_ in t)if(_!=="autoRound"&&(u=t[_],!(qt[_]&&$u(_,t,n,i,e,s)))){if(p=typeof u,g=Os[_],p==="function"&&(u=u.call(n,i,e,s),p=typeof u),p==="string"&&~u.indexOf("random(")&&(u=kr(u)),g)g(this,e,_,u,n)&&(w=1);else if(_.substr(0,2)==="--")l=(getComputedStyle(e).getPropertyValue(_)+"").trim(),u+="",ei.lastIndex=0,ei.test(l)||(m=wt(l),d=wt(u)),d?m!==d&&(l=ri(e,_,l,d)+d):m&&(u+=m),this.add(o,"setProperty",l,u,i,s,0,0,_),a.push(_),P.push(_,0,o[_]);else if(p!=="undefined"){if(c&&_ in c?(l=typeof c[_]=="function"?c[_].call(n,i,e,s):c[_],yt(l)&&~l.indexOf("random(")&&(l=kr(l)),wt(l+"")||l==="auto"||(l+=$t.units[_]||wt(Fn(e,_))||""),(l+"").charAt(1)==="="&&(l=Fn(e,_))):l=Fn(e,_),f=parseFloat(l),y=p==="string"&&u.charAt(1)==="="&&u.substr(0,2),y&&(u=u.substr(2)),h=parseFloat(u),_ in En&&(_==="autoAlpha"&&(f===1&&Fn(e,"visibility")==="hidden"&&h&&(f=0),P.push("visibility",0,o.visibility),Zn(this,o,"visibility",f?"inherit":"hidden",h?"inherit":"hidden",!h)),_!=="scale"&&_!=="transform"&&(_=En[_],~_.indexOf(",")&&(_=_.split(",")[0]))),T=_ in kn,T){if(this.styles.save(_),p==="string"&&u.substring(0,6)==="var(--"&&(u=on(e,u.substring(4,u.indexOf(")"))),h=parseFloat(u)),M||(b=e._gsap,b.renderTransform&&!t.parseTransform||Wr(e,t.parseTransform),A=t.smoothOrigin!==!1&&b.smooth,M=this._pt=new zt(this._pt,o,ct,0,1,b.renderTransform,b,0,-1),M.dep=1),_==="scale")this._pt=new zt(this._pt,b,"scaleY",b.scaleY,(y?nr(b.scaleY,y+h):h)-b.scaleY||0,No),this._pt.u=0,a.push("scaleY",_),_+="X";else if(_==="transformOrigin"){P.push(kt,0,o[kt]),u=G0(u),b.svg?Bo(e,u,0,A,0,this):(d=parseFloat(u.split(" ")[2])||0,d!==b.zOrigin&&Zn(this,b,"zOrigin",b.zOrigin,d),Zn(this,o,_,Bs(l),Bs(u)));continue}else if(_==="svgOrigin"){Bo(e,u,1,A,0,this);continue}else if(_ in uh){Y0(this,b,_,f,y?nr(f,y+u):u);continue}else if(_==="smoothOrigin"){Zn(this,b,"smooth",b.smooth,u);continue}else if(_==="force3D"){b[_]=u;continue}else if(_==="transform"){K0(this,u,e);continue}}else _ in o||(_=mr(_)||_);if(T||(h||h===0)&&(f||f===0)&&!C0.test(u)&&_ in o)m=(l+"").substr((f+"").length),h||(h=0),d=wt(u)||(_ in $t.units?$t.units[_]:m),m!==d&&(f=ri(e,_,l,d)),this._pt=new zt(this._pt,T?b:o,_,f,(y?nr(f,y+h):h)-f,!T&&(d==="px"||_==="zIndex")&&t.autoRound!==!1?L0:No),this._pt.u=d||0,m!==d&&d!=="%"&&(this._pt.b=l,this._pt.r=D0);else if(_ in o)H0.call(this,e,_,l,y?y+u:u);else if(_ in e)this.add(e,_,l||e[_],y?y+u:u,i,s);else if(_!=="parseTransform"){nl(_,u);continue}T||(_ in o?P.push(_,0,o[_]):typeof e[_]=="function"?P.push(_,2,e[_]()):P.push(_,1,l||e[_])),a.push(_)}}w&&th(this)},render:function(e,t){if(t.tween._time||!dl())for(var n=t._pt;n;)n.r(e,n.d),n=n._next;else t.styles.revert()},get:Fn,aliases:En,getSetter:function(e,t,n){var i=En[t];return i&&i.indexOf(",")<0&&(t=i),t in kn&&t!==kt&&(e._gsap.x||Fn(e,"x"))?n&&Rc===n?t==="scale"?F0:N0:(Rc=n||{})&&(t==="scale"?O0:B0):e.style&&!Qo(e.style[t])?I0:~t.indexOf("-")?U0:ul(e,t)},core:{_removeProperty:Di,_getMatrix:ml}};Vt.utils.checkPrefix=mr;Vt.core.getStyleSaver=ah;(function(r,e,t,n){var i=Bt(r+","+e+","+t,function(s){kn[s]=1});Bt(e,function(s){$t.units[s]="deg",uh[s]=1}),En[i[13]]=r+","+e,Bt(n,function(s){var a=s.split(":");En[a[1]]=i[a[0]]})})("x,y,z,scale,scaleX,scaleY,xPercent,yPercent","rotation,rotationX,rotationY,skewX,skewY","transform,transformOrigin,svgOrigin,force3D,smoothOrigin,transformPerspective","0:translateX,1:translateY,2:translateZ,8:rotate,8:rotationZ,8:rotateZ,9:rotateX,10:rotateY");Bt("x,y,z,top,right,bottom,left,width,height,fontSize,padding,margin,perspective",function(r){$t.units[r]="px"});Vt.registerPlugin(dh);var Zi=Vt.registerPlugin(dh)||Vt;Zi.core.Tween;document.addEventListener("DOMContentLoaded",()=>{const r=document.getElementById("cd-scene"),e=document.getElementById("zoomWrapper"),t=document.getElementById("desktop"),n=document.getElementById("trainContainer"),i=document.getElementById("taskbar"),s=document.getElementById("aboutMeBtn"),a=document.getElementById("contactBtn"),o=document.getElementById("formBtn"),c=document.getElementById("bookmarksBar"),l=document.getElementById("homeContent"),u=document.getElementById("companyOverview");let h=0,f=0,p=0,g=0;const _=new Ff,m=new rn(75,1,.001,1e3),d=new Ug({canvas:r,alpha:!0}),y=new br,T=new $o(.7,4.3,64),M=new qf,b=M.load("/kieran.jpg",J=>{}),A=new ql({map:b,side:hn}),w=new pn(T,A);y.add(w);const P=M.load("/cd.png",J=>{J.repeat.set(.75,.75),J.offset.set(.126,.126)}),x=new ql({map:P,side:hn,transparent:!0,opacity:.7}),E=new pn(T,x);y.add(E),_.add(y);const D=new Zf(16777215,1.2);_.add(D);const N=new $f(16777215,1.5);N.position.set(5,5,5),_.add(N);function O(){const J=window.innerWidth<=768;m.aspect=window.innerWidth/window.innerHeight,m.updateProjectionMatrix(),d.setSize(window.innerWidth,window.innerHeight),h=J?0:-3.3,f=J?1:-.5,y.position.x=h,y.position.y=f;const le=J?.65:1;y.scale.set(le,le,le)}function X(){Zi.to(y.rotation,{z:y.rotation.z+6.283,duration:.8,ease:"power2.out"})}const H={microsoft:`
        ...
        `};O(),window.addEventListener("resize",O),document.addEventListener("mousemove",J=>{p=J.clientX/window.innerWidth*2-1,g=J.clientY/window.innerHeight*2-1}),m.position.x=h,m.position.y=f,m.position.z=.1,m.rotation.x=-.1;function G(){r.style.zIndex=2,n.classList.add("driving"),i.classList.add("show"),Zi.to(m.position,{x:0,y:0,z:10,duration:2.5,ease:"power2.inOut"}),Zi.to(m.rotation,{x:0,duration:2.5,ease:"power2.inOut"})}setTimeout(G,100);const q=document.getElementById("tryMeArrow");q&&setTimeout(()=>{q.classList.add("fade-out"),setTimeout(()=>{q.remove()},1e3)},5e3);function z(){requestAnimationFrame(z),y.rotation.z+=.005;const J=.25,le=g*J*-1,C=(p-100)*J,Ce=.012;y.rotation.x+=(le-y.rotation.x)*Ce,y.rotation.y+=(C-y.rotation.y)*Ce,d.render(_,m)}z();const te=document.getElementById("addressBar"),re=document.getElementById("suggestions"),ve=document.getElementById("window-template"),Ie=document.getElementById("closeBtn");let Xe=10,Ne=null,Be=0,K=0;const Z=["resume","projects","github","linkedin"];Ie.addEventListener("click",J=>{document.querySelectorAll(".draggable-window, .alert-window, .contact-window").forEach(C=>C.remove()),r.style.zIndex=13,n.classList.remove("driving"),i.classList.remove("show"),Zi.to(m.position,{x:h,y:f,z:.1,duration:2.5,ease:"power2.inOut"}),Zi.to(m.rotation,{x:-.1,duration:2.5,ease:"power2.inOut",onComplete:G})}),te.addEventListener("input",J=>{const le=J.target.value.toLowerCase();if(le){const C=Z.filter(Ce=>Ce.includes(le));C.length>0?(re.innerHTML=C.map(Ce=>`<div class="suggestion-item" data-value="${Ce}">${Ce}</div>`).join(""),re.classList.add("show")):re.classList.remove("show")}else re.classList.remove("show")}),re.addEventListener("click",J=>{if(J.target.classList.contains("suggestion-item")){const le=J.target.dataset.value;te.value=le,re.classList.remove("show"),Pe(le),te.value=""}}),te.addEventListener("keydown",J=>{J.key==="Enter"&&(J.preventDefault(),re.classList.remove("show"),Pe(te.value),te.value="")});const pe=document.getElementById("searchIcon");pe&&pe.addEventListener("click",()=>{const J=te.value;J&&(re.classList.remove("show"),Pe(J),te.value="")}),document.addEventListener("click",J=>{!te.contains(J.target)&&!re.contains(J.target)&&re.classList.remove("show")});function Pe(J){switch(J.toLowerCase().trim()){case"resume":Me({title:"My Resume",icon:"📄",contentUrl:"/resume.html"});break;case"projects":Me({title:"My Projects",icon:"💡",contentUrl:"/projects.html"});break;case"inception":Me({title:"Inception",icon:"",contentUrl:"/inception.html"});break;case"travel":Me({title:"My Travels",icon:"💡",contentUrl:"/travel.html",width:"1200px",height:"600px"});break;case"github":window.open("https://github.com/kierankhan","_blank");break;case"linkedin":window.open("https://linkedin.com/in/kierankhan","_blank");break;case"are my balls wrinkly?":window.open("https://wrinkle-identifier-db48a.web.app/","_blank");break;case"flashbang":const C=document.createElement("div");C.className="flashbang-overlay",e.appendChild(C),setTimeout(()=>{C.remove()},3e3);break;case"bangladesh jumpscare":const fe=document.getElementById("gif-template").content.cloneNode(!0).firstElementChild,Ae=fe.querySelector(".alert-close-btn"),me=()=>fe.remove();Ae.addEventListener("click",me),e.appendChild(fe),setTimeout(me,1e3);break;default:alert("Command not found: "+J+`
Try: resume, projects, github, or linkedin`)}}function Me(J){const le=ve.content.cloneNode(!0).firstElementChild;le.querySelector(".window-title").textContent=J.title,le.querySelector(".window-icon").textContent=J.icon;const C=le.querySelector(".window-content"),Ce=document.createElement("iframe");if(Ce.src=J.contentUrl,C.appendChild(Ce),Xe++,le.style.zIndex=Xe,J.width&&(le.style.width=J.width),J.height&&(le.style.height=J.height),window.innerWidth>768){const fe=Math.floor(Math.random()*100)-50,Ae=Math.floor(Math.random()*100)-50;le.style.transform=`translate(calc(-50% + ${fe}px), calc(-50% + ${Ae}px))`}e.appendChild(le)}e.addEventListener("mousedown",J=>{const le=J.target.closest(".draggable-window");le&&(Xe++,le.style.zIndex=Xe)}),e.addEventListener("click",J=>{if(J.target.classList.contains("close-btn")){const le=J.target.closest(".draggable-window");le&&le.remove()}}),e.addEventListener("mousedown",J=>{if(J.target.classList.contains("title-bar")){if(window.innerWidth<=768||(Ne=J.target.closest(".draggable-window"),!Ne))return;const le=Ne.getBoundingClientRect();Be=J.clientX-le.left,K=J.clientY-le.top}}),document.addEventListener("mousemove",J=>{if(Ne){J.preventDefault();const le=t.getBoundingClientRect();let C=J.clientX-Be-le.left,Ce=J.clientY-K-le.top;const fe=Ne.getBoundingClientRect();C=Math.max(0,Math.min(C,le.width-fe.width)),Ce=Math.max(0,Math.min(Ce,le.height-fe.height)),Ne.style.left=`${C}px`,Ne.style.top=`${Ce}px`,Ne.style.transform="none"}}),document.addEventListener("mouseup",()=>{Ne=null}),s.addEventListener("click",()=>{const le=document.getElementById("alert-template").content.cloneNode(!0).firstElementChild,C=le.querySelector(".alert-ok-btn"),Ce=le.querySelector(".alert-close-btn"),fe=()=>le.remove();C.addEventListener("click",fe),Ce.addEventListener("click",fe),e.appendChild(le)}),a.addEventListener("click",()=>{const le=document.getElementById("contact-template").content.cloneNode(!0).firstElementChild,C=le.querySelector(".alert-ok-btn"),Ce=le.querySelector(".alert-close-btn"),fe=()=>le.remove();C.addEventListener("click",fe),Ce.addEventListener("click",fe),e.appendChild(le)}),o.addEventListener("click",()=>{const le=document.getElementById("form-template").content.cloneNode(!0).firstElementChild,C=le.querySelector(".alert-close-btn"),Ce=le.querySelector("#contact-form"),fe=le.querySelector(".alert-ok-btn"),Ae=()=>le.remove();C.addEventListener("click",Ae),Ce.addEventListener("submit",me=>{me.preventDefault(),fe.textContent="Sending...",fe.disabled=!0;const nt=new FormData(Ce);fetch(Ce.action,{method:"POST",body:nt,headers:{Accept:"application/json"}}).then(_e=>{_e.ok?(fe.textContent="Sent!",setTimeout(Ae,1e3)):_e.json().then(Fe=>{Object.hasOwn(Fe,"errors")?alert(Fe.errors.map(_t=>_t.message).join(", ")):alert("Oops! Something went wrong."),fe.textContent="Send",fe.disabled=!1})}).catch(_e=>{alert("Oops! A network error occurred."),fe.textContent="Send",fe.disabled=!1})}),e.appendChild(le)}),c.addEventListener("click",J=>{const le=J.target.closest(".bookmark-btn");if(!le)return;const C=le.dataset.target;X(),c.querySelectorAll(".bookmark-btn").forEach(Ce=>{Ce.classList.remove("selected")}),le.classList.add("selected"),C==="home"?(l.style.display="block",u.style.display="none"):(l.style.display="none",u.innerHTML=H[C],u.style.display="block")})});
